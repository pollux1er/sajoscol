...
<p class=bold>
<a href="index.php?id_classe=<?php echo $id_classe; ?>"><img src='../images/icons/back.png' alt='Retour' class='back_link'/> Choose another period</a> |
<a href="index.php">Choose another class</a></p>
...
?>
<p><b>Class of <?php echo "$classe"; ?> - absences Consultation  : <?php $temp = strtolower($nom_periode[$periode_num]); echo "$temp"; ?></b>
<br />
<!--table border=1 cellspacing=2 cellpadding=5-->
<table class='boireaus' cellspacing='2' cellpadding='5'>
<tr>
	<th align='center'><b>Name Surname</b></th>
	<th align='center'><b>Total number of 1/2 days absences</b></th>
	<th align='center'><b>Number of not justified absences</b></th>
	<th align='center'><b>Number of delay</b></th>
