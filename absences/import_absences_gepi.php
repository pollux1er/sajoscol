...
?>
      <fieldset style="width: 450px; margin: auto;" class="couleur_ligne_3">
         <legend style="font: normal 10pt Arial;">&nbsp;Selection&nbsp;</legend>
            <div style="color: #E8F1F4; text-align: left; font: normal 12pt verdana, sans-serif; font-weight: bold; background-image: url(../mod_absences/images/haut_tab.png); border: 0px solid #F8F8F8;">Absences importation </div>
            <div style="text-align: center; color: #330033; font: normal 10pt Arial;">
		For the class of <?php echo "$classe"; ?><br /><br />
		Define the dates of beginning and end for the period of <?php echo $nom_periode[$periode_num]; ?><br />
                from <input name="du" type="text" size="11" maxlength="11" value="<?php echo $du; ?>" /><a href="#calend" onClick="<?php  echo $cal_1->get_strPopup('../lib/calendrier/pop.calendrier.php', 350, 170); ?>"><img src="../lib/calendrier/petit_calendrier.gif" border="0" alt="" /></a>
		to <input name="au" id="au" type="text" size="11" maxlength="11" value="<?php echo $au; ?>" onClick="getDate(au,'form_absences')" /><a href="#calend" onClick="<?php  echo $cal_2->get_strPopup('../lib/calendrier/pop.calendrier.php', 350, 170); ?>"><img src="../lib/calendrier/petit_calendrier.gif" border="0" alt="" /></a>
		...
		Caution, you will import the absences<br />managed by the absence module  of GEPI
	    </div>
      </fieldset>
    </form>
</div>
<?php
	...
	} else { echo 'You selected any period. It is thus impossible to import the data for you'; }
...
<div style="text-align: center;">
	...
	<span style="font: normal small-caps normal 14pt Verdana; line-height: 125%;">Class of <?php echo "$classe"; ?> - Importation of the absences of GEPI</span>
	<br />for : <b><?php $temp = strtolower($nom_periode[$periode_num]); echo "$temp"; ?></b>
	<br /><br />


	<span style="font-weight: bold; color: #FF0000;">Caution</span>
	<ul><li style="color: #FF0000;">the importation will be finished when you click on "Record".</li>
	<li style="color: #FF0000;">After having clicked on "Recording" these data will crush the data which would have been typed for this period.</li></ul>
	...
	<center><div id="fixe"><input type="submit" value="Save" /></div></center>
	</form>
