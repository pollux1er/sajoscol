...
if (isset($_POST['is_posted']) and $_POST['is_posted'] == "yes") {
	...
	//$affiche_message = 'yes';
	if(!isset($msg)){$msg='The modifications were recorded!';}
}
$themessage  = 'Fields were modified. Do you want to really leave without recording?';
...
?>
<p class="bold">
<a href="index.php?id_classe=<?php echo $id_classe; ?>" onclick="return confirm_abandon (this, change, '<?php echo $themessage; ?>')"><img src='../images/icons/back.png' alt='Retour' class='back_link'/>Choose another period</a> |
<a href="index.php" onclick="return confirm_abandon (this, change, '<?php echo $themessage; ?>')">Choose another class</a> | <input type="submit" value="Save" /> | <a href="<?php echo "consulter_absences.php?id_classe=$id_classe&amp;periode_num=$periode_num";?>">Consult the absences of the class</a></p>
...
?>
<p><b>Class of<?php echo "$classe"; ?> - typing of the absences : <?php $temp = strtolower($nom_periode[$periode_num]); echo "$temp"; ?></b>
<br />
<!--table border=1 cellspacing=2 cellpadding=5-->
<table class='boireaus' cellspacing='2' cellpadding='5'>
<tr>
	<th align='center'><b>Name First name</b></th>
	<th align='center'><b>Total Number of 1/2 days absence</b></th>
	<th align='center'><b>Nb. not justified absences</b></th>
	<th align='center'><b>Nb. of delay</b></th>
...
echo "<p>It is imperative that you do not leave 'champ absence', 'absence_non_justifiee', 'retard' empty.<br />
An empty field delay is not included/understood like zero delay, but like an absence of filling of the field.<br />
If you filled only the nonnull fields, you can Complete of a blow below&nbsp;:<br />\n";
echo "<a href='javascript:complete_a_zero_champs_vides()'>Complete the empty fields by zeros</a>";
echo "</p>\n";
