...
echo "<a href=\"./accueil.php?accueil_simpl=n\">Access to the menu of home/a>";
//echo " | \n";
//echo "<a href='index.php'> Carnet de notes </a> | \n";
echo " | \n";
//echo "<a href='./gestion/config_prefs.php'> Paramétrer mes interfaces simplifiées </a>\n";
echo "<a href='./gestion/config_prefs.php'> Parameterize my interface </a>\n";
echo "</p>\n";
echo "</div>\n";
...
if($colspan>0){
	for($i=1;$i<=$maxper;$i++){
		...
		for($k=0;$k<count($groups);$k++){
			if ((getSettingValue("GepiAccesReport cardSimpleProf") == "yes")||(getSettingValue("GepiAccesReport cardSimpleProfTousEleves") == "yes")) {
			...
			if((getSettingValue("GepiAccesReport cardSimplePP") == "yes")&&($test_acces_bull_simp[$i]=="n")) {
				$sql="SELECT 1=1 FROM j_eleves_groupes jeg,
...
//echo "<table border='1'>\n";
echo "<table class='contenu' summary=\"Table of the list of the courses with the links towards the Report card, bulletins, graphs,...\">\n";
echo "<tr>\n";
echo "<th";
...
if(($active_carnets_notes=="y")&&($pref_accueil_cn=="y")){
	...
	if($colspan>0){
		...
		for($i=1;$i<=$maxper;$i++){
			...
			if($pref_accueil_cn=="y"){
				echo "<th rowspan='2'>\n";
				echo "<span id='h_cn_$i'>Report card</span>\n";
				echo "</th>\n";
			}
	
			if($pref_accueil_bull=="y"){
				echo "<th colspan='2'>\n";
				echo "<span id='h_b_$i'>Report card</span>\n";
				echo "</th>\n";
			}
			...
			if($pref_accueil_visu=="y"){
				...
				*/
				...
				echo "<span id='h_v_$i'>Visualization</span>\n";
				echo "</th>\n";
			}
	
			if($pref_accueil_liste_pdf=="y"){
				echo "<th rowspan='2'>\n";
				echo "<span id='h_liste_pdf_$i'>Pdf list </span>\n";
				echo "</th>\n";
			}
		}
		echo "</tr>\n";
	...
	if($colspan>0){
		...
		for($i=1;$i<=$maxper;$i++){
			...
			if($pref_accueil_visu=="y"){
				echo "<th>\n";
				echo "<span id='h_g_$i'>Graph</span>";
				echo "</th>\n";
...
for($i=0;$i<count($groups);$i++){
	...
	foreach($groups[$i]["classes"]["classes"] as $classe){
		...
		if($pref_accueil_infobulles=="y"){
			...
			echo "<div id='info_popup_".$i."_".$cpt."' class='infobulle_corps' style='border: 1px solid #000000; color: #000000; padding: 0px; position: absolute; width: 18em;' onmouseout=\"cacher_div('info_popup_".$i."_".$cpt."');\">List of students of ".htmlentities($groups[$i]['description'])." (<i>".preg_replace("/ /","&nbsp;",$classe['classe'])."</i>).</div>\n";
	...
	if(($active_cahiers_texte=="y")&&($pref_accueil_ct=="y")){
		...
		//if(($accueil_aff_txt_icon==1)||($accueil_aff_txt_icon==3)){
			...
			echo "<img src='images/icons/cahier_textes.png' width='32' height='32' alt='Textbook' border='0' />";
		/*
		}
		...
		*/
		...
		if($pref_accueil_infobulles=="y"){
			...
			echo "<div id='info_ct_$i' class='infobulle_corps' style='border: 1px solid #000000; color: #000000; padding: 0px; position: absolute; width: 18em;' onmouseout=\"cacher_div('info_ct_$i');\">Textbook of ".htmlentities($groups[$i]['description'])." (<i>$liste_classes_du_groupe</i>).</div>\n";
	...
	if(($active_module_trombinoscopes=="y")&&($pref_accueil_trombino=="y")){
		...
		*/
		...
		if($pref_accueil_infobulles=="y"){
			...
			echo "<div id='info_trombino_$i' class='infobulle_corps' style='border: 1px solid #000000; color: #000000; padding: 0px; position: absolute; width: 18em;' onmouseout=\"cacher_div('info_trombino_$i');\">Trombinoscope of ".htmlentities($groups[$i]['description'])." (<i>$liste_classes_du_groupe</i>).</div>\n";
					...
					if($pref_accueil_cn=="y"){
						...
						if(!in_array($groups[$i]['id'],$invisibilite_groupe['cahier_notes'])) {
							...
							//if(($accueil_aff_txt_icon==1)||($accueil_aff_txt_icon==3)){
								...
								echo "<img src='images/icons/carnet_notes.png' width='32' height='32' alt='Typing of notes' border='0' />";
							/*
							}
							if($accueil_aff_txt_icon==3){
								echo "<br />";
							...
							*/
							...
							if($pref_accueil_infobulles=="y"){
								...
								echo "<div id='info_cn_".$i."_".$j."' class='infobulle_corps' style='border: 1px solid #000000; color: #000000; padding: 0px; position: absolute; width: 18em;' onmouseout=\"cacher_div('info_cn_".$i."_".$j."');\">Report card of ".htmlentities($groups[$i]['description'])." (<i>$liste_classes_du_groupe</i>)<br />".$groups[$i]["periodes"][$j]["nom_periode"].".</div>\n";
			...
			cacher_div('info_bn_".$i."_".$j."');
						...
						if(!in_array($groups[$i]['id'],$invisibilite_groupe['bulletins'])) {
							...
							//if(($accueil_aff_txt_icon==1)||($accueil_aff_txt_icon==3)){
								...
								echo "<img src='images/icons/bulletin.png' width='32' height='34' alt='Appreciations' border='0' />";
							/*
							}
							if($accueil_aff_txt_icon==3){
								echo "<br />";
							...
							*/
							...
							if($pref_accueil_infobulles=="y"){
								...
								echo "<div id='info_ba_".$i."_".$j."' class='infobulle_corps' style='border: 1px solid #000000; color: #000000; padding: 0px; position: absolute; width: 15em;' onmouseout=\"cacher_div('info_ba_".$i."_".$j."');\">Typing of the appreciations ".htmlentities($groups[$i]['description'])." (<i>$liste_classes_du_groupe</i>)<br />".$groups[$i]["periodes"][$j]["nom_periode"].".</div>\n";
					...
					if($pref_accueil_visu=="y"){
						...
						foreach($groups[$i]["classes"]["classes"] as $classe){
							...
							//if(($accueil_aff_txt_icon==1)||($accueil_aff_txt_icon==3)){
								...
								echo "<img src='images/icons/graphes.png' width='32' height='32' alt='Graph' border='0' />";
							/*
							}
							if($accueil_aff_txt_icon==3){
								echo "<br />";
							...
							*/
							...
							if($pref_accueil_infobulles=="y"){
								...
								echo "<div id='info_graphe_".$i."_".$j."_".$cpt."' class='infobulle_corps' style='border: 1px solid #000000; color: #000000; padding: 0px; position: absolute; width: 10em;' onmouseout=\"cacher_div('info_graphe_".$i."_".$j."_".$cpt."');\">Graphic tool<br />".$classe['classe']."<br />".$groups[$i]["periodes"][$j]["nom_periode"].".</div>\n";
		...
		cacher_div('info_graphe_".$i."_".$j."_".$cpt."');
						...
						if($test_acces_bull_simp[$j]=="y") {
							...
							foreach($groups[$i]["classes"]["classes"] as $classe){
								...
								elseif(getSettingValue("GepiAccesReport cardSimplePP") == "yes") {
									$sql="SELECT 1=1 FROM j_eleves_groupes jeg,
																j_eleves_professeurs jep,
								...
								if($affiche_bull_simp_cette_classe=="y") {
									//echo "<a href='../prepa_conseil/index3.php?id_classe=".$classe['id']."' onClick=\"valide_bull_simpl('".$classe['id']."','".$j."'); return false;\"><img src='../images/icons/bulletin_simpl.png' width='37' height='34' alt='Report card simplifié' border='0' />";
									...
									//if(($accueil_aff_txt_icon==1)||($accueil_aff_txt_icon==3)){
										//echo "<img src='../images/icons/bulletin_simp.png' width='34' height='34' alt='Report card simplifié' border='0' />";
										echo "<img src='images/icons/bulletin_simp.png' width='34' height='34' alt='Report card simplifié' border='0' />";
									/*
									}
									if($accueil_aff_txt_icon==3){
									...
									*/
									...
									if($pref_accueil_infobulles=="y"){
										...
										echo "<div id='info_bs_".$i."_".$j."_".$cpt."' class='infobulle_corps' style='border: 1px solid #000000; color: #000000; padding: 0px; position: absolute; width: 10em;' onmouseout=\"cacher_div('info_bs_".$i."_".$j."_".$cpt."');\">Simplified bulletins<br />".$classe['classe']."<br />".$groups[$i]["periodes"][$j]["nom_periode"].".</div>\n";
					...
					if($pref_accueil_liste_pdf=="y"){
						...
						*/
						...
						if($pref_accueil_infobulles=="y"){
							...
							echo "<div id='info_liste_pdf_".$i."_".$j."' class='infobulle_corps' style='border: 1px solid #000000; color: #000000; padding: 0px; position: absolute; width: 12em;' onmouseout=\"cacher_div('info_liste_pdf_".$i."_".$j."');\">Pdf lists  of students<br />".$classe['classe']."<br />".$groups[$i]["periodes"][$j]["nom_periode"].".</div>\n";
