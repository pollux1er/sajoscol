...
//**************** EN-TETE *********************
$titre_page = "Cards projects of the former years";
...
echo "<p class=bold>";
echo "<a href=\"annees_anterieures_accueil.php?annee_scolaire=".$annee_scolaire."\"><img src='../images/icons/back.png' alt='Retour' class='back_link'/> Return</a>";
echo "</p>\n";
echo "<center><H3>Liste des projets ".$nom_projet."</H3></center>";
$_login = $_SESSION["login"];
$message_avertissement = "";
$non_defini = "<font color='red'>Not defined</font>";
