...
if ((NiveauGestionAid($_SESSION["login"],$indice_aid) >= 10) and (isset($_POST["is_posted"]))) {
    ...
    while ($i < $nombreligne){
        ...
        if (!$register)
			    $msg_inter .= "Error during the recording of data  related to fiche_publique of the ida $aid_id <br />\n";
        ...
        if (!$register)
			    $msg_inter .= "Error during the data record eleve_peut_modifier of the ida $aid_id <br />\n";
        ...
        if (!$register)
			    $msg_inter .= "Error during the data recording prof_peut_modifier of the aid $aid_id <br />\n";
        ...
        if (!$register)
			    $msg_inter .= "Error during the data record ing cpe_peut_modifier of the $aid_id <br />\n";
        ...
        if (!$register)
			    $msg_inter .= "Error during the data recording affiche_adresse1 of the ida $aid_id <br />\n";
        ...
        if (!$register)
			    $msg_inter .= "Error during the data recording en_construction ida $aid_id <br />\n";
        $i++;
    }
    if ($msg_inter == "") {
...
if ($_SESSION['statut']=="administrateur")
  ...
  if (NiveauGestionAid($_SESSION["login"],$indice_aid) >= 10) {
    echo "<a href=\"export_csv_aid.php?indice_aid=$indice_aid\">Importation of data from a file towards GEPI</a>|";
}
echo "</p>";

if ((NiveauGestionAid($_SESSION["login"],$indice_aid) >= 10) and ($activer_outils_comp == "y"))
    echo "<br /><p class=\"medium\">The rights of access to the various fields are configurable for the
whole of the IDA in the page <b><i>Management of the IDA -> <a href='./config_aid_fiches_projet.php'>Configure the cards project</a></i></b>.</p>";
...
if ((NiveauGestionAid($_SESSION["login"],$indice_aid) >= 10) and ($activer_outils_comp == "y")) {
    echo "<th><p class=\"small\">The card is visible on <a href=\"javascript:centrerpopup('../public/index_fiches.php',800,500,'scrollbars=yes,statusbar=no,resizable=yes')\">public part</a></p>\n";
    echo "<a href=\"javascript:CocheColonne(1);changement();\"><img src='../images/enabled.png' width='15' height='15' alt='check all' /></a> / <a href=\"javascript:DecocheColonne(1);changement();\"><img src='../images/disabled.png' width='15' height='15' alt='uncheck all' /></a>\n";
    echo "</th>\n";

    echo "<th><p class=\"small\">The student reponsibles can modify the card (*)</p>\n";
    echo "<a href=\"javascript:CocheColonne(2);changement();\"><img src='../images/enabled.png' width='15' height='15' alt='check all' /></a> / <a href=\"javascript:DecocheColonne(2);changement();\"><img src='../images/disabled.png' width='15' height='15' alt='uncheck all' /></a>\n";
    echo "</th>\n";

    echo "<th><p class=\"small\">The professors responsibles can modify the card (*)</p>\n";
    echo "<a href=\"javascript:CocheColonne(3);changement();\"><img src='../images/enabled.png' width='15' height='15' alt='check all' /></a> / <a href=\"javascript:DecocheColonne(3);changement();\"><img src='../images/disabled.png' width='15' height='15' alt='uncheck all' /></a>\n";
    echo "</th>\n";

    echo "<th><p class=\"small\">The CPE can modify the card (*)</p>\n";
    echo "<a href=\"javascript:CocheColonne(4);changement();\"><img src='../images/enabled.png' width='15' height='15' alt='check all' /></a> / <a href=\"javascript:DecocheColonne(4);changement();\"><img src='../images/disabled.png' width='15' height='15' alt='uncheck all' /></a>\n";
    echo "</th>\n";

    echo "<th><p class=\"small\">The link \"public address\" is visible on the public part</p>\n";
    echo "<a href=\"javascript:CocheColonne(5);changement();\"><img src='../images/enabled.png' width='15' height='15' alt='check all' /></a> / <a href=\"javascript:DecocheColonne(5);changement();\"><img src='../images/disabled.png' width='15' height='15' alt='uncheck all' /></a>\n";
    echo "</th>\n";

    echo "<th><p class=\"small\">The link\"public address\" is accompanied by a message \"In construction\"</p>\n";
    echo "<a href=\"javascript:CocheColonne(6);changement();\"><img src='../images/enabled.png' width='15' height='15' alt='check all' /></a> / <a href=\"javascript:DecocheColonne(6);changement();\"><img src='../images/disabled.png' width='15' height='15' alt='uncheck all' /></a>\n";
    echo "</th>\n";
}
// Colonne "supprimer
if (NiveauGestionAid($_SESSION["login"],$indice_aid) >= 5)
...
while ($i < $nombreligne){
    ...
    if (NiveauGestionAid($_SESSION["login"],$indice_aid,$aid_id) >= 5)
      if (!((getSettingValue("num_aid_trombinoscopes")==$indice_aid) and (getSettingValue("active_module_trombinoscopes")=='y')))
        echo "<td><p class='medium'><a href='modify_aid.php?flag=prof&amp;aid_id=$aid_id&amp;indice_aid=$indice_aid'>Add, remove professors</a></p></td>\n";
    // colonne "Ajouter, supprimer des élèves"
    if (NiveauGestionAid($_SESSION["login"],$indice_aid,$aid_id) >= 1)
        echo "<td><p class='medium'><a href='modify_aid.php?flag=eleve&amp;aid_id=$aid_id&amp;indice_aid=$indice_aid'>Add, remove students</a></p></td>\n";
    // colonne "Ajouter, supprimer des gestionnaires"
    if (NiveauGestionAid($_SESSION["login"],$indice_aid,$aid_id) >= 10)
      if (getSettingValue("active_mod_gest_aid")=="y")
            echo "<td><p class='medium'><a href='modify_aid.php?flag=prof_gest&amp;aid_id=$aid_id&amp;indice_aid=$indice_aid'>Add, remove managers</a></p></td>\n";
    ...
    // colonne "Supprimer"
    if (NiveauGestionAid($_SESSION["login"],$indice_aid,$aid_id) >= 5)
        echo "<td><p class='medium'><a href='../lib/confirm_query.php?liste_cible=$aid_id&amp;liste_cible3=$indice_aid&amp;action=del_aid".add_token_in_url()."'>delete</a></p></td></tr>\n";
...
<?php
if ((NiveauGestionAid($_SESSION["login"],$indice_aid) >= 10) and ($activer_outils_comp == "y")) {
  echo "<br />(*) Only if the administrator opened this possibility for the concerned project .";
