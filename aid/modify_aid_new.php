...
$titre_page = empty($lang) ? ${'titre_page' . $lang} = "Management of student in IDA" : $titre_page;
...
// Affichage du retour
	...
	$aff_infos_g .= "<span class=\"aid_a\"><a href=\"modify_aid.php?flag=eleve&amp;aid_id=".$id_aid."&amp;indice_aid=".$indice_aid.add_token_in_url()."\"><img src='../images/icons/back.png' alt='Return' class='back_link' /> Return</a></span>";
...
//Affichage du nom et des précisions sur l'AID en question
	...
	$aff_infos_g .= "<p class=\"bold\">List of classes</p>\n";
	...
	";
		...
		<tr class=\"".$aff_tr_css."\">
			<td>
				...
				<img src=\"../images/icons/add_user.png\" alt=\"Add\" title=\"Add\" /> All the class
				</a>
			</td>
		</tr>
		<tr>
...
<a href="#" onMouseOver="javascript:changerDisplayDiv('aid_aide');" onMouseOut="javascript:changerDisplayDiv('aid_aide');">
	<img src="../images/info.png" alt="More infos..." Title="More infos..." />
</a>
	<div id="aid_aide" style="display: none;">
	To accelerate the procedure, while clicking on a class,
	you have access to the list of its pupils.<br />
	You can integrate all these pupils while clicking on [ All the class].<br />
	<hr />
	</div>
...
?>
		...
		<table class="aid_tableau" summary="List of classes">
