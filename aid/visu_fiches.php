...
echo "<p class='bold'>";
echo "<a href=\"index_fiches.php?indice_aid=".$indice_aid."\"><img src='../images/icons/back.png' alt='Return' class='back_link'/> Return</a>";
echo "</p>\n";
echo "<h3 style=\"text-align:center\">List of projects ".$nom_projet."</h3>";

$_login = $_SESSION["login"];
$message_avertissement = "";
$non_defini = "<span style=\"color:red\">No défined</span>";
