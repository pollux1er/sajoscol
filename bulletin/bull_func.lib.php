...
/* $Id: bull_func.lib.php 8720 2011-12-09 14:21:43Z crob $ */
...
function bulletin_html($tab_bull,$i,$tab_rel) {
	...
	for ($bulletin=0; $bulletin<$nb_bulletins; $bulletin++) {
		...
		echo "\n<!-- Beginning of the posting of the heading of the bulletin n°$bulletin for ".$tab_bull['eleve'][$i]['nom']." ".$tab_bull['eleve'][$i]['prenom'].", ".$tab_bull['eleve'][$i]['classe']." -->\n";
...
width:".$largeur1."%;\n";
			...
			echo "<table summary='Table of logo and infos establishment'";
			...
			if  ($bull_affiche_eleve_une_ligne == 'no') { // sur plusieurs lignes
				...
				echo "<p class='bulletin'>\n";
				echo "<b><span class=\"x\">".$tab_bull['eleve'][$i]['nom']." ".$tab_bull['eleve'][$i]['prenom']."</span></b><br />";
				// echo "Né";
				// if (strtoupper($tab_bull['eleve'][$i]['sexe'])=="F") {echo "e";}
				// echo "&nbsp;le&nbsp;".$tab_bull['eleve'][$i]['naissance'];
				if ($tab_bull['eleve'][$i]['regime'] == "d/p") {echo ", ";}
				if ($tab_bull['eleve'][$i]['regime'] == "ext.") {echo ", External";}
				if ($tab_bull['eleve'][$i]['regime'] == "int.") {echo ", Intern";}
				if ($tab_bull['eleve'][$i]['regime'] == "i-e"){
					echo ", Intern&nbsp;externé";
					if (strtoupper($tab_bull['eleve'][$i]['sexe'])=="F") {echo "e";}
				}
			...
			if($bull_affiche_INE_eleve=="y"){
				echo "<br />\n";
				echo "Number INE: ".$tab_bull['eleve'][$i]['no_gep'];
			}
			...
			if($addressblock_debug=="y"){echo "border='1' ";}
			echo "cellspacing='".$cellspacing."' cellpadding='".$cellpadding."' summary='Table of name of class, year and period'>\n";
			echo "<tr>\n";
			echo "<td class='empty'>\n";
			echo "&nbsp;\n";
			echo "</td>\n";
			echo "<td style='width:".$addressblock_classe_annee2."%;'>\n";
			echo "<p class='bulletin' align='center'><span class=\"bgrand\">Classe de ".$tab_bull['eleve'][$i]['classe_nom_complet']."<br />School year ".$gepiYear."</span><br />\n";
			...
			echo "<table width='$largeurtableau' border='0' cellspacing='".$cellspacing."' cellpadding='".$cellpadding."' summary='Table of data student and establishment'>\n";
			...
			if  ($bull_affiche_eleve_une_ligne == 'no') { // sur plusieurs lignes
				...
				if ($tab_bull['eleve'][$i]['regime'] == "d/p") {echo ", ";}
				elseif ($tab_bull['eleve'][$i]['regime'] == "ext.") {echo ", External";}
				elseif ($tab_bull['eleve'][$i]['regime'] == "int.") {echo ", Intern";}
			...
			if ($tab_bull['affiche_adresse'] != "y") {
				echo "<p class='bulletin'><span class=\"bgrand\">Class ".$tab_bull['eleve'][$i]['classe_nom_complet']."<br />School year ".$gepiYear."</span><br />\n";
				$temp = strtolower($tab_bull['nom_periode']);
				echo "Report card&nbsp;";
				if($genre_periode=="M"){
					echo " ";
		...
		echo "\n<!-- End of the display of the heading of the bulletin n°$bulletin for ".$tab_bull['eleve'][$i]['nom']." ".$tab_bull['eleve'][$i]['prenom'].", ".$tab_bull['eleve'][$i]['classe']." -->\n\n";
		...
		echo "\n<!-- Beginning of the display of the table of the course of the bulletin n°$bulletin for ".$tab_bull['eleve'][$i]['nom']." ".$tab_bull['eleve'][$i]['prenom'].", ".$tab_bull['eleve'][$i]['classe']." -->\n\n";
        //=============================================
        ...
        //=============================================
		echo "\n<!-- End of the display of the table of the course of the bulletin n°$bulletin for ".$tab_bull['eleve'][$i]['nom']." ".$tab_bull['eleve'][$i]['prenom'].", ".$tab_bull['eleve'][$i]['classe']." -->\n\n";


		// Absences et retards
		//if($tab_bull['affiche_absences']=='y') {
		/* if($bull_affiche_absences=='y') {
			echo "\n<!-- Beginning of the display of the table of the absences of the bulletin n°$bulletin for ".$tab_bull['eleve'][$i]['nom']." ".$tab_bull['eleve'][$i]['prenom'].", ".$tab_bull['eleve'][$i]['classe']." -->\n\n";

            echo "<table width='$largeurtableau' border='0' cellspacing='".$cellspacing."' cellpadding='".$cellpadding."' summary='Table of absences'>\n";
			echo "<tr>\n";
			echo "<td style='vertical-align: top;'>\n";
			echo "<p class='bulletin'>";
			if ($tab_bull['eleve'][$i]['eleve_absences'] == '0') {
				echo "<i>No half-day of absence</i>.";
			} else {
				echo "<i>Number of half-days of absence ";
				if ($tab_bull['eleve'][$i]['eleve_nj'] == '0') {echo "justified ";}
				echo ": </i><b>".$tab_bull['eleve'][$i]['eleve_absences']."</b>";
				if ($tab_bull['eleve'][$i]['eleve_nj'] != '0') {
					echo " (dont <b>".$tab_bull['eleve'][$i]['eleve_nj']."</b> not justified"; if ($tab_bull['eleve'][$i]['eleve_nj'] != '1') {echo "s";}
					echo ")";
				}
				echo ".";
			}
			...
			echo " follow-up : ". affiche_utilisateur($tab_bull['eleve'][$i]['cperesp_login'],$tab_bull['id_classe']) . ")";
			if ($tab_bull['eleve'][$i]['appreciation_absences']!="") {echo "<br />".texte_html_ou_pas($tab_bull['eleve'][$i]['appreciation_absences']);}
			echo "</p>\n";
			echo "</td>\n</tr>\n</table>\n";

			echo "\n<!-- End of the display of the table of the absences of the bulletin n°$bulletin for ".$tab_bull['eleve'][$i]['nom']." ".$tab_bull['eleve'][$i]['prenom'].", ".$tab_bull['eleve'][$i]['classe']." -->\n\n";
		...
		if (($bull_affiche_avis == 'y')||($bull_affiche_signature == 'y')) {
			...
			echo "\n<!-- Beginning of the display of the table of the opinion of council/signature of the bulletin n°$bulletin for ".$tab_bull['eleve'][$i]['nom']." ".$tab_bull['eleve'][$i]['prenom'].", ".$tab_bull['eleve'][$i]['classe']." -->\n\n";

			// Tableau de l'avis des conseil de classe
			echo "<table $class_bordure width='$largeurtableau' border='1' cellspacing='".$cellspacing."' cellpadding='".$cellpadding."' summary=\"Table of the opinion of staff meeting\">\n";
			echo "<tr>\n";
		}
        ...
        if ($bull_affiche_avis == 'y') {
			...
			// 1) l'avis
			echo "<span class='bulletin'><i>Opinion of the staff meeting:</i></span><br />\n";
        ...
        if ($bull_affiche_signature == 'y') {
			...
			*/
			...
			echo "<!-- Box: paraph of the headmaster -->\n";
			if($tab_bull['formule']!='') {echo "<span class='bulletin'><b>".$tab_bull['formule']."</b>:</span><br />";}
			/*if($tab_bull['suivi_par']!='') {*/echo "<span class='bulletin'><i>Rev. Fr. Peter Nouck"./*.$tab_bull['suivi_par'].*/"</i></span>";/*}*/
		}
        ...
        if (($bull_affiche_avis == 'y')||($bull_affiche_signature == 'y')) {
			...
			echo "\n<!-- End of the display of the table of the opinion of council/signature of the bulletin n°$bulletin for ".$tab_bull['eleve'][$i]['nom']." ".$tab_bull['eleve'][$i]['prenom'].", ".$tab_bull['eleve'][$i]['classe']." -->\n\n";
		...
		echo "<table width='$largeurtableau' style='margin-left:5px; margin-right:5px;' border='0' cellspacing='".$cellspacing."' cellpadding='".$cellpadding."' summary='Formulate of bottom of page'>\n";
		echo "<tr>";
		echo "<td><p align='center' class='bulletin'>Balance Fee :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br />Next term re-opens : 03/01/2013</p></td>\n";
		echo "</tr></table>";
		...
		if(count($tab_rel)!=0) {
			...
			if(isset($tab_rel['eleve'])) {
				...
				echo "<p style='color:red;'>It seems that the table of the statements of notes is empty.</p>\n";
			}
		}
...
function bulletin_pdf($tab_bull,$i,$tab_rel) {
	...
	*/
	...
	for($num_resp_bull=0;$num_resp_bull<$nb_bulletins;$num_resp_bull++) {
		...
		// $fomule = 'Report card à conserver précieusement. Aucun duplicata ne sera délivré. - GEPI : solution libre de gestion et de suivi des résultats scolaires.'
		...
		if($tab_modele_pdf["active_bloc_eleve"][$classe_id]==='1') {
			...
			*/
			...
			if($tab_modele_pdf["affiche_numero_impression"][$classe_id]==='1') {
				...
				//$num_ordre = $i;
				$num_ordre = $i+1;
				$pdf->Cell(45,4, 'Report card N° '.$num_ordre,0,2,'');
			}
		...
		if($tab_modele_pdf["active_bloc_datation"][$classe_id]==='1') {
			...
			$pdf->Cell(90,7, traite_accents_utf8("Class of".unhtmlentities($tab_bull['classe_nom_complet'])),0,2,'C');
			...
			$pdf->Cell(90,5, traite_accents_utf8("School year ".$annee_scolaire),0,2,'C');
			...
			$pdf->SetFont($tab_modele_pdf["caractere_utilse"][$classe_id], $type_texte, $taille_texte);
			$pdf->Cell(90,5, traite_accents_utf8("Report card of ".unhtmlentities($tab_bull['nom_periode'])),0,2,'C');
			$taille_texte = '8';
			$type_texte = '';
		...
		if($tab_modele_pdf["active_bloc_note_appreciation"][$classe_id]==='1' and $nb_matiere!='0') {
			...
			while ( !empty($ordre_moyenne[$cpt_ordre]) ) {
				...
				if (($tab_modele_pdf["toute_moyenne_meme_col"][$classe_id]!=1)&&
					...
					$text_entete_moyenne = 'For the class';
					$pdf->SetXY($tab_modele_pdf["X_note_app"][$classe_id]+$largeur_utilise, $tab_modele_pdf["Y_note_app"][$classe_id]);
					$hauteur_caractere=10;
					$pdf->SetFont($tab_modele_pdf["caractere_utilse"][$classe_id],'',$hauteur_caractere);
			...
			*/
			...
			for($m=0; $m<count($tab_bull['groupe']); $m++)
			{
				...
				fich_debug_bull("\n");
				fich_debug_bull("Preceding category: \$categorie_passe=$categorie_passe\n");
				...
				if(isset($tab_bull['nom_cat_complet'][$m])) {
                  fich_debug_bull("Current category :  \$tab_bull['nom_cat_complet'][$m]=".$tab_bull['nom_cat_complet'][$m]."\n");
                }
                else {
                  fich_debug_bull("Current category :  \$tab_bull['nom_cat_complet'][$m] non affectée.\n");
                }
				...
				fich_debug_bull("After the categories on the side\n");
				fich_debug_bull("\$Y_decal=$Y_decal\n");
