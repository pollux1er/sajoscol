...
The generation of the pdf will fail because this information of debuggage is displayed,<br />
but it is possible that you have precise details on what poses problem.<br />
</p>\n";
}
//================================
...
$bull_formule_bas=getSettingValue("bull_formule_bas") ? getSettingValue("bull_formule_bas") : "Report card to be preserved preciously. No duplicate will be delivered. - GEPI : free solution of management and follow-up of the school results.";
...
// Fin modif Eric  pour option tri par etab origine
	...
	while ($donner = mysql_fetch_array($call_eleve))
	{
		...
		if ($sexe[$cpt_i] == "M") {
			$date_naissance[$cpt_i] = 'Born on'.date_fr($donner['naissance']);
		} else {
			$date_naissance[$cpt_i] = 'Born on'.date_fr($donner['naissance']);
		}
...
//echo "==============================<br />\n";
	...
	$pdf->Cell(90,5, "Report card du ".unhtmlentities($nom_periode[$id_classe_selection][$id_periode]),0,2,'C');
...
//+++++++++++++++++++++++++
	...
	{
		$info_absence = $info_absence."<i> Number of delays : </i><b>".$info_bulletin[$ident_eleve_aff][$id_periode]['absences_retards']."</b>";
	}
