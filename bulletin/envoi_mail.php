...
if($envoi) {echo " <img src='../images/enabled.png' width='20' height='20' alt='Message sent successfully' title='Message sent successfully' />";}
else {echo " <img src='../images/icons/flag.png' width='17' height='18' alt='Failure of the sending of the message' title='Failure of the sending of the message' />";}
?>