...
.boireaus td {
	...
	$releve_formule_bas=getSettingValue("releve_formule_bas") ? getSettingValue("releve_formule_bas") : "Statement to be preserved preciously. No duplicate will be delivered. - GEPI : free solution of management and follow-up of the school results.";
