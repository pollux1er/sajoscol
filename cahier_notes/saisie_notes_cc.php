<?php
/*
 * @version: $Id: saisie_notes_cc.php 8671 2011-11-29 12:11:13Z crob $
*
...
if($query) {
	...
	header("Location: index.php?msg=".rawurlencode("The number of the exam is not associated to this group."));
	die();
}
...
if(!isset($id_eval)) {
	header("Location: index.php?msg=".rawurlencode("Invalid number of evaluation."));
	die();
}
...
if(mysql_num_rows($query)==0) {
	$mess="The evaluation n°$id_eval is not associated $nom_cc n°$id_dev.<br />";
	header("Location: index_cc.php?id_racine=$id_racine&msg=$mess");
	die();
}
...
//**************** EN-TETE *****************
$titre_page = "Typing of the notes CC";
...
echo "<p class='bold'>\n";
echo "<a href=\"index_cc.php?id_racine=$id_racine\" onclick=\"return confirm_abandon (this, change, '$themessage')\"><img src='../images/icons/back.png' alt='Return' class='back_link'/> Return </a>";
...
if(mysql_num_rows($res_eval)>1) {
	...
	echo "| Evaluation ";
	if($id_eval_prec!="-1") {
		echo " <a href='".$_SERVER['PHP_SELF']."?id_racine=$id_racine&amp;id_dev=$id_dev&amp;id_eval=$id_eval_prec' onclick=\"return confirm_abandon (this, change, '$themessage')\">Previous</a>";
	}
	...
	echo "</select>\n";
	if($id_eval_suiv!="-1") {
		echo " <a href='".$_SERVER['PHP_SELF']."?id_racine=$id_racine&amp;id_dev=$id_dev&amp;id_eval=$id_eval_suiv' onclick=\"return confirm_abandon (this, change, '$themessage')\"> Next</a>";
	}
...
echo "<tr>\n";
echo "<th><a href='".$_SERVER['PHP_SELF']."?id_racine=$id_racine&amp;id_dev=$id_dev&amp;id_eval=$id_eval&amp;order_by=nom' onclick=\"return confirm_abandon (this, change,'$themessage')\">Name First name</a></th>\n";
echo "<th><a href='".$_SERVER['PHP_SELF']."?id_racine=$id_racine&amp;id_dev=$id_dev&amp;id_eval=$id_eval&amp;order_by=classe' onclick=\"return confirm_abandon (this, change,'$themessage')\">Class</a></th>\n";
echo "<th>Note</th>\n";
echo "<th>Comment</th>\n";
echo "</tr>\n";
...
echo "</select>\n";
echo "</td><td>\n";
echo "paste below the data be imported : <br />\n";
...
echo "<p><b>Significant remark :</b> the importation takes into account only the student whose name is displayed above !<br />Be thus vigilant to paste only the notes of these students, in the good order.</p>\n";
echo "</form></fieldset>\n";
...
?>
<br />
* In conformity with the CNIL, the professor commits himself making appear in the report card only
notes and comments made available of the student (note and comment present on the copy, ...).
<script type="text/javascript" language="javascript">
chargement = true;
