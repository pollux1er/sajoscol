<?php
/*
 * @version: $Id: visu_cc.php 6795 2011-04-18 12:23:35Z crob $
*
...
if(mysql_num_rows($query)>0) {
	...
	header("Location: index.php?msg=".rawurlencode("The number of exam is not associated to this group."));
	die();
}
...
if(isset($_GET['export_csv'])) {
	...
	if(mysql_num_rows($res_eval)==0) {
		$msg="No evaluation is associated to $nom_cc n°$id_dev<br />";
	}
	else {
		$cpt=0;
		$tab_eval=array();
...
foreach ($liste_eleves as $eleve) {
	...
	echo "<table class='boireaus table_no_split' summary=\"$nom_cc of $eleve_nom[$i] $eleve_prenom[$i]\">\n";
	...
	echo "<tr class='table_no_split'>\n";
	echo "<th colspan='4'><b>Student</b>&nbsp;: $eleve_nom[$i] $eleve_prenom[$i]</th>\n";
	echo "</tr>\n";
