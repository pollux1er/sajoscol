...
$code_retour_admin = '<p><a href="../cahier_texte_admin/' . $_retour .'.php">RETURN to the signature of the text book</a></p>';
...
if((isset($_SESSION['retour_cdt']))&&($_SESSION['retour_cdt']='visa_ct')) {
	$_retour='visa_ct';
	$retour_admin='<p><a href="../cahier_texte_admin/' . $_retour .'.php#tableau_des_enseignants">RETURN to the signature of the text book</a></p>';
}

//**************** EN-TETE *****************
if ($current_imprime=='n') $titre_page = "Log book - Global view";
...
//On vérifie si le module est activé
if (getSettingValue("active_cahiers_texte")!='y') {
	die("<p class='grand centre_texte'>The text book is not accessible for the moment.</p>");
}
		...
		if ($current_imprime=='n') {
			...
			if ($_SESSION["statut"] == "administrateur" OR $_SESSION["statut"] == "professeur" OR $_SESSION["statut"] == "scolarite" OR $_SESSION["statut"] == "cpe" OR $_SESSION["statut"] == "autre") {
				...
				if ($_SESSION["statut"] == "professeur") {
					echo "<a href='./index.php'>\n<img src='../images/icons/back.png' alt='Return' class='back_link'/> Return to my text book\n</a> - ";
				}
			} else {
...
if ($nb_test == 0) {
	...
	if ($_SESSION['statut'] == "responsable") {
		echo "Choose a student and a courses.";
	} elseif ($_SESSION['statut'] == "eleve") {
		echo "Choose a courses.";
	} else {
...
echo "<h2 class='grande_ligne couleur_bord_tableau_notice'>\n<strong>TEXT BOOK: reports of meeting</strong>\n</h2>\n";
