...
echo "<legend style=\"border: 1px solid grey; font-variant: small-caps;\"> Moving of notice</legend> ";
...
echo "<option value='-1'>(choose a group of destination)</option>\n";
...
echo "<button onClick=\"javascript:
			...
			return false;\"
			id=\"bouton_deplacer\" name=\"deplacer\" style='font-variant: small-caps;'>Move</button>";
