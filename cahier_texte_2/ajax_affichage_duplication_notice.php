<?php
/*
 * $Id: ajax_affichage_duplication_notice.php 7938 2011-08-24 07:57:41Z jjocal $
 *
...
echo "<legend style=\"border: 1px solid grey; font-variant: small-caps;\"> Duplication of notice</legend> ";
...
echo "<option value='-1'>(choose a destination group)</option>\n";
...
echo "<button onClick=\"javascript:
			...
			return false;\"
			id=\"bouton_dupliquer\" name=\"Dupliquer\" style='font-variant: small-caps;'>Duplicate</button>";

echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button onClick=\"javascript:
			$('dupplication_notice').hide();
			return false;\"
			style='font-variant: small-caps;'>Hide</button>";			
echo "</td></tr></table>";
echo "</fieldset>";
echo "</form>";
?>
