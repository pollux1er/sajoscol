<?php
/*
 * $Id: ajax_liste_notices_privees.php 6889 2011-05-08 11:59:42Z crob $
 *
...
if($id_groupe=="") {
	echo "<p style='color:red;'>The group identifier of is incorrect.</p>";
}
elseif($today=="") {
	echo "<p style='color:red;'>The format of the date (<i>timestamp</i>) is incorrect.</p>";
}
else {
	require("cdt_lib.php");
