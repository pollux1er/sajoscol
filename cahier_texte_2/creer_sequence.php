...
// Gestion des erreurs
if ($verif == 'no'){
  $msg = "<p>At least one report has not be recorded !</p>";
}
 ...
 */
$use_observeur = "ok";
$titre_page = "Create sequences for the text book";
...
<form action="#" method="post">
  <p>
    <label for="idSeq">Create a sequences for the text book (<i>specify the number of meetings</i>)</label>
