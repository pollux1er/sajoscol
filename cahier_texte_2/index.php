...
echo "<button style='width: 200px;' onclick=\"javascript:
						...
						return false;
				\">Reposition the windows</button>\n";
echo "</td>";

echo "<td width='20 px'>";
echo "<a href=\"./index.php?cdt_version_pref=1\">\n";
echo "<img src='../images/icons/cdt2_1.png' alt='Use version 1 of the textbook' class='link' title='Use version 1 of the textbook'/> </a>";
...
if ($groups->isEmpty()) {
    echo "<br /><br />";
    echo "<b>No textbook is available.</b>";
    echo "<br /><br />";
}
...
echo "<a href='creer_sequence.php'>Prepare a whole sequence</a></td>";
