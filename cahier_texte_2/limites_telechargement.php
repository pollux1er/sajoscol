...
echo "<p>The maximum disk space authorized for the group <i>".$current_group["description"]."</i> is : <b>".$total_max_size_ko." Ko</b>.";

echo "<p>Total size of the files currently stored for the group <i>".$current_group["description"]."</i> is : <b>".$result." Ko</b>.</p>";

?>

<H2>Types of files authorized on download</h2>
<p>Below the table of the authorized extensions. If you wish to make add one or more extensions,
<?php
         echo("<a href=\"javascript:centrerpopup('../gestion/contacter_admin.php',600,480,'scrollbars=yes,statusbar=no,resizable=yes')\">contact the administrator</a>");
?>
</p>
<center>
