	...
	<h3>Choose your school according to its RNE : </h3>
		...
		<form method="get" action="login_sso.php" id="liste_rne">
			...
			<select name="rne" onchange="document.getElementById('liste_rne').submit();">
				<option value="RNE">Choice of the rne</option>
<?php
	echo $aff_options;
?>
			</select>
...
<p>We are the <?php echo date("d m Y"); ?> &agrave; <?php echo date("h:i:s"); ?> and your IP address is <?php echo $_SERVER["REMOTE_ADDR"] ; ?>.</p>
