		...
		echo "<ul>\n";
			...
			echo "<li>to break the connections&nbsp;:<br />That would mean that you would have two distinct courses then for $classe and a class sharing the course.<br />For the professor the consequences are as follows&nbsp;:<br />\n";
				echo "<ul>\n";
					...
					echo "<li>For the existing notes, a new group should be created, a new report card, cloner exams and box to transfer the notes to it and cause the recalculation of the averages of containers.<br />Les saisies de cahier de textes, d'emploi du temps doivent être dupliquées, les saisies antérieures d'absences peuvent-elles être perturbées (?) ou l'association n'est-elle que élève/jour_heures_absence (?),...</li>";
				echo "</ul>\n";
