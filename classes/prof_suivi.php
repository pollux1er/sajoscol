	...
	While ($k < $nombreligne) {
		...
		if($num_eleve!=-1){
			...
			if (($reg_prof == '') and ($eleve_profsuivi != '')) {
				...
				updateOnline("DELETE FROM j_eleves_professeurs WHERE (login='$login_eleve' AND id_classe='$id_classe')");
			}
			...
			updateOnline("UPDATE j_eleves_professeurs SET professeur ='$reg_prof' WHERE (login='$login_eleve' AND id_classe='$id_classe')");
			}
			if  (($reg_prof != '') and ($eleve_profsuivi == '')) {
...
//**************** EN-TETE **************************************
$titre_page = "Management of classes | ".ucfirst(getSettingValue("gepi_prof_suivi"));
...
echo "<p class='bold'><a href='classes_const.php?id_classe=$id_classe'><img src='../images/icons/back.png' alt='Return' class='back_link'/> Return </a>";
...
?>
	...
	?> : specify the number in the class :</p>
...
?>
	<p>Pour chaque <?php echo getSettingValue("gepi_prof_suivi"); ?>, specify the professor : </p>
	<?php
	$call_profsuivi = mysql_query("SELECT DISTINCT professeur FROM j_eleves_professeurs WHERE id_classe='$id_classe'");
	...
	if ($etape2 == 'no') {
		echo "<p>You did not define ".getSettingValue("gepi_prof_suivi")." !</p>\n";
		echo "<form enctype=\"multipart/form-data\" action=\"prof_suivi.php\" method=post>\n";
		...
		if ($nombreligne == '0') {
			...
			echo "<p>Click on the button \"Save\" to validate.</p>\n";
			echo "<center><input type='submit' value='Save' /></center><br />\n";
			$k = '0';
			echo "<table border='1' cellpadding='5' class='boireaus' summary='Choice of students'>\n";
			echo "<tr><th>Name First name</th>\n";
			for ($i=1; $i < $nb_prof_suivi+1; $i++) {
				...
				echo "<a href=\"javascript:CocheColonne(".$i.")\"><img src='../images/enabled.png' width='15' height='15' alt='Check all' /></a>";
				//echo " / <a href=\"javascript:DecocheColonne(".$i.")\"><img src='../images/disabled.png' width='15' height='15' alt='Tout décocher' /></a>";
				echo "</p></th>\n";
			}
			echo "<th><p class='small'>No ".getSettingValue("gepi_prof_suivi")."<br />\n";
			echo "<a href=\"javascript:CocheColonne(".$i.")\"><img src='../images/enabled.png' width='15' height='15' alt='Check all' /></a>";
			echo "</p></th>\n";
			echo "</tr>\n";
