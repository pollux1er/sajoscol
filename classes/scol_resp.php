		...
		for($i=0;$i<count($scol_login);$i++){
			if(isset($_POST['case_'.$i.'_'.$j])){
				...
				if(mysql_num_rows($test)==0){
					...
					updateOnline($sql);
					if(!$reg_data){
						$msg.= "Error during the insertion of a new record $tab_id_clas[$j] for $scol_login[$i].";
						$notok = true;
					}
				}
				...
				if(mysql_num_rows($test)>0){
					...
					updateOnline($sql);
					if(!$reg_data){
						$msg.= "Error during the suppression of the record $tab_id_clas[$j] for $scol_login[$i].";
						$notok = true;
					}
				}
			}
...
if(!isset($quitter_la_page)){
	echo "<p class='bold'>";
	echo "<a href='index.php' onclick=\"return confirm_abandon (this, change, '$themessage')\"><img src='../images/icons/back.png' alt='Return' class='back_link'/> Return </a>";
	echo "</p>\n";
}
else{
	...
	echo "<p class='bold'>";
	echo "<a href='index.php' onClick=\"if(confirm_abandon (this, change, '$themessage')){self.close()};return false;\"><img src='../images/icons/back.png' alt='Return' class='back_link'/> close the page </a>";
	echo "</p>\n";
...
<p>Assign the classes to the accounts schooling.</p>
...
<?php
	...
	$ligne_comptes_scol.="<th style='text-align:center; font-weight:bold;'>Accounts</th>\n";
	...
	for($i=0;$i<$nb;$i++){
		...
		echo "<a href=\"javascript:modif_case($i,true,'col');changement();\"><img src='../images/enabled.png' width='15' height='15' alt='Check all' /></a>/\n";
		//echo "<a href='javascript:modif_case($i,false)'><img src='../images/disabled.png' width='15' height='15' alt='Tout décocher' /></a>\n";
		echo "<a href=\"javascript:modif_case($i,false,'col');changement();\"><img src='../images/disabled.png' width='15' height='15' alt='Uncheck all' /></a>\n";
	...
	if ($nombre_lignes != 0) {
		...
		while($lig_clas=mysql_fetch_object($call_data)){
			...
			echo "<td>\n";
			echo "<a href=\"javascript:modif_case($j,true,'lig');changement();\"><img src='../images/enabled.png' width='15' height='15' alt='Check all' /></a>/\n";
			//echo "<a href='javascript:modif_case($i,false)'><img src='../images/disabled.png' width='15' height='15' alt='Tout décocher' /></a>\n";
			echo "<a href=\"javascript:modif_case($j,false,'lig');changement();\"><img src='../images/disabled.png' width='15' height='15' alt='Uncheck all' /></a>\n";
			echo "</td>\n";
			echo "</tr>\n";
			$j++;
		}
