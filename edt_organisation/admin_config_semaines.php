...
if ($action === "visualiser") {
	...
	//====================================
	// header
	$titre_page = "Definition of the types of week of the school";
	...
	<div id="lecorps">
		...
		<h2>Definition of the types of weeks</h2>
		...
		<div style="text-align: center;">			
			<form method="post" action="admin_config_semaines.php?action=<?php echo $action; ?>" name="form1">
				...
				<tbody>
					<tr>
						<th class="tab_th" style="width: 100px;">Week n°<br /> (official)</th>
						<th class="tab_th" style="width: 100px;">Intern<br />number
						<br />
						<a href="javascript: numerotation_auto()" title="Automatic classification;leave empty the fields not be treated"><img src="../images/icons/wizard.png" width="16" height="16" alt="Automatic classification according to the first field" /></a>
						</th>
						<th class="tab_th" style="width: 100px;">Type
						<br />
						<a href="javascript: alterne_auto_semaines_AB()" title="Alternate the weeks A and B;leave empty the fields not be treated"><img src="../images/icons/wizard.png" width="16" height="16" alt="Alternate the weeks A/B" /></a>
						</th>
						<th class="tab_th" style="width: 200px;">From</th>
						<th class="tab_th" style="width: 200px;">to</th>
					</tr>
					<?php
