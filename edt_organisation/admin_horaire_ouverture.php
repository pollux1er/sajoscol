...
// ===================================================================
// header
$titre_page = "Timetables of opening of the school";
									...
									<div class="art-post-inner art-article">
										<div class="art-postmetadataheader">
											<h2 class="art-postheader">
												Definition of the schedules of opening of the school
											</h2>
										</div>
...
<?php /* gestion des horaire d'ouverture */ ?>
  ...
  <form method="post" action="admin_horaire_ouverture.php?action=<?php echo $action; ?>" name="form1">
	<table cellpadding="0" cellspacing="1" class="tab_table" summary="Timetables of opening">
	  <tbody>
	    <tr>
	    ...
	    <tr class="couleur_ligne_1">
	      <td class="tab_td_donnee_cote">Opened</td>
	      <?php $i = '0';
		while ( $i < '7' ) { ?>
	    ...
	    <tr class="couleur_ligne_2">
	      <td class="tab_td_donnee_cote">Opening at</td>
	      <?php $i = '0';
		while ( $i < '7' ) { ?>
	    ...
	    <tr class="couleur_ligne_1">
	      <td class="tab_td_donnee_cote">Closing at</td>
	      <?php $i = '0';
		while ( $i < '7' ) { ?>
	    ...
	    <tr class="couleur_ligne_2">
	      <td class="tab_td_donnee_cote">Time of pause</td>
	      <?php $i = '0';
		while ( $i < '7' ) { ?>
	    ...
	    <tr class="couleur_ligne_1">
	      <td class="tab_td_donnee_cote">Time Day</td>
	      <?php $i = '0';
		while ( $i < '7' ) { ?>
