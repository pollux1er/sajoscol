...
if ( getSettingValue("autorise_edt_tous") === 'y') {
	if ($IE6) {
		echo "<div class=\"cadreInformation\">Votre navigateur (Internet Explorer 6) is obsolete and behaves badly with respect to the display of the
timetables. Absolutely make an update towards versions 7 or 8 or change navigator (FireFox, Chrome, Opera, Safari)</div>";
	}
