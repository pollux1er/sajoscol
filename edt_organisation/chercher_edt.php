...
if ($_GET["cherch_salle"] == "ok") {
	if (isset($_GET["ch_heure"])) {
		...
		echo ("You must choose a crenel, back !");

	if (isset($_GET["ch_jour_semaine"])) {
		$auto_aff_22 = 1;
	}
	else
		echo ("You must choose one day of the week, back !");
...
This page is used to find the rooms of courses occupied and free to a
schedule of the week.

For that, please choose a crenel and a day of the week:
...
echo '
	<select name="ch_heure">
		<option value=\'rien\'>Timetable</option>
	';
