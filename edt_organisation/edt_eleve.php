...
if (isset($_SESSION["login"])) {
	...
	if ($autorise == 'oui') {
		...
		$aff_nom_edt = '<span style="font-weight: bold;">Timetable of '.$aff_nom_edt."</span>\n";

	}else{

		DIE('You cannot see the timetable of this user.');
...
<div id="edteleve">
	...
	<p class="bold">
		<a href="../accueil.php"><img src='../images/icons/back.png' alt='Return' class='back_link'/> Return to Home</a></p>
