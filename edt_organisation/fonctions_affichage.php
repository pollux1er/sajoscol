...
function EdtDuJourVertical($tab_data, $jour, $flags) 
{
    ...
    while (isset($tab_data[$jour]['type'][$index_box]))
    {
        if ($tab_data[$jour]['type'][$index_box] == "vide") {
            ...
            $result .= "<div style=\"display:none;\">".$tab_data[$jour]['affiche_creneau'][$index_box]." - duration = ".$tab_data[$jour]['duree_valeur'][$index_box]." hour(s)</div>\n";
    ...
    while (isset($entetes['entete'][$jour])) {
        ...
        while (isset($tab_data[$jour]['type'][$index_box]))
        {
            if ($tab_data[$jour]['type'][$index_box] == "vide") {
                ...
                echo("<div style=\"display:none;\">".$tab_data[$jour]['affiche_creneau'][$index_box]." - duration = ".$tab_data[$jour]['duree_valeur'][$index_box]." hour(s)</div>\n");
...
function AfficheBarCommutateurPeriodes($login_edt, $visioedt, $type_edt_2)
{
    ...
    echo "<li>Visualized period : ".$rep_periode['nom_calendrier']."</li>";
    echo "</ul>";
...
function AfficheBarCommutateurPeriodesEleve()
{
    ...
    echo "<ul class=\"Period\">";
    echo "Visualized period : ".$rep_periode['nom_calendrier'];
    echo "</ul>";
...
function AfficheBascule($display_commutator, $login_edt, $visioedt, $type_edt_2)
{
    ...
    if ($display_commutator) {
        if (!isset($_SESSION['bascule_edt'])) {
            ...
            echo "<a href=\"./index_edt.php?bascule_edt=semaine&amp;visioedt=".$visioedt."&amp;login_edt=".$login_edt."&amp;type_edt_2=".$type_edt_2."\"><img src=\"../templates/".NameTemplateEDT()."/images/bascule_periode2.png\" title=\"Go to week timetable\" alt=\"Go to week timetable\" /></a>";
            echo "</div>";
        }
            ...
            echo "<div class=\"ButtonBarCommutator\">";
            echo "<a href=\"./index_edt.php?bascule_edt=periode&amp;visioedt=".$visioedt."&amp;login_edt=".$login_edt."&amp;type_edt_2=".$type_edt_2."\"><img src=\"../templates/".NameTemplateEDT()."/images/bascule_semaine2.png\" title=\"Go to week timetable\" alt=\"Go to week timetable\" /></a>";
            echo "</div>";
        }
    }
}
