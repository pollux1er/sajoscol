    ...
    while (isset($tab_id_creneaux[$j]) AND !$erreur) {
        ...
        // ========================================== 3 cours
            ...
            if (($tab_cas['cas_detecte'] >= 22) AND ($tab_cas['cas_detecte'] <=30)) {  
                ...
                $erreur = true;
                echo "<div class= \"cadreInformation\">Error on the generation of the timetable : ".$tab_cas['cas_detecte']."</div>";
            }
        ...
        else
        {
			...
			$case_tab = "<a href='#' onclick=\"afficher_div('".$id_div."','n',0,0);return false;\"><img src=\"../templates/".NameTemplateEDT()."/images/voir.png\" title=\"see the courses\" alt=\"see the courses\" /> </a>".creer_div_infobulle($id_div, "Liste des enseignements", "#330033", $contenu, "#FFFFFF", 20,0,"y","n","y","n")."\n";
...
while (isset($jour_sem_tab[$jour])) {
    ...
    while (isset($tab_id_creneaux[$j]) AND !$erreur) {
        ...
        else
        {
			...
			$id_div = "ens_".$tab_id_creneaux[$j]."_".$jour_sem_tab[$jour]."_".$id_groupe;
			$case_tab = "<a href='#' onclick=\"afficher_div('".$id_div."','n',0,0);return false;\"><img src=\"../templates/".NameTemplateEDT()."/images/voir.png\" title=\"see the courses\" alt=\"see the courses\" /> </a>".creer_div_infobulle($id_div, "List of courses", "#330033", $contenu, "#FFFFFF", 20,0,"y","n","y","n")."\n";
