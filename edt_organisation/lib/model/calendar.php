		...
		if ($calendriers) {
			...
			while (isset($calendriers['id'][$i])) {
				...
				$result.="<div class=\"bouton_loupe\">
							...
							<img src=\"./lib/template/images/loupe.png\" alt=\"See the calendar periods\" title=\"see the calendar periods\"/>
							</a>
							</div>";
				$result.="<div class=\"bouton_supprimer\">
							...
							<img src=\"./lib/template/images/erase.png\" alt=\"Delete\" title=\"Delete the calendar\"/>
							</a>
							</div>";
				$result.="<div class=\"bouton_modifier\">
							...
							<img src=\"./lib/template/images/modif.png\" alt=\"modify the name\" title=\"modify the name of the calendar\"/>
							</a>
							</div>";				
				$result .= "</div>";
				...
				$result .="<input type=\"submit\" value=\"Validate the classes\">";
				$result .="</form>";
				$result.="</div></div>";
				$i++;
			}
