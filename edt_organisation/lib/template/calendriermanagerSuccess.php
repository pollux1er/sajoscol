                                ...
                                <div class="art-post-body">
									<div class="art-post-inner art-article">
                                            <div class="art-postcontent">
                                                <!-- article-content -->
												<div style="font-size:12px;color:white;width:80%;text-align:center;margin:10px auto;padding:10px;background-color:#9571dd;">[Manager of calendars] : Define here your various calendars to which you associate the classes concerned.</div> 
									...
									<div class="art-post-inner art-article">
                                            <div class="art-postcontent">
												...
												<fieldset>
													...
													<input name="nom_calendrier" style="width:200px;" type="text" title="Enter the name of the new calendar">
													<input name="bouton_submit" type="submit" value="Create a new calendar">
												</fieldset>
												</form>
												</div>
                                                <div class="cleared"></div>
