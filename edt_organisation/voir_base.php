...
$titre_page = "Timetable - See the base";
...
if ($_SESSION["statut"] != "administrateur") {
	Die('You must ask for to your administrator the authorization to see this page.');
}
...
<h2><strong>See the table edt_cours</strong></h2>
<?php
	...
	echo "<div class=\"titre_voir_base_7\"><a href=\"./voir_base.php?trier=6\" >duration</a></div>";
	...
	echo "<div style=\"float:left;text-align:center;font-size:45%;padding:3px;margin:1px;border:1px solid black;width:20%;background-color:#FAFFBD;\"><a href=\"./voir_base.php?start_list=".$previous_start."&amp;trier=".$trier." \" >previous</a></div>";
	echo "<div style=\"float:left;text-align:center;font-size:45%;padding:3px;margin:1px;border:1px solid black;width:20%;background-color:#FAFFBD;\"><a href=\"./voir_base.php?start_list=".$next_start."&amp;trier=".$trier." \" >Next</a></div>";    
    echo "<div style=\"clear:both;\"></div>";
