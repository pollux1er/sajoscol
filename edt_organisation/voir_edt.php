...
if(isset($login_edt)){
    ...
    if ($type_edt == "prof")
    {
		...
		if(mysql_num_rows($test)==0) {
			...
			$tab_data=array();
			$msg="<b>ANOMALY&nbsp;:</b> Courses of null duration disturb the display.<br />Contact the administrator for a ";
			if($_SESSION['statut']=='administrateur') {
				$msg.="<a href='verifier_edt.php'>Cleaning of the tables</a>";
			}
			else {
				$msg.="Cleaning of the tables";
			}
			$msg.=" relating to the EDT.";
		}
    ...
    else if ($type_edt == "salle")
    {
		...
		if(mysql_num_rows($test)==0) {
			...
			$tab_data=array();
			$msg="<b>ANOMALIE&nbsp;:</b> Courses of null duration disturb the display.<br />Contact the administrator for a ";
			if($_SESSION['statut']=='administrateur') {
				$msg.="<a href='verifier_edt.php'>Cleaning of the tables</a>";
			}
			else {
