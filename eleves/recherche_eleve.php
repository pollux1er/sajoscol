...
/*
	$Id: recherche_eleve.php 8739 2012-01-06 12:35:33Z crob $
*/
...
//echo $string;
	...
	if($nb_ele>0){
		...
		echo "<p>Research returned <b>$nb_ele</b> answer";
		if($nb_ele>1) {echo "s";}
		echo ":</p>\n";
		echo "<table border='1' class='boireaus' summary='List of students'>\n";
		echo "<tr>\n";
		//echo "<th>Elève</th>\n";
		echo "<th><a href='".$page."?page=$page";
		if(isset($rech_nom)) {echo "&amp;rech_nom=$rech_nom";}
		if(isset($rech_prenom)) {echo "&amp;rech_prenom=$rech_prenom";}
		echo "&amp;Recherche_sans_js=y'>Student</a></th>\n";

		echo "<th><a href='".$page."?order_by=classe";
		if(isset($rech_nom)) {echo "&amp;rech_nom=$rech_nom";}
		if(isset($rech_prenom)) {echo "&amp;rech_prenom=$rech_prenom";}
		echo "&amp;page=$page&amp;Recherche_sans_js=y'>Class(es)</a></th>\n";
		echo "</tr>\n";
		$alt=1;
