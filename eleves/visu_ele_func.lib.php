...
;
	...
	*/
	...
	echo "<table width='$releve_largeurtableau' border='0' cellspacing='".$releve_cellspacing."' cellpadding='".$releve_cellpadding."' summary='Report booklet'>\n";
	...
	echo "<p class='bulletin'><span class=\"releve_grand\">Class of ".$tab_rel['periodes'][$index_per]['nom_complet']."<br />School year ".$gepiYear."</span><br />\n";

	echo "<b>".$tab_rel['periodes'][$index_per]['nom_periode']."</b> :Report booklet";
	echo "</p>\n";
	...
	*/
	...
	echo "<table width=\"$larg_tab\" class='boireaus' border='1' cellspacing='3' cellpadding='3' summary='Courses/notes/appreciations'>\n";
	//echo "<table width=\"$larg_tab\"$releve_class_bordure border='1' cellspacing='3' cellpadding='3'>\n";
	echo "<tr>\n";
	echo "<td width=\"$larg_col1\" class='releve'><b>Course</b><br /><i>Professor</i></td>\n";
	...
	if(($tab_rel['rn_sign_chefetab']=='y')||($tab_rel['rn_sign_pp']=='y')||($tab_rel['rn_sign_resp']=='y')){
		...
		if($tab_rel['rn_sign_resp']=='y'){
			echo "<td width='$largeur_case'>\n";
			echo "<b>Signature of the responsibles:</b>";
			for($m=0;$m<$tab_rel['rn_sign_nblig'];$m++) {
				echo "<br />\n";
			}
			echo "</td>\n";
	...
	if (($releve_formule_bas != '') and ($releve_affiche_formule == 'y')) {
		...
		echo "<table width='$releve_largeurtableau' style='margin-left:5px; margin-right:5px;' border='0' cellspacing='".$releve_cellspacing."' cellpadding='".$releve_cellpadding."' summary='Formula of bottom of page'>\n";
		echo "<tr>";
