...
for ($i=0;$i<$nb_fiches;$i++) {
	echo "<p>To attention of  <span class = \"bold\">" . $nom . " " . $prenom . "</span>";
	echo "<br />Name of login : <span class = \"bold\">" . $identifiant. "</span>";
	echo "<br />Password : <span class = \"bold\">" . $mdp . "</span>";
	echo "<br />E-mail Adresse  : <span class = \"bold\">" . $email . "</span>";
	echo "</p>";

	echo "<p style='font-variant:small-caps;color:red;'>The line giving the password of the user is reproduced on the
card <b>ONLY IF</b> it is printed during the creation of the user.</p>";
