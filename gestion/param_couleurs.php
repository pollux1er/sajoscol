<?php
/*
 * $Id: param_couleurs.php 8404 2011-10-01 13:46:23Z crob $
 *
...
elseif(isset($_POST['valide_import_couleurs'])) {
	...
	if(!is_uploaded_file($csv_file['tmp_name'])) {
		...
		$msg.="<p>Variables of php.ini can perhaps explain the problem:<br />\n";
		$msg.="post_max_size=$post_max_size<br />\n";
		$msg.="upload_max_filesize=$upload_max_filesize<br />\n";
	}
	else {
		if(!file_exists($csv_file['tmp_name'])){
			$msg="The file would have been uploaded... but would not be present/preserved.<br />\n";

			$msg.="The variables of php.ini can perhaps explain the problem:<br />\n";
			$msg.="post_max_size=$post_max_size<br />\n";
			$msg.="upload_max_filesize=$upload_max_filesize<br />\n";
			...
			*/
				...
				if(!$fp) {
					$msg="Error during the opening of the file $dest_file<br />\n";
				}
				else {
					$msg="";
					$cpt_reg=0;
					while (!feof($fp)) {
						...
						if($ligne!="") {
							...
							if(!in_array($nom, $tab_items)) {
								$msg.="Item '$nom' unknown (not imported).<br />";
							}
							else {
								if(!saveSetting($nom, $valeur)) {
									$msg.="Error during the recording of item '$nom' with the value '$valeur'.<br />";
								}
								else {
									$cpt_reg++;
								}
					...
					if($cpt_reg>0) {
						...
						$msg.="Validate the form at the foot of the page to regenerate the file of CSS styles .<br />";
					}
				}
...
if(isset($_POST['is_posted'])) {
	...
	if($reinitialiser=='y') {
		if(saveSetting('style_body_backgroundcolor','')) {
			...
			fwrite($fich,"/*
This file is intended to receive parameters preset in the page /gestion/param_couleurs.php
Charged before the section <body> in the /lib/header.inc,
its properties crush the properties defined before in </head>.
*/
");
			fclose($fich);
			$msg.="Re-initialization done.";
		}
		else {
			$msg.="Error during the Re-initialization.";
		}
	}
	else {
		$temoin_modif=0;
		...
		if(isset($_POST['utiliser_couleurs_perso'])) {
			if(!saveSetting('utiliser_couleurs_perso','y')) {
				$msg.="Error during the safeguard of 'utiliser_couleurs_perso'. ";
				$nb_err++;
			}
...
");
					...
					$msg.="Error at the time of the safeguard of 'style_body_backgroundcolor'. ";
					$nb_err++;
				}
			}
		}
			...
			if(!saveSetting('utiliser_couleurs_perso','n')) {
				$msg.="Error at the time of the safeguard of 'utiliser_couleurs_perso'. ";
				$nb_err++;
			}
...
");
		...
		if(isset($_POST['utiliser_degrade'])) {
			if(!saveSetting('utiliser_degrade','y')) {
				$msg.="Error at the time of the safeguard of 'utiliser_degrade'. ";
				$nb_err++;
			}
			...
			if(isset($_POST['degrade_haut'])) {
				...
				if(saveSetting('degrade_haut',$degrade_haut)) {
					...
					$msg.="Error at the time of the safeguard of 'degrade_haut'. ";
					$nb_err++;
				}
			}
			...
			if(isset($_POST['degrade_bas'])) {
				...
				if(saveSetting('degrade_bas',$_POST['degrade_bas'])) {
					...
					$msg.="Error at the time of the safeguard of 'degrade_bas'. ";
					$nb_err++;
				}
			}
...
*/
		...
		if(isset($_POST['utiliser_couleurs_perso_infobulles'])) {
			if(!saveSetting('utiliser_couleurs_perso_infobulles','y')) {
				$msg.="Error at the time of the safeguard of 'utiliser_couleurs_perso_infobulles'. ";
				$nb_err++;
			}
			...
			if(isset($_POST['couleur_infobulle_fond_entete'])) {
				...
				if(saveSetting('couleur_infobulle_fond_entete',$couleur_infobulle_fond_entete)) {
					...
					$msg.="Error during safeguard of 'couleur_infobulle_fond_entete'. ";
					$nb_err++;
				}
			}
			...
			if(isset($_POST['couleur_infobulle_fond_corps'])) {
				...
				if(saveSetting('couleur_infobulle_fond_corps',$couleur_infobulle_fond_corps)) {
					...
					$msg.="Error during safeguard of 'couleur_infobulle_fond_corps'. ";
					$nb_err++;
				}
			}
...
");
		...
		if(isset($_POST['utiliser_couleurs_perso_lig_tab_alt'])) {
			if(!saveSetting('utiliser_couleurs_perso_lig_tab_alt','y')) {
				$msg.="Error during the safeguard of 'utiliser_couleurs_perso_lig_tab_alt'. ";
				$nb_err++;
			}
			...
			if(isset($_POST['couleur_lig_entete'])) {
				...
				if(saveSetting('couleur_lig_entete',$couleur_lig_entete)) {
					...
					$msg.="Error during the safeguard of 'couleur_lig_entete'. ";
					$nb_err++;
				}
			}
			...
			if(isset($_POST['couleur_lig_alt1'])) {
				...
				if(saveSetting('couleur_lig_alt1',$couleur_lig_alt1)) {
					...
					$msg.="Error during the safeguard of 'couleur_lig_alt1'. ";
					$nb_err++;
				}
			}
			...
			if(isset($_POST['couleur_lig_alt_1'])) {
				...
				if(saveSetting('couleur_lig_alt_1',$couleur_lig_alt_1)) {
					...
					$msg.="Error during the safeguard of 'couleur_lig_alt_1'. ";
					$nb_err++;
				}
			}
...
");
				...
				$msg.="Error during the safeguard of 'couleur_fond_postit'. ";
				$nb_err++;
			}
		}
		//=========================================
...
");
					...
					$msg.="Error during the safeguard of 'style_panneau_affichage'.<br />";
					$nb_err++;
				}
			}
			else {
				$msg.="Value of 'style_panneau_affichage' incorrect.<br />";
				$nb_err++;
			}
		}
		...
		if(isset($_POST['utiliser_cahier_texte_perso'])) {
			if(!saveSetting('utiliser_cahier_texte_perso','y')) {
				$msg.="Error during the safeguard of 'utiliser_cahier_texte_perso'. ";
				$nb_err++;
			}
			...
			for($i=0;$i<count($poste_notice_nom);$i++) {
				if(isset($_POST[$poste_notice_nom[$i]])) {
					...
					if(saveSetting($poste_notice_nom[$i],$couleur_poste)) {
						...
						$msg.="Error during the safeguard of '".$poste_notice_nom[$i]."'. ";
						$nb_err++;
					}
				}
...
//**************** EN-TETE *****************
$titre_page = "Colors and Model of GEPI";
...
//echo "<div class='norme'><p class='bold'><a href='param_gen.php'><img src='../images/icons/back.png' alt='Retour' class='back_link'/> Retour</a>\n"; ?>
	...
	<p class='bold'>
		...
		<a href='index.php#param_couleurs'><img src='../images/icons/back.png' alt='' class='back_link'/> Return</a>
		| Model choice&nbsp;:
		<select name='choix_modele' id='choix_modele' onchange="valide_modele($('choix_modele').options[$('choix_modele').selectedIndex].value)">
			...
			<option value='ngb'>Black_Gray_White</option>
		</select>
		<?php }	else { ?>
		<a href='param_couleurs.php'><img src='../images/icons/back.png' alt='' class='back_link'/> Return</a>
		<?php } ?>
		| <a href='param_couleurs.php?export_couleurs=y'>Export the colors of your model</a>
		| <a href='param_couleurs.php?import_couleurs=y'>Import the colors from a CSV</a>
	</p>
	</div>
<?php
...
if((isset($_GET['import_couleurs']))&&($_GET['import_couleurs']=='y')) {
	...
	echo "<p>Please provide the file of CSV of the correspondences of your model of color&nbsp;:<br />\n";
...
<p>Define the colors for interface GEPI and manage your models.
...
echo add_token_field();
	echo "<h2><strong>Colors:</strong></h2>\n";
	// echo "<blockquote>\n";
		echo "<div class='tableau_param_couleur'>\n";
			// echo "<tr>\n";
				// echo "<td>\n";
					...
					echo "/> ";
					echo "<label for='utiliser_couleurs_perso' style='cursor: pointer;'>Use custom colors.</label>\n";
				// echo "</td>\n";
			// echo "</tr>\n";
			// echo "<tr>\n";
			// 	echo "<td>\n";
			...
			// 	echo "</td>\n";
				// echo "<td>\n";
					echo "<table class='tableau_change_couleur' summary=\"background change of color : column 3 red, column 4 green, column 5 blue, column 7 validation\">\n";
						...
						for($i=0;$i<count($tab);$i++) {
							echo "<tr>\n";
								...
								echo "<a href='#' onclick='reinit_couleurs(\"$tab[$i]\");return false;'>Re-initialize</a>\n";
	...
	// echo "<blockquote>\n";
		echo "<div class='tableau_param_couleur'>\n";
			// echo "<tr>\n";
				...
				// echo "</td>\n";
				// echo "<td>\n";
					echo "<label for='utiliser_degrade' style='cursor: pointer;'>Generate/use a degradé personalized for the heading of page.</label>\n";
				// echo "</td>\n";
			// echo "</tr>\n";
			...
			// echo "<tr>\n";
				...
				// echo "</td>\n";
				// echo "<td>\n";
					echo "<table class='tableau_change_couleur' summary=\"stringcourse change of color : line 2 dégradé haut, line 3 dégradé bas, column 2 rouge, column 3 vert, column 4 bleu, column 6 validation\">\n";
						echo "<tr class='fond_blanc'>\n";
							echo "<td class='texte_gras'>Couleur</td>\n";
							for($j=0;$j<count($comp);$j++) {
								echo "<td class='texte_gras'>$comp[$j]</td>\n";
							}
							echo "<td class='texte_gras'>Preview</td>\n";
							echo "<td class='texte_gras'>Re-initialization</td>\n";
							...
							echo "/><label for='degrade_double_bandeau'> Use a double dégradé on the stringcourse of heading.</label><br />\n";
							...
							echo "/><label for='degrade_double_bandeau_small'> Use a double dégradé on the reduced stringcourse of heading.</label><br />\n";
							...
							echo "/><label for='degrade_double_barre_menu'> Use a double dégradé on the bar of menus.</label><br />\n";
							echo "</td>\n";
						echo "</tr>\n";
						...
						for($i=0;$i<count($tab_degrade);$i++) {
							echo "<tr>\n";
								...
								echo "<td>\n";
									echo "<a href='#' onclick='reinit_couleurs(\"$tab_degrade[$i]\");return false;'>Re-initialize</a>\n";
								echo "</td>\n";
	...
	echo "<h2><strong>Colors of 'infobulles':</strong></h2>\n";
	// echo "<blockquote>\n";
		echo "<div class='tableau_param_couleur'>\n";
		// echo "<tr>\n";
			// echo "<td>\n";
			...
			// echo "</td>\n";
			// echo "<td>\n";
				echo "<label for='utiliser_couleurs_perso_infobulles' style='cursor: pointer;'>Use custom colors for the infobulles.</label>\n";
			// echo "</td>\n";
		// echo "</tr>\n";
		...
		// echo "<tr>\n";
			...
			// echo "</td>\n";
			// echo "<td>\n";
				echo "<table class='tableau_change_couleur' summary=\"infobulles change of colors : line 2 heading, line 3 body, column 2 red, column 3 green, column 4 blue, column 6 validation\">\n";
					...
					echo "<tr>\n";
						echo "<td>\n";
							echo "Background color of the heading of the infobulles\n";
						echo "</td>\n";
						for($j=0;$j<count($comp);$j++) {
							/*
							$sql="SELECT value FROM setting WHERE name='".$tab[$i]."_".$comp[$j]."'";
						...
						echo "&nbsp;&nbsp;&nbsp;</td>\n";
						echo "<td>\n";
							echo "<a href='#' onclick='reinit_couleurs(\"couleur_infobulle_fond_entete\");return false;'>Re-initialize</a>\n";
						echo "</td>\n";
						echo "</tr>\n";

						echo "<tr>\n";
							echo "<td>\n";
								echo "Background color of the body of the infobulles";
							echo "</td>\n";
							for($j=0;$j<count($comp);$j++) {
								/*
								$sql="SELECT value FROM setting WHERE name='".$tab[$i]."_".$comp[$j]."'";
							...
							echo "&nbsp;&nbsp;&nbsp;</td>\n";
							echo "<td>\n";
								echo "<a href='#' onclick='reinit_couleurs(\"couleur_infobulle_fond_corps\");return false;'>Re-initialize</a>\n";
							echo "</td>\n";
						echo "</tr>\n";
	...
	echo "<h2><strong>Colors of the lines alternated in the tables:</strong></h2>\n";
		echo "<div class='tableau_param_couleur'>\n";
					...
					echo "/> ";
					echo "<label for='utiliser_couleurs_perso_lig_tab_alt' style='cursor: pointer;'>colors of the tables.</label>\n";

					echo "<table class='tableau_change_couleur' summary=\"table change of color : line 2 odd lines, line 3 even lines, column 2 red, column 3 green, column 4 blue, column 6 validation\">\n";
						...
						echo "<tr>\n";
							...
							echo "&nbsp;&nbsp;&nbsp;</td>\n";
							echo "<td>\n";
								echo "<a href='#' onclick='reinit_couleurs(\"couleur_lig_entete\");return false;'>Re-initialize</a>\n";
							echo "</td>\n";
						echo "</tr>\n";

						echo "<tr>\n";
							echo "<td>Color of line 1";
							echo "</td>\n";
							for($j=0;$j<count($comp);$j++) {
								echo "<td>\n";
							...
							echo "&nbsp;&nbsp;&nbsp;</td>\n";
							echo "<td>\n";
								echo "<a href='#' onclick='reinit_couleurs(\"couleur_lig_alt1\");return false;'>Re-initialize</a>\n";
							echo "</td>\n";
						echo "</tr>\n";
						...
						echo "<tr>\n";
							...
							echo "&nbsp;&nbsp;&nbsp;</td>\n";
							echo "<td>\n";
								echo "<a href='#' onclick='reinit_couleurs(\"couleur_lig_alt_1\");return false;'>Re-initialize</a>\n";
							echo "</td>\n";
						echo "</tr>\n";
		...
		echo "<div class='tableau_param_couleur'>\n";
			...
			echo "<table class='tableau_change_couleur' summary=\"Table of various colors\">\n";
				...
				echo "<tr>\n";
					echo "<td>Background color of the Messages in Panel of display";
					echo "</td>\n";
					for($j=0;$j<count($comp);$j++) {
						echo "<td>\n";
							echo "<label for='id_couleur_fond_postit_".$comp[$j]."' class='invisible'>".$comp[$j]." Panel ".$comp[$j]."</label>\n";
					...
					echo "&nbsp;&nbsp;&nbsp;</td>\n";
					echo "<td>\n";
						echo "<a href='#' onclick='reinit_couleurs(\"couleur_fond_postit\");return false;'>Re-initialize</a>\n";
					echo "</td>\n";
				echo "</tr>\n";
...
/* ===== couleurs du cahier de texte ===== */
	...
	echo "<h2>\n<strong>Notices textbook :</strong>\n</h2>\n";
	echo "<div class='tableau_param_couleur'>\n";
		...
		echo "/> ";
		echo "<label for='utiliser_cahier_texte_perso' style='cursor: pointer;'>Custom colors in the textbook.</label>\n";
...
//=== initialisation des couleurs ===
		...
		$tab_ct_nom_notice=array("Report of meeting","Work to made","General information","Recall of work to made");
...
// ----- Notices -----
		...
		// Titre de la notice
			...
			echo "<table class='tableau_change_couleur' summary=\"textbook change of color\">\n";
				// entête
				echo "<tr class='fond_blanc'>\n";
					echo "<td class='texte_gras'>Color</td>\n";
					for($j=0;$j<count($comp);$j++) {
						echo "<td class='texte_gras'>$comp[$j]</td>\n";
					}
					echo "<td class='texte_gras'>Preview</td>\n";
					...
					for($j=0;$j<count($tab_ct_couleur_fond);$j++) {
						if (isset($tab_ct_couleur_origine[$tab_ct_couleur_fond[$j]][$tab_ct_notice[$i]])) {
							echo "<tr>\n";
								...
								echo "</td>\n";
								echo "<td>\n";
									echo "<a href='#' onclick='reinit_couleurs(\"".$tab_ct_couleur_fond[$j]."_".$tab_ct_notice[$i]."\");return false;'>Re-initialize</a>\n";
								echo "</td>\n";
							echo "</tr>\n";
						}
					}
		...
		echo "<table class='tableau_change_couleur' summary=\"textbook change of color\">\n";
			...
			for($i=0;$i<count($tab_ct_police_bordure);$i++) {
				echo "<tr>\n";
					...
					echo "</td>\n";
					echo "<td>\n";
						echo "<a href='#' onclick='reinit_couleurs(\"".$tab_ct_police_bordure[$i]."\");return false;'>Re-initialize</a>\n";
					echo "</td>\n";
				echo "</tr>\n";
			}
		echo "</table>\n";
	...
	<div class="panneau_affichage">
		<div class="panneau_central">
			...
			<div id="panneau_centre" class="panneau_centre">	
				<div style="margin-bottom:10px;opacity:1;"><strong>Choose your display panel</strong></div>
...
/*============================================*/
	...
	// echo "<p style='text-align:center;'><input type='submit' name='ok' value='Validate' /></p>\n";
	echo "<input type='button' name='ok' value='Validate' onclick='calcule_et_valide()' />\n</p>\n";


	echo "<h2><strong>Notice:</strong></h2>";
	// echo "<blockquote>\n";
		echo "<p>It can happen that it is necessary to insist after validation so that
the navigator reloads the page well (<em>problem of mask of the navigator</em>).<br />You can force recharging with CTRL+MAJ+R.</p>\n";
	// echo "</blockquote>\n";
	...
	*/
	...
	// echo "<div class='centre_texte'>\n";
		echo "<div class='panneau_secour'>\n";
			echo "The button below is a ' safety'<br />for re-initialize colors<br />if ever you manage from there to obtain something<br />like black text on a black background.<br />\n";
			...
			echo "<input type='button' name='reinitialiser' value='Re-initialize' onclick='reinit()' />\n";
		echo "</div>\n";
	// echo "</div>\n";
