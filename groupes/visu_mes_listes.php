...
$ok=isset($_GET['ok']) ? $_GET["ok"] : NULL;
	...
	if($_SESSION['statut']=='professeur') {
		echo "<p>Select the course and the period for which you want to visualize the list of ".$gepiSettings['denomination_eleve']."s&nbsp;:</p>\n";
		...
		if(mysql_num_rows($res_grp)==0) {
			echo "<p>You apparently do not have a course.</p>\n";
			echo "</body></html>\n";
			die();
		}
		else {
	...
	elseif($_SESSION['statut']=='cpe') {
		echo "<p>Select the class and the period for which you want visu_mes_listes the list of ".$gepiSettings['denomination_eleves']."s&nbsp;:</p>\n";
		...
		echo "<p>Select the class and the period for which you want to visualize the list of ".$gepiSettings['denomination_eleves']."s&nbsp;:</p>\n";
	...
	if(mysql_num_rows($result_classes)==0) {
		echo "<p>It seems that no class was still created...<br />... or then no class was allotted to you.<br />Contact the administrator so that it carries out the suitable parameter setting in the Management of the classes.</p>\n";
	}
	else {
		$nb_classes=mysql_num_rows($result_classes);
