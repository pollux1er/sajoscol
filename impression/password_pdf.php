...
$texte_presentation = 'Caution : Your password is confidential. At your first connection, you will have to change your password.';
...
if (($donnees_personne_csv)) {
	...
	for ($i=0; $i<$nb_enr_tableau ; $i++) {
		...
		$texte = "\nA l'attention de ".$prenom." ".$nom." , classe de ".$classe.
				 " :                         Here your identifier and password for access to your notes.\nIdentifier : ".$login.
				 "\nPassword : ".$password.
				// "\nEmail : ".$email.
				 "\nAddress of Gepi site to be type in your Internet navigator  : ".$adresse_site_gepi."\n".$texte_presentation."\n\n";
...
// problème de variable de session
  $pdf->CellFitScale($l_cell_avis,$h_cell,"Error of session export pdf",1,0,'L',0); //le quadrillage
}
