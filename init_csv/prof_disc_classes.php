...
echo "<center><h3 class='gepi'>Sixth phase of initialization<br />Importation of associations Profs-course-classes (Teaching)</h3></center>\n";
...
if (!isset($_POST["action"])) {
	...
	echo "<p>You will carry out the sixth stage : it consists in importing the file <b>g_prof_disc_classes.csv</b> containing the data relating to the courses.</p>\n";
	echo "<p>CAUTION ! With this operation, you erase all the groups of course which had been defined last year. They will be crushed by those which you will import with the current procedure.</p>\n";
	...
	echo "<ul><li>Login of the professor</li>\n" .
			...
			"<li>Identifiers of class (separated by a point of exclamation ; ex : 1S1!1S2)</li>\n" .
	...
	echo "<p>Please specify the complete name of the file <b>g_prof_disc_classes.csv</b>.</p>\n";
	...
	if ($_POST['action'] == "save_data") {
		...
		if(mysql_num_rows($res_tempo4)==0) {
			echo "<p style='color:red'>ERROR&nbsp;: No association professor/course/class/type was found&nbsp;???</p>\n";
			echo "<p><br /></p>\n";
		...
		if(strtolower($csv_file['name']) == "g_prof_disc_classes.csv") {
			...
			if(!$fp) {
				...
				echo "<p><a href='prof_disc_classes.php'>Click here </a> to restart !</p>\n";
			} else {
				...
				echo "<table border='1' class='boireaus' summary='Prof/course/class/type'>\n";
				echo "<tr><th>Login prof</th><th>Course</th><th>Class(es)</th><th>Type</th></tr>\n";
			...
			echo "<a href='prof_disc_classes.php'>Click here </a> to restart !</p>\n";
