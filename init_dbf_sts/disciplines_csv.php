...
@set_time_limit(0);
/*
* $Id: disciplines_csv.php 5937 2010-11-21 17:42:55Z crob $
*
...
if (!isset($is_posted)) {
    ...
    echo "<p><b>CAUTION ...</b><br />You should proceed to this operation only if the constitution of the classes were done !</p>";
...
*/
            ...
            echo "<p>In the table below, the identifiers in red correspond to new courses in base GEPI. the identifiers in green correspond to course identifiers
detected in file GEP but already present in base GEPI.<br /><br />It is possible that certain courses below, although appearing in file GEP, are not used in your school this year. This is why it will be proposed to you at the end of the procedure of
initialsation, a cleaning of the base in order to remove these useless data.</p>";
            ...
            if ($nb_reg_no != 0) {
                ...
                echo "<p>The importation of the courses in base GEPI was carried out uccessfully!<br />You can proceed to the fourth phase of importation of the professors.</p>";
            }
            echo "<center><p><a href='prof_csv.php'>Importation of professors</a></p></center>";
        }
