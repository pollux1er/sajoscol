...
@set_time_limit(0);
/*
 * $Id: init_options.php 5937 2010-11-21 17:42:55Z crob $
 *
...
//**************** EN-TETE *****************
$titre_page = "Tool of initialization of the year | Initialization of options by GEP";
...
if ($test1 ==0) {
    ...
    if ($test2 ==0) {
        ...
        if ($test3 ==0) {
            echo "<p class='grand'>In order to proceed to the phase of definition of the options followed
by the students, you must initially carry out the first phase of importation of the students starting from the file F_ELE.DBF</p>";
            die();
        }
    }
}
...
GEPI was carried out successfully!<br />You can proceed to the next stage of importation of the principal professors.</p>\n";
echo "<center><p><a href='init_pp.php'>Importation of principal professors</a></p></center>\n";
