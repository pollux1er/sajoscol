...
?>
<p class=bold><a href="index.php"><img src='../images/icons/back.png' alt='Retour' class='back_link'/> Return to home of initialization</a></p>
<?php
...
if (!isset($step1)) {
    ...
    if ($flag != 0){
        ...
        echo "<ul><li>Only the table containing the users (professors, admin, ...) and the table connecting the courses and the professors will be
preserved.</li>";
        echo "<li>Professors of the last year present in base GEPI and not present in base GEP of this year are not erased base GEPI but simply declared \"inactive\".</li>";
        echo "</ul>";
        echo "<form enctype='multipart/form-data' action='".$_SERVER['PHP_SELF']."' method='post'>";
        echo "<input type=hidden name='step1' value='y' />";
        echo "<input type='submit' name='confirm' value='Continue the procédure' />";
        echo "</form>";
        die();
    }
}
...
if (!isset($is_posted)) {
    ...
    echo "<br /><input type='radio' name='login_gen_type' value='lcs' /> pname( LCS way)";
    echo "<br /><br /><p>Will these accounts be used as Single Sign-On with CAS or LemonLDAP ? (leave 'non' if you do not know what it is)</p>";
...
GEP but already present in base GEPI.<br /><br />It is possible that certain professors below, although appearing in file GEP, are not any more in exercise in your school this year. This is why it will be proposed to you at the end of the procedure of
initialsation, a cleaning of the base in order to remove these useless
data.</p>";
        ...
        if ($nb_reg_no != 0) {
            ...
            */
            ...
            <ul>
            <li>When a new professor is inserted in base GEPI, its password during the first connection to GEPI is that
registered in F_wind.csv.</li>
            <li>If the password is not available in the F_wind.csv file, GEPI
generates a password .</li></ul>";
            echo "<p><b>In all the cases the new user is brought to change his password
during the his first connection.</b></p>";
...
each professor, of assignment of the professors in each class and of definition of the options followed by the students.</p>";
        ...
        echo "<center><p><b><a href='prof_disc_classe_csv.php'>Proceed to the fifth phase of initialization</a></b></p></center><br /><br />";
        }
