...
if (!isset($is_posted)) {
	...
	echo "<p>Importation of the files <b>F_men.csv</b> and <b>F_gpd.csv</b> containing the data of relations between professors, course and classes.";
	echo "<form enctype='multipart/form-data' action='".$_SERVER['PHP_SELF']."' method=post>";
	echo "<p>Please specify the complete name of the file <b>F_men.csv</b>.";
	echo "<p><input type='file' size='80' name='dbf_file' />";
	echo "<p>Please specify the complete name of the file <b>F_gpd.csv</b>.";
...
*/
			...
			affiche_debug("=======================================================<br />\n");
			affiche_debug("The picking of the file was finished F_GPD<br />\n");
			affiche_debug("=======================================================<br />\n");
			unset($en_tete2);
				...
				if(!feof($fp)){
					...
					if(trim($ligne)!=""){
						...
						if ($login_prof != '') {
							...
							affiche_debug("One (at least) teacher found : $login_prof<br />\n");
							...
							if($resverif == 0) {
								...
								echo "<p>Addition of the correspondence prof/next course : $login_prof/$affiche[0]<br />\n";
								if(!$req) $nb_reg_no++;
							}
...
*/
											...
											affiche_debug("the group already exists for the class \$id_classe=$id_classe, the professor is added $login_prof to the group:<br />\n");
			...
			if ($nb_reg_no != 0) {
				...
				echo "<p>The importation of the relations professors/courses and professors/classes in base GEPI was carried out successfully!<br />You can proceed to the next stage of importation of the options
followed by the students.</p>";

			}
			echo "<center><p><a href='init_options.php'>Import the options followed by the students</a></p></center>";
		}
	} else if ((trim($dbf_file['name'])=='') or (trim($dbf_file2['name'])=='')) {
		echo "<p>Please specify the files !<br />";
		echo "<a href='".$_SERVER['PHP_SELF']."'>Click here </a> to restart !</center></p>";

	} else {
		echo "<p>Nonvalid selected files !<br />";
		echo "<a href='".$_SERVER['PHP_SELF']."'>Click here </a> to restart !</center></p>";
	}
}
