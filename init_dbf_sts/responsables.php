...
echo "<h3 class='gepi' align='center'>Second phase of initialization<br />Importation of the responsibles</h3>\n";
...
if (!isset($is_posted)) {
    ...
    echo "<p><b>CAUTION ...</b><br />You should not proceed to this operation only if the constitution of
the classes were carried out !</p>";
    ...
    if(strtoupper($dbf_file['name']) == "F_ERE.DBF") {
        ...
        if(!$fp) {
            ...
            dbase_close($fp);
            if ($nb_reg_no != 0) {
                echo "<p>During recording of the data there was $nb_reg_no errors. Test find the cause of the error and start again the procedure before passing at the next stage.";
            } else {
                echo "<p>The importation of the responsibles in GEPI base was carried out successfully (".$nb_record." total recordings ).
                <br />You can now return to home and manually carry out all the other operations of initialization however to proceed to the third phase of importation of the courses and of definition of the options followed by the students.</p>";
