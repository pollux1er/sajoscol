...
base GEPI.<br /></p>";
    ...
    echo "<p>Caution !!! There are no tests on the fields. Be vigilant not to put special characters in the fields ...</p>";
...
<legend style="font-variant: small-caps;"> Help for the filling </legend>
<table border="0">
<tr>
  <td width="2%">&nbsp;</td>
  <td width="2%">&nbsp;</td>
