...
echo "<center><h3 class='gepi'>Third stage : Recording of the students and assignment of the students to the classes</h3></center>";
...
if (isset($is_posted) and ($is_posted == "yes")) {
    ...
    $nb = mysql_num_rows($call_data);
    $i = "0";
    echo "<p>The following table displays the data which will be recorded in the base of data GEPI when you confirm this choice all in bottom of the page.<br /><b>As long as you did not validate in bottom of the page, no data is recorded!</b></p>";
    echo "<p>The values in red announce possible missing data (ND for \"nondefinite\") in the file <b>F_ELE.DBF</b> ! This is not problem for the recording in the base <b>GEPI</b>. You will indeed have the possibility of supplementing the missing data
with the tools provided in <b>GEPI</b></p>";
...
*/
    ...
    if ($max_lignes_pb == 0) {
        ...
        echo "Missing data or incomplete were detected in <b>$max_lignes_pb lignes</b> : They appear in the table above in red !";
        if ($affiche != 'partiel') {
            ...
            echo "<p>--> To display all the lines, click on the button \"Display all\" :</p>";
            echo "<form enctype='multipart/form-data' action='step3.php' method=post>";
            echo "<input type=hidden name='is_posted' value='no'>";
