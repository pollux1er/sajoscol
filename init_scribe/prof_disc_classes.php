...
echo "<center><h3 class='gepi'>Fourth phase of initialization<br />Importation of associations profs-courses-classes (courses)</h3></center>";
...
if (!isset($_POST["action"])) {
    ...
    echo "<p>You will carry out the fourth stage: it consists in importing the file <b>prof_disc_classes.csv</b> containing the data relating to the courses.";
    echo "<p>CAUTION ! With this operation, you erase all the groups of course which had been defined last
year. They will be crushed by those which you will import with the current
procedure.</p>";
    echo "<p>The following fields must be present, in the order, and <b>separated by a semicolon</b> : ";
    echo "<ul><li>Login of the professor</li>" .
            "<li>Short name of the course</li>" .
            "<li>The identifier of class (separated by a point of exclamation ; ex : 1S1!1S2)</li>" .
            "<li>Type of course (CG for general course follow-up by all the class, OPT for an optional course )</li>" .
            "</ul>";
    echo "<p> Example of line for a general course :<br/>" .
            "DUPONT.JEAN;MATHS;1S1;CG<br/>" .
            "Example of line for an optional course with students of several classes :<br/>" .
            "DURANT.PATRICE;ANGL2;1S1!1S2!1S3;OPT</p>";
    echo "<p>Please specify the complete name of the file <b>prof_disc_classes.csv</b>.";
    ...
    if ($_POST['action'] == "save_data") {
        ...
        if ($total > 0) echo "<p>" . $total . " groups were recorded.</p>";
        if ($warning_matiere) echo "<p><font color=red>Caution !</font> Courses were created during importation. Their complete name could not be given. You must thus return to the page of <a href='../matieres/index.php'>management of courses</a> to rename them.</p>";
        ...
        if(strtolower($csv_file['name']) == "prof_disc_classes.csv") {
            ...
            if(!$fp) {
                ...
                echo "<p><a href='prof_disc_classes.php'>Click here </a> to restart !</center></p>";
            } else {
            ...
            if ($tabligne[3] != "CG" AND $tabligne[3] != "OPT") $tabligne[3] = "";
                ...
                echo "<table>";
                echo "<tr><td>Login prof</td><td>Course</td><td>Class(es)</td><td>Type</td></tr>";
            ...
            echo "<a href='prof_disc_classes.php'>Click here </a> to restart !</center></p>";
