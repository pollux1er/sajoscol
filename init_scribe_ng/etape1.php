...
if (isset($_POST['step'])) {
    ...
    */
              ...
              for ($cpt=0; $cpt<$nb_classes; $cpt++) {
                  ...
                  if (strcmp($classe_from_ldap[0], $ldap->get_base_branch()) == 0) {
                      ...
                      // Si plus d'une classe trouvee, erreur...
                          ...
                          die ("error in the base : several classes have the same name.<br>");
                      }
     ...
     */
    echo "<h3> Summary of stage 1 </h3>";

    echo "<b>$eleves_inseres</b> students inserted in base<br>";

    echo "<b>$classes_inserees</b> classes inserted in base<br>";
    ...
    echo "<p>Pass to stage 2 :</p>";
    echo "<input type='submit' value='Stage 2'>";
    echo "</form>";
}
    ...
    echo "<br><p>The operation of importation of the students since the LDAP will carry out the following operations :</p>";
    echo "<ul>";
    echo "<li>Importation of the students.</li>";
    echo "<li>Attempt of addition of each students present in the directory.</li>";
    ...
    echo "<li>Addition of the classes present in the directory.</li>";
    echo "</ul>";
    ...
    echo "<p>Are you sure you want to import all the students from the directory towards Gepi ?</p>";
    echo "<br/>";
