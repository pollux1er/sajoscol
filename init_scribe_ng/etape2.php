...
//**************** EN-TETE *****************
$titre_page = "Tool of initialization of the year : Importation of students";
...
if ($_POST['step'] == "2") {
    ...
    if (!isset($_SESSION['classesamodifier'])) {
        echo "Error: no periods to be created";
        ...
        */
        echo "<h3> Summary of the stage 2 </h3>";
        ...
        foreach($classes_concernees as $key => $val) {
            ...
            for ($i=1; $i<=$_POST[$indice]; $i++) {
                ...
                if (mysql_errno() != 0) {
                    die("An error occurred during creation of the periods");
                }
            }

            if (isset($_POST[$indice])) {
                echo "<p>Creation of ".$_POST[$indice]." periods for the class $val</p>";
            }
        }
        ...
        foreach($relations_eleves_classes as $relation_ec) {
            ...
            echo "recuperation of the periodes for the class ".$relation_ec->getIdClasse()." <br>";
            ...
            echo mysql_num_rows($periodes_de_la_classe)." found periods<br>";
        ...
        echo "<p>Pass at the stage 3 :</p>";
        echo "<input type='submit' value='Stage 3'>";
        echo "</form>";
    }
}
    ...
    echo "<br><p>Stage 2 enables you to create the periods for the classes.</p>";
    echo "<p>Once those created, the students will be assigned to all the periods of their classes</p>";
    ...
    if (mysql_errno() != 0) {
        echo "<br>Impossible to recover the classes in GEPI base.<br>";
        require("../lib/footer.inc.php");
        die();
    }
    else {
        ...
        if (mysql_num_rows($res) != 0) {
            echo "<p>Here the list of the classes present in GEPI for which no period was defined,<br>";
            echo "<br><p><b>Choose for each class the number of periods : </b></p>";
            ...
            echo "<br><p>Validation of the choice of the periods :</p>";
            ...
            echo "<br><p>No class without period was found.</p>";
            echo "<p>No action to be carried out.</p>";
            require("../lib/footer.inc.php");
        }
    }
