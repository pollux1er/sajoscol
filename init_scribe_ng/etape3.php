...
//**************** EN-TETE *****************
$titre_page = "Tool of initialization of the year : Importation of the responsibles";
...
*/
  $del = mysql_query("DELETE FROM utilisateurs WHERE statut = 'responsable'");
    ...
    for($nb=0; $nb<$nb_responsables; $nb++) {
        ...
        for ($i=0;$i<$nb_eleves_a_charge;$i++) {
            ...
            if (mysql_num_rows($req_eleid) == 1) {
              ...
              if (mysql_errno() != 0) {
                  ...
                  die("An error occurred during recovery of the responsibles already present.");
              }
              ...
              if (mysql_errno() != 0) {
                  die("An error occurred during assignment of a student to its legal responsible.");
              }
              $valid_associations++;
            }
        }
        ...
        if ($nb_eleves_a_charge > 0 && $valid_associations > 0) {
            ...
            if ($compte_utilisateur_resp != null) {
                ...
                echo "An account already exists for the identifier ".$resp->getLogin().".<br/>";
            }
            else {
     ...
     */
    echo "<h3> Summary of stage 3 </h3>";

    echo "<p><b>$resp_inseres</b> responsibles of students inserted in base<br> (on $nb_responsables found )</p>";
    if ($avertissement_trop_de_responsables) {
        echo "<br><p><font color=red>Warning : certain students have more than 2 legals responsibles, what is not normal. Although gepi manages only 2 of them, they all were imported.</font></p><br>";
    }
    echo "<br>";
    ...
    echo "<p>Pass to stage 4 :</p>";
    echo "<input type='submit' value='Stage 4'>";
    echo "</form>";
}
    ...
    echo "<br><p>Stage 3 enables you to import the student responsibles  and to associate them their student.</p>";
    echo "<br><p>Data concerning the reponsables of students currently in base will be replaced by these new data</p>";
    ...
    if ((!is_table_vide("responsables2")) || (!is_table_vide("resp_pers")) || (!is_table_vide("resp_adr"))) {
        ...
        echo "<br><p><font color=red>Caution, the tables concerning the responsibles are not empty, you did not pass by the first stage.</font></p><br>";
    }
