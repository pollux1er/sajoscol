...
//**************** EN-TETE *****************
$titre_page = "Tool of initialization of the year : Importation of the teachers";
...
if ($_POST['step'] == "4") {
    ...
    */
        ...
        if ($profs[$cpt]['typeadmin'][0] == 2) {
          ...
          for($cl=0; $cl<count($profs[$cpt]['divcod']); $cl++) {
            ...
            if ($classe_courante == null) {
              $error = true;
              echo "Error : impossible of recover the class $indice<br/>";
            }
            if (count($classe_courante) > 1) {
              $error = true;
              echo "Error : several classes having the name '$indice' are present.<br/>";
            }
          ...
          echo "The teacher $prenom $nom is not a principal professor<br/>";
        }
    } // fin parcours de tous les profs
        /*
         * Résumé des profs trouvés :
         */
    echo "<br/><br/>Professors found  : $nb_profs"."<br/><br/>";
    ...
    echo "<p>Pass at stage 5 :</p>";
    echo "<input type='submit' value='Stage 5'>";
    echo "</form>";
}
    ...
    echo "<br><p>Stage 4 enables you to import the professors and their quality of principal professor.</p>";
