...
if ($_POST['step'] == "5") {
    ...
    */
    ...
    for($cpt=0; $cpt<$matieres['count']; $cpt++) {
        ...
        if ($nb_profs > 0) {
          for ($i=0;$i<$nb_profs;$i++){
            ...
            if ($prof != null) {
              ...
              echo "The associated teacher (".$matieres[$cpt]['memberuid'][$i].") do not exist in the base !<br/>";
            }
          }
        }
         ...
         */
    echo "<br/><br/>  Courses found : $nb_matieres"."<br/><br/>";
    ...
    echo "<p>Pass to stage 6 :</p>";
    echo "<input type='submit' value='Stage 6'>";
    echo "</form>";
}
    ...
    echo "<br/><p>Stage 5 enables you to import the courses and associates to the professors who will have to teach them. The courses already present will not be removed.</p>";
