...
if ($test1 ==0) {
    ...
    if ($test2 ==0) {
        ...
        if ($test3 ==0) {
            echo "<p class='grand'>In order to proceed to the phase of definition of the options followed by the students, you must initially carry out the first phase of importation of the students from the file ELEVES.CSV</p>";
            die();
        }
    }
}
