...
//**************** EN-TETE *****************
$titre_page = "XML of STS: Generation of CSV";
...
<body-->
    ...
    document.location.replace("../../../login.php")
            ...
            if(isset($_GET['nettoyage'])) {
                ...
                echo "<h2 align='center'>Suppression of CSV</h2>\n";
                ...
                echo "<h2 align='center'>Reading of the XML Timetable of Sts-Web and generation of CSV</h2>\n";
                if(!isset($_POST['is_posted'])) {
                    ...
                    echo "<p>This page makes it possible to fill of the temporary tables with information of professors, courses,...<br />It generates files CSV allowing an importation of the accounts Profs for GEPI.</p>\n";
                    echo "<p>It is necessary to provide him an Export XML carried out from the STS-Web application.<br />Ask nicely your secretary access to STS-Web and to carry out 'Update/Exports/Timetables'.</p>\n";
                    echo "<form enctype='multipart/form-data' action='".$_SERVER['PHP_SELF']."' method='post'>\n";
					echo add_token_field();
                    echo "<p>Please provide file XML: \n";
                    echo "<p><input type=\"file\" size=\"80\" name=\"xml_file\" />\n";
                    echo "<input type='hidden' name='is_posted' value='yes' />\n";
                    echo "</p>\n";
                    echo "<p><input type=\"radio\" name=\"mdp\" id='mdp_alea' value=\"alea\" checked /> <label for='mdp_alea' style='cursor: pointer;'>Generate a random password for each professor.</label><br />\n";
                    echo "<input type=\"radio\" name=\"mdp\" id='mdp_date' value=\"date\" /> <label for='mdp_date' style='cursor: pointer;'>Rather use the date of birth in the format 'aaaammjj' as initial password (<i>it will have to be modified at the first login</i>).</label></p>\n";
                    echo "<input type='hidden' name='is_posted' value='yes' />\n";
                    //echo "</p>\n";
...
';
                    ...
                    if($fp){
                        ...
                        echo "<p>Go to <a href='#gepi'>section GEPI</a><br />If you have patience, direct links will be proposed (<i>within a yellow frame</i>) to download the files.<br />If the page finishes its loading without generating of yellow
frame, it may be that the configuration of PHP gives a too short processing time ";
                        ...
                        echo "<h2>School</h2>\n";
                        echo "<blockquote>\n";
                        echo "<h3>Analyze file to extract the parameters of the school...</h3>\n";
                        echo "<blockquote>\n";
                        $cpt=0;
                        $etablissement=array();
                        $temoin_param=0;
                        ...
                        echo "<h3>Display of the PARAMETERS data extracted  school:</h3>\n";
                        echo "<blockquote>\n";
                        echo "<table border='1'>\n";
                        echo "<tr>\n";
                        //echo "<th style='color: blue;'>&nbsp;</th>\n";
                        echo "<th>Code</th>\n";
                        echo "<th>Code academy</th>\n";
                        echo "<th>Heading academy</th>\n";
                        echo "<th>Initials</th>\n";
                        ...
                        echo "<th>Statute</th>\n";
                        echo "<th>Significant_school</th>\n";
                        echo "<th>Year</th>\n";
                        echo "<th>beginning_Date </th>\n";
                        echo "<th>End_Date</th>\n";
                        echo "</tr>\n";
                        //$cpt=0;
                        ...
                        echo "<h3>Display of the data extracted COURSES:</h3>\n";
                        echo "<blockquote>\n";
                        echo "<table border='1'>\n";
                        echo "<tr>\n";
                        echo "<th style='color: blue;'>&nbsp;</th>\n";
                        echo "<th>Code</th>\n";
                        echo "<th>Code_management</th>\n";
                        echo "<th>short_heading</th>\n";
                        echo "<th>long_ heading</th>\n";
                        echo "<th>edition_ heading</th>\n";
                        echo "</tr>\n";
                        $cpt=0;
                        ...
                        echo "<th style='color: blue;'>&nbsp;</th>\n";
                        echo "<th>Code</th>\n";
                        echo "<th>Short heading</th>\n";
                        echo "<th>Long heading</th>\n";
                        echo "</tr>\n";
                        $cpt=0;
                        ...
                        while($cpt<count($ligne)){
                            ...
                            if($temoin_structure==1){
                                if(strstr($ligne[$cpt],"<DIVISIONS>")){
                                    echo "Beginning of the section DIVISIONS at the line <span style='color: blue;'>$cpt</span><br />\n";
                                    $temoin_divisions++;
                                    $divisions=array();
                                    $i=0;
                                }
                                if(strstr($ligne[$cpt],"</DIVISIONS>")){
                                    echo "End of the section DIVISIONS at the line <span style='color: blue;'>$cpt</span><br />\n";
                                    $temoin_divisions++;
                                }
                                ...
                                if(strstr($ligne[$cpt],"</GROUPES>")){
                                    echo "End of the section GROUPS to the line <span style='color: blue;'>$cpt</span><br />\n";
                                    $temoin_groupes++;
                                }
                                if($temoin_groupes==1){
                                    /*
...
*/
                        ...
                        echo "<p style='color:red;'><b>To do</b>: a file Profs for GEPI...</p>\n";
...
<p>Print this page, then remove it while carrying out cleaning as indicated in the previous page.</p>
                        ...
                        echo "<blockquote>\n";
                        if(($temoin_au_moins_une_matiere=="")||($temoin_au_moins_un_prof=="")){
                            echo "<p>Your file does not comprise sufficient information to generate this CSV.<br />It is necessary that the timetables went up towards STS so that file
XML makes it possible to generate this CSV.</p>\n";
                        }
                        else{
...
*/
    ...
    */
    ...
    //                  }
                        ...
                        //echo "<p style='margin-top: 0;'>Make a Right-Click/Save the target of the link under... for each file below.</p>\n";
                        echo "<p style='margin-top: 0;'>Recover the following CSV (<i>pas par clic-droit</i>).</p>\n";
                        echo "<table border='0'>\n";
/*
                        echo "<li>File Profs: <a href='../backup/$dirname/csv/f_wind.csv'>f_wind.csv</a></li>\n";
                        ...
                        echo "<li>File Profs principal: <a href='../backup/$dirname/csv/f_div.csv'>f_div.csv</a></li>\n";
*/
                        ...
                        echo "<tr><td>File Profs principal:</td><td><a href='save_csv.php?fileid=4'>f_div.csv</a></td></tr>\n";

                        echo "</table>\n";
                        if($_POST['mdp']=="alea"){
                            echo "<p>Here also one <a href='../backup/$dirname/csv/profs.html' target='_blank'>page of the initial passwords of the professors</a> to print before carrying out cleaning below.</p>\n";
                        }
                        echo "<p>To remove the files after recovery: <a href='".$_SERVER['PHP_SELF']."?nettoyage=oui".add_token_in_url()."'>Nettoyage</a></p>\n";
                        echo "</div>\n";
                    }
                    else{
						echo "<p><span style='color:red'>ERROR!</span> File XML could not be open.<br />\n";
