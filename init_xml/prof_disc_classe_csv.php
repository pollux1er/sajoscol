...
if (!isset($is_posted)) {
	...
	echo "<p>Importation of the files <b>F_men.csv</b> and <b>F_gpd.csv</b> containing the data in relations with professors, course and classes.";
	echo "<form enctype='multipart/form-data' action='".$_SERVER['PHP_SELF']."' method=post>";
	echo add_token_field();
...
*/
			...
			affiche_debug("=======================================================<br />\n");
			affiche_debug("The Peeling of the file was finished F_GPD<br />\n");
			affiche_debug("=======================================================<br />\n");
			unset($en_tete2);
					...
					if(trim($ligne)!=""){
						...
						if ($login_prof != '') {
							...
							if($resverif == 0) {
								...
								echo "<p>Addition of the correspondence prof/course following: $login_prof/$affiche[0]<br />\n";
								if(!$req) $nb_reg_no++;
							}
...
*/
											echo " and the class it $classe.<br />\n";
