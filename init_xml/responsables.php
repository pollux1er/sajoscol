...
//**************** EN-TETE *****************
$titre_page = "Tool of initialization of the year : Importation of responsibles of the students";
...
if (!isset($is_posted)) {
	...
	echo "<p><b>CAUTION ...</b><br />You should not proceed to this operation only if the constitution of the classes were carried out !</p>";
	...
	echo "<p>Importation of the files <b>PERSONNES.CSV</b>, <b>RESPONSABLES.CSV</b> et <b>ADRESSES.CSV</b> containing the data relating to the responsibles.\n";
	echo "<form enctype='multipart/form-data' action='responsables.php' method=post>\n";
	echo add_token_field();
	...
	if(strtoupper($csv_file['name']) == "PERSONNES.CSV") {
		...
		if(!$fp){
			...
			echo "<p><a href='responsables.php'>Click here </a> to restart !</center></p>\n";
		}
		else{
			...
			*/
			...
			if ($nb_reg_no3 != 0) {
				echo "<p>During recording of the data of PERSONNES.CSV, there was $nb_reg_no3 errors. Test find the cause of the error and restart the procedure before passing to the next stage.</p>\n";
			} else {
				echo "<p>The importation of the people (responsibles) in base GEPI was carried out successfully (".$nb_record3." records on the whole).</p>\n";
				/*
		...
		echo "<p>No file PERSONNES.CSV was selected !<br />\n";
		//echo "<a href='disciplines.php'>Click here </a> to restart !</center></p>";
		echo "<a href='responsables.php'>Click here </a> to restart !</center></p>\n";
	...
	if(strtoupper($csv_file['name']) == "RESPONSABLES.CSV") {
		...
		if(!$fp){
			...
			*/
			...
			if(mysql_num_rows($test)>0){
				...
				//echo ".</p>\n";
				echo "<br />$cpt_nett aberrant associations removed .</p>\n";
			}



			if ($nb_reg_no1 != 0) {
				echo "<p>During recording of the data of RESPONSABLES.CSV, there was $nb_reg_no1 errors. Test find the cause of the error and restart the procedure before passing to the following stage.</p>\n";
			}
			else {
				echo "<p>The importation of the relations student/responsibles in base GEPI was carried out successfully (".$nb_record1." records on the whole).</p>\n";
				/*
				echo "<br />Vous pouvez à présent retourner à l'accueil et effectuer toutes les autres opérations d'initialisation manuellement ou bien procéder à la troixième phase d'importation des matières et de définition des options suivies par les élèves.</p>\n";
				echo "<center><p><a href='../accueil.php'>Retourner à l'accueil</a></p></center>\n";
				echo "<center><p><a href='disciplines_csv.php'>Procéder à la troisième phase</a>.</p></center>\n";
		...
		echo "<p>No file RESPONSABLES.CSV was selected !<br />\n";
		//echo "<a href='disciplines.php'>Click here </a> to restart !</center></p>";
		echo "<a href='responsables.php'>Click here </a> to restart !</center></p>\n";
	...
	if(strtoupper($csv_file['name']) == "ADRESSES.CSV") {
		...
		if(!$fp){
			...
			*/
			...
			if ($nb_reg_no2 != 0) {
				echo "<p>During recording of the data of ADRESSES.CSV, there was $nb_reg_no2 errors. Test find the cause of the error and restart the procedure before passing to the next stage.</p>\n";
			} else {
				echo "<p>The importation of the addresses of responsibles in base GEPI was carried out successfully (".$nb_record2." records on the whole).</p>\n";
				/*
				echo "<br />Vous pouvez à présent retourner à l'accueil et effectuer toutes les autres opérations d'initialisation manuellement ou bien procéder à la troixième phase d'importation des matières et de définition des options suivies par les élèves.</p>\n";
				echo "<center><p><a href='../accueil.php'>Retourner à l'accueil</a></p></center>\n";
				echo "<center><p><a href='disciplines_csv.php'>Procéder à la troisième phase</a>.</p></center>\n";
		...
		echo "<p>No file ADRESSES.CSV was selected !<br />\n";
		//echo "<a href='disciplines.php'>Click here </a> to restart !</center></p>";
		echo "<a href='responsables.php'>Click here </a> to restart !</center></p>\n";
	...
	if(($nb_reg_no1==0)&&($nb_reg_no2==0)&&($nb_reg_no3==0)){
		echo "<p>You can now turn over to home and manually carry out all the other operations of initialization or proceed well to the third phase of importation of the courses and of definition of the options followed by the students.</p>\n";
		echo "<center><p><a href='../accueil.php'>Return to home</a></p></center>\n";
		echo "<center><p><a href='disciplines_csv.php'>Proceed to the third phase</a>.</p></center>\n";
	}
}
require("../lib/footer.inc.php");
?>