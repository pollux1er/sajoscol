...
@set_time_limit(0);
/*
 * $Id: step3.php 5936 2010-11-21 17:32:17Z crob $
 *
...
if (isset($is_posted) and ($is_posted == "yes")) {
    ...
    $nb = mysql_num_rows($call_data);
    $i = "0";
    echo "<p>The following table display the data which will be recorded in the Gepi Datebase when you confirm this choice in bottom of the page.<br /><b>As long as you did not validate in bottom of the page, no data is recorded !</b></p>";
    ...
    echo "<p>The values in red announce possible missing data (ND for \"nondefinite\") in the file <b>eleves.csv</b> provided ! This is not awkward for the recording in the base <b>GEPI</b>. You will indeed have the possibility of supplementing the missing data with the tools provided in <b>GEPI</b></p>";
    ...
    echo "<tr><td><p class=\"small\">N° INE</p></td><td><p class=\"small\">Identifier</p></td><td><p class=\"small\">Name</p></td><td><p class=\"small\">First name</p></td><td><p class=\"small\">Sex</p></td><td><p class=\"small\">Date of birth</p></td><td><p class=\"small\">Regim</p></td><td><p class=\"small\">Doubling</p></td><td><p class=\"small\">Class</p></td><td><p class=\"small\">School of origin or previous</p></td></tr>";
    $max_lignes_pb = 0;
    while ($i < $nb) {
        $ligne_pb = 'no';
        $no_gep = mysql_result($call_data, $i, "ELENONAT");
...
*/
    ...
    if ($max_lignes_pb == 0) {
        ...
        echo "Missing data or incomplete were detected in <b>$max_lignes_pb lines</b> : They appear in the table above in red !";
        if ($affiche != 'partiel') {
