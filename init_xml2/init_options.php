...
if ($test1 ==0) {
	...
	if ($test2 ==0) {
		...
		if ($test3 ==0) {
			...
			echo "<p class='grand'>In order to proceed to the phase of definition of the options followed by the students, you must initially carry out the first phase of importation of the students starting from the file ElevesSansAdresses.xml</p>";
			die();
		}
	}
}
...
echo "<p>The importation of the options followed by the students in base GEPI was carried out successfully !<br />You can proceed to the next stage of importation of the principal professors.</p>\n";
echo "<center><p><a href='init_pp.php'>Importation of the principal professors</a></p></center>\n";
