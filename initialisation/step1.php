...
//                    echo ".";
            ...
            dbase_close($fp);
            if ($nb_reg_no != 0) {
                echo "<p>During recording of the data there was $nb_reg_no errors, you cannot continue the initialization. Find the cause of the error and restart the procedure, after having emptied the temporary table.";
            } else {
                echo "<p>The $nblignes lines of the file F_ELE.DBF were analyzed.<br />$nb_reg_ok lines of data corresponding to students of the current year were recorded in a temporary table.<br />There no were errors, you can proceed at the next stage.</p>";
                echo "<center><p><a href='step2.php'>Access to the stage 2</a></p></center>";
            }
        }
