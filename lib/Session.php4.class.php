...
class Session {
	...
	function security_check() {
		...
		if ($this->is_anonymous()) {
			tentative_intrusion(1, "Access to a page without being identified (can come from a timeout of session).");
			return "0";
			exit;
		}
	...
	function lock_account($_login) {
	   ...
	   tentative_intrusion(2, "Locking of the account ".$_login." because of a too great number of unfruitful attempts of connection. It can be an attempt of attack rough-force.");
	   return true;
	}
