 ...
 *
 * @version $Id: header_barre_menu.php 8463 2011-10-11 14:50:13Z crob $
 * @copyright 2008-2011
 * @license GNU/GPL v2
 * @package General
...
$barre_textes = '<li class="li_inline">
	<a href="'.$gepiPath.'/calculnotes/Choixnotes.php'.$groupe_text.'"'.insert_confirm_abandon().'>Types notes</a>'."\n";
	...
	if(getSettingValue("active_carnets_notes") == 'y'){
		...
		// Report cards
		$barre_note.='<li class="li_inline"><a href="'.$gepiPath.'/saisie/index.php"'.insert_confirm_abandon().'>Report cards</a>'."\n";
		$barre_note .= '	<ul class="niveau2">'."\n";
			...
			if ((getSettingValue("GepiAccesReport cardSimpleProf") == "yes")||(getSettingValue("GepiAccesReport cardSimpleProfTousEleves") == "yes")) {
				...
				$barre_note.= '		<li class="plus"><a href="'.$gepiPath.'/prepa_conseil/index3.php"'.insert_confirm_abandon().'>Report cards simplifiés</a>'."\n";
					$barre_note .= '		<ul class="niveau3">'."\n";
					foreach($tmp_mes_classes as $key => $value) {
	...
	if (getSettingValue("autorise_edt_tous") == "y") {
		...
		$barre_edt = '<li class="li_inline"><a href="'.$gepiPath.'/edt_organisation/index_edt.php?visioedt=prof1&amp;login_edt='.$_SESSION["login"].'&amp;type_edt_2=prof"'.insert_confirm_abandon().'>Timetables</a>'."\n";
	...
	*/
	//=======================================================
	$barre_eleve = '<li class="li_inline"><a href="'.$gepiPath.'/groupes/visu_mes_listes.php"'.insert_confirm_abandon().'>Students</a>';
...
// fin plugins
	...
	<ul class="niveau1">
		<li class="li_inline"><a href="'.$gepiPath.'/accueil.php">Home</a></li>
		'.$barre_absence.'
		'.$barre_textes.'
		'.$barre_note.'
		'.$barre_edt.'
		...
		'.$barre_eleve.'
		'.$barre_plugin.'		  
		<li class="li_inline"><a href="'.$gepiPath.'/utilisateurs/mon_compte.php">My account</a></li>
	</ul>
</div>
';
?>