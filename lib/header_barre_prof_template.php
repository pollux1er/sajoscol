 ...
 * 
 * $Id: header_barre_prof_template.php 8691 2011-12-01 11:53:11Z crob $
 * 
...
include("tbs_menu_plugins.inc.php");
	...
	// Lien vers l'accueil
	$tbs_menu_prof[$compteur_menu]=array("lien"=>'/accueil.php', "texte"=>"Home");
	$compteur_menu++;
	...
	//$tbs_menu_prof[$compteur_menu]=array("lien"=> '/calculnotes/Choixnotes.php' , "texte"=>"Type notes");
    $tmp_sous_menu=array();
	$compteur_menu++;	
	...
	if(getSettingValue("active_carnets_notes") == 'y'){
		...
		// Report cards
		$tbs_menu_prof[$compteur_menu]=array("lien"=> '/saisie/index.php' , "texte"=>"Report cards");
		$tmp_sous_menu=array();
		$cpt_sous_menu=0;
			...
			if($affiche_li_bull_simp=="y") {
				$tmp_sous_menu[$cpt_sous_menu]=array("lien"=> '/prepa_conseil/index3.php' , "texte"=>"Report cards simplifiés");
				$tmp_sous_menu2=array();
				$cpt_sous_menu2=0;
				foreach($tmp_mes_classes as $key => $value) {
	...
	if (getSettingValue("autorise_edt_tous") == "y") {
		$tbs_menu_prof[$compteur_menu]=array("lien"=> '/edt_organisation/index_edt.php?visioedt=prof1&amp;login_edt='.$_SESSION["login"].'&amp;type_edt_2=prof' , "texte"=>"Timetables");
	...
	//=======================================================
	$tbs_menu_prof[$compteur_menu]=array("lien"=> '/groupes/visu_mes_listes.php' , "texte"=>"Students");
	$tmp_sous_menu=array();
	$cpt_sous_menu=0;
	...
	//=======================================================
	$tbs_menu_prof[$compteur_menu]=array("lien"=> '/utilisateurs/mon_compte.php' , "texte"=>"My account");
	$compteur_menu++;
