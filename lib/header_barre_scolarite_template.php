 ...
 * 
 * $Id: header_barre_scolarite_template.php 8299 2011-09-21 14:42:21Z crob $
 *
 ...
 *******************************************************************/
	...
	if ($_SESSION['statut'] == "scolarite") {
		...
		if(getSettingValue("active_carnets_notes") == 'y'){
			//=======================================================
			// Report cards
			$menus .= '<li class="li_inline"><a href="#"'.insert_confirm_abandon().'>&nbsp;Report cards</a>'."\n";
			$menus .= '   <ul class="niveau2">'."\n";
			...
			$menus .= '     <li class="plus">Report cards'."\n";
			$menus .= '            <ul class="niveau3">'."\n";
			...
			$menus .= '                <li><a href="'.$gepiPath.'/prepa_conseil/index3.php"'.insert_confirm_abandon().'>Report cards simplifiés</a></li>'."\n";
			$menus .= '            </ul>'."\n";
			$menus .= '     </li>'."\n";
		...
		$tbs_menu_scol[]=array("li"=> '<li class="li_inline"><a href="'.$gepiPath.'/accueil.php"'.insert_confirm_abandon().'>Home</a></li>'."\n");		
