...
//Site en maintenance
	...
	if ((getSettingValue("disable_login"))!='no'){
		...
		$tbs_Site_ferme[0] = "The site is undergoing mantenance.";
		$tbs_Site_ferme[1] = "We apologize, please try to sign in later.";
	}
...
//Message
	if (isset($message)) {
		...
		$tbs_message[] =array("classe"=>"","texte" => "Log in, please.");
	}
...
//	administrateurs
	...
	if(getSettingValue("gepiAdminAdressPageLogin")!='n'){
		...
		if(count($tab_adr)>0){
			...
			//echo("<p><a href=\"javascript:pigeon2();\">[Contact administrator]</a></p>\n");
		}
		*/
	}
