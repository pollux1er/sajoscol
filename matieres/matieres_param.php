<?php
/*
 * $Id: matieres_param.php 6603 2011-03-03 13:17:26Z crob $
 *
...
*/
    ...
    if ($reg_ok=='') {
        ...
        $message_enregistrement = "There was a problem during recording of the modification.";
        $affiche_message = 'yes';
    }
}
//**************** EN-TETE *****************
$titre_page = "Management tool - Parameter setting of the courses by batches";
...
echo "<p class=bold><a href=\"index.php\"><img src='../images/icons/back.png' alt='Return' class='back_link'/> Return</a> | <input type='submit' value='Save' /></p>\n";
echo "<p>On this page, you can modify the coefficients and the priorities of display of one or more courses by batches of classes selected below.</p>\n";

//================================================
// AJOUT:boireaus
echo "<p><input type='button' name='cochetout' value='Check all' onClick='coche_tout();' /> / <input type='button' name='decochetout' value='Uncheck all' onClick='decoche_tout();' /></p>";
//============================================
...
echo "<table width='100%' border='1' class='boireaus' summary='Choice of classes'>\n";
$i ='0';
//============================================
// AJOUT: boireaus
$cpt_classe=0;
...
<p>Notice : No modification is made to the empty fields .</p>

<table width='100%' border='1' cellpadding='5' class='boireaus' summary='Paramétrage des matières'>
<tr>
    <th><p class='bold'>Course identifier</p></th>
    <th><p class='bold'>Complete name</p></th>
    <th><p class='bold'>Order of display</p></th>
    <th><p class='bold'>Coefficient</p></th>
    <th><p class='bold'>Category</p></th>
</tr>
