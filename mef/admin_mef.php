...
// header
$titre_page = "Management of the mef (elementary module of formation)";
require_once("../lib/header.inc");

echo "<p class='bold'>";
echo "<a href=\"../accueil_admin.php\">";
echo "<img src='../images/icons/back.png' alt='Return' class='back_link'/> Return</a> | ";
echo "<a href=\"associer_eleve_mef.php\">Associate the students to mef</a>";
echo "</p>";
?>
...
<div style="text-align:center">
    <?php
    	if($action=="ajouter") { 
	    echo "<h2>Addition of a mef</h2>";
	} elseif ($action=="modifier") {
	    echo "<h2>Modify a mef</h2>";
	}
	?>
...
?>
      ...
      <table cellpadding="2" cellspacing="2" class="menu">
        <tr>
          <td>Id outside (nomenclature EN)</td>
          <td>short heading</td>
          <td>long heading</td>
          <td>Edition heading</td>
       </tr>
        <tr>
              <td>
           <?php
...
<?php
	...
	<a href="admin_mef.php?action=ajouter"><img src='../images/icons/add.png' alt='' class='back_link' /> Add the mef</a>
	<br/><br/>
	<a href="admin_mef.php?action=ajouterdefaut<?php echo add_token_in_url();?>"><img src='../images/icons/add.png' alt='' class='back_link' /> Add the default mef</a>
	<br/><br/>
    <table cellpadding="0" cellspacing="1" class="menu">
      <tr>
        <td>Id</td>
        <td>Number mef nomenclature EN</td>
          <td>short heading</td > 
		  <td>long heading</td > 
		  <td>Edition heading</td >
 ...
 ?>
	  ...
	  <td><?php echo $mef->getId(); ?></td>
          ...
          <td><a href="admin_mef.php?action=supprimer&amp;id=<?php echo $mef->getId(); echo add_token_in_url();?>" onclick="return confirm('Are you sure you want to remove this mef ?')"><img src="../images/icons/delete.png" width="22" height="22" title="Delete" alt="" /></a></td>
       </tr>
     <?php } ?>
    </table>
    <br/><br/>
