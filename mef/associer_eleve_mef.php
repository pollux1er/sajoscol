...
if (!$classe_col->isEmpty()) {
	...
	echo '<button type="submit">Display students</button>';
	echo '</p>';
	echo "</form>";
	echo "</td>";
} else {
...
<p>
			...
			<p class="choix_fin">
				<input value="Save" name="Valider" type="submit"  onclick="this.form.submit();this.disabled=true;this.value='In progress'" />
			</p>
	...
	<table style="width:750px;" >
		<tbody>
			<tr class="titre_tableau_gestion" style="white-space: nowrap;">
				<th style="text-align : center;" abbr="élèves">List of students.
				Select :
				<a href="#" onclick="SetAllCheckBoxes('liste_mef_eleve', 'active_mef_eleve[]', '', true); return false;">All</a>
				<a href="#" onclick="SetAllCheckBoxes('liste_mef_eleve', 'active_mef_eleve[]', '', false); return false;">None</a>
				</th>
				<th style="text-align : center;">current MEF </th>
