...
if ($id_mef != null && $id_mef != -1) {
    ...
    if ($mef == null) {
	$message_enregistrement .= "Problem with the id of mef : ".$_POST['$id_mef']."<br/>";
    }
}
...
for($i=0; $i<$total_eleves; $i++) {
    ...
    if ($eleve == null) {
	$message_enregistrement .= "Problem with the id student : ".$_POST['id_eleve_mef'][$i]."<br/>";
	continue;
    }
    $eleve->setMef($mef);
    $eleve->save();
    $message_enregistrement .= "Mef recorded for the student : ".$eleve->getNom()."<br/>";
}
