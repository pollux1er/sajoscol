...
/*
 *
 * $Id: admin_justifications_absences.php 5946 2010-11-22 16:02:12Z crob $
 *
...
// header
$titre_page = "Management of the justifications of absence";
...
<div style="text-align:center">
    <?php
    	if($action=="ajouter") { 
	    echo "<h2>Addition of a justification</h2>";
	} elseif ($action=="modifier") {
	    echo "<h2>Modify a justification</h2>";
	}
	?>
...
<?php
	...
	<a href="admin_justifications_absences.php?action=ajouter"><img src='../../images/icons/add.png' alt='' class='back_link' /> Add a new justification</a>
	<br/><br/>
	<a href="admin_justifications_absences.php?action=ajouterdefaut<?php echo add_token_in_url();?>"><img src='../../images/icons/add.png' alt='' class='back_link' /> Add the justifications by defect</a>
	<br/><br/>
