...
// header
$titre_page = "Management of the places of absence";
...
<div style="text-align:center">
    <h2>Definition of the places of absence</h2>
    <p>
        A place could be affected with a type of seizure to make it possible
to know or is the seized student. <br />
        For the types without definite place one will considèrera that the
student is not in the enclosure of the establishment.<br />
    </p>
<?php if ($action == "ajouter" OR $action == "modifier") { ?>
<div style="text-align:center">
    <?php
    	if($action=="ajouter") { 
	    echo "<h2>Addition of a place</h2>";
	} elseif ($action=="modifier") {
	    echo "<h2>Modify a place</h2>";
	}
	?>
...
<?php }  ?>
	...
	<a href="admin_lieux_absences.php?action=ajouter"><img src='../../images/icons/add.png' alt='' class='back_link' /> Add a place</a>
	<br/><br/>
	<a href="admin_lieux_absences.php?action=ajouterdefaut<?php echo add_token_in_url();?>"><img src='../../images/icons/add.png' alt='' class='back_link' /> Add the places by defect</a>
	<br/><br/>
    ...
    foreach ($lieu_collection as $lieu) { ?>
	  ...
	  <td><?php echo $lieu->getCommentaire(); ?></td>
          ...
          <td><a href="admin_lieux_absences.php?action=supprimer&amp;id_lieu=<?php echo $lieu->getId(); echo add_token_in_url();?>" onClick="return confirm('Are you sure to want to remove this place ?')"><img src="../../images/icons/delete.png" width="22" height="22" title="Remove" border="0" alt="" /></a></td>
          <td><a href="admin_lieux_absences.php?action=monter&amp;id_lieu=<?php echo $lieu->getId(); echo add_token_in_url();?>"><img src="../../images/up.png" width="22" height="22" title="Go up" border="0" alt="" /></a></td>
          <td><a href="admin_lieux_absences.php?action=descendre&amp;id_lieu=<?php echo $lieu->getId(); echo add_token_in_url();?>"><img src="../../images/down.png" width="22" height="22" title="Go down" border="0" alt="" /></a></td>
        </tr>
     <?php } ?>
    </table>
    <br/><br/>
