...
// header
$titre_page = "Management of the reasons for absence";
...
<div style="text-align:center">
    <h2>Definition of the reasons for absence</h2>
<?php if ($action == "ajouter" OR $action == "modifier") { ?>
<div style="text-align:center">
    <?php
    	if($action=="ajouter") { 
	    echo "<h2>Addition of a reason</h2>";
	} elseif ($action=="modifier") {
	    echo "<h2>Modify a reason</h2>";
	}
	?>
...
<?php }  ?>
	...
	<a href="admin_motifs_absences.php?action=ajouter"><img src='../../images/icons/add.png' alt='' class='back_link' /> Add a reason</a>
	<br/><br/>
	<a href="admin_motifs_absences.php?action=ajouterdefaut<?php echo add_token_in_url();?>"><img src='../../images/icons/add.png' alt='' class='back_link' /> Add the reasons by defect</a>
	<br/><br/>
