...
<h2>Les saisies du
    ...
    <button style="font-size:12px" dojoType="dijit.form.Button" type="submit">Change</button>
</h2>
</form>
...
<?php $creneau_col = EdtCreneauPeer::retrieveAllEdtCreneauxOrderByTime();?>
	<tr>
		<th style="border: 1px solid black; background-color: gray;">Class</th>
		<th style="border: 1px solid black; background-color: gray; min-width: 300px; max-width: 500px;">Name First name</th>
<?php
...
if ($classe_col->isEmpty()) {
    echo '	<tr>
			<td colspan="'.($creneau_col->count() + 2).'">No class with affected student was found</td>
		</tr>';
}
...
<br />
  <span class="bold">Made impression it <?php echo date("d/m/Y - H:i"); ?>.</span>
</div>
<?php
