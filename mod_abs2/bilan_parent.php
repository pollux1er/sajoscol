...
//afficher les créneaux
    ...
    <p>
      <span style="background-color:red;">&nbsp;&nbsp;NJ&nbsp;&nbsp;</span>
              	Failure with compulsory educations: Not justified absence
    </p>
    <p>
      <span style="background-color:fuchsia;">&nbsp;RNJ&nbsp;</span>
              	Failure with compulsory educations: Delay not justified
    </p>
    <p>
      <span style="background-color:blue;">&nbsp;&nbsp;&nbsp;J&nbsp;&nbsp;&nbsp;&nbsp;</span>
              	Failure with compulsory educations: Justified absence
    </p>
    <p>
      <span style="background-color:aqua;">&nbsp;&nbsp;RJ&nbsp;&nbsp;</span>
              	Failure with compulsory educations: Justified delay
    </p>
  ...
  ?>
      ...
      <p class="bold small">Made impression it <?php echo date("d/m/Y - H:i"); ?>.</p>
    </div>
<?php
