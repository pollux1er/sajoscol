...
?>    <div id="action_bouton" dojoType="dijit.form.DropDownButton" style="display: inline">
	...
	<div dojoType="dijit.Menu" style="display: inline">
		...
		document.liste_notifications.submit();
				">
		Generer by batch selected notifications
	    </button>
	</div>
    </div>
...
echo '<span style="white-space: nowrap;"> ';
//echo '<nobr>';
echo 'Between: <input size="13" id="filter_date_creation_notification_debut_plage" name="filter_date_creation_notification_debut_plage" value="';
...
echo '<span style="white-space: nowrap;"> ';
//echo '<nobr>';
echo 'And: <input size="13" id="filter_date_creation_notification_fin_plage" name="filter_date_creation_notification_fin_plage" value="';
