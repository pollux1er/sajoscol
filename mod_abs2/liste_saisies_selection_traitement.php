...
/**
 *
 * @version $Id: liste_saisies_selection_traitement.php 8157 2011-09-08 17:36:31Z dblanqui $
 *
...
?>    <div id="action_bouton" dojoType="dijit.form.DropDownButton" style="display: inline">
	...
	<div dojoType="dijit.Menu" style="display: inline">
		...
		document.liste_saisies.submit();
				">
		Add the seizures to the treatment 
		<?php 
...
if (getFiltreRechercheParam('filter_saisies_supprimees') == 'y') {
	...
	//echo '<nobr>';
	echo '<span style="white-space: nowrap;"> ';
	echo 'Between: <input size="13" id="filter_date_suppression_saisie_debut_plage" name="filter_date_suppression_saisie_debut_plage" value="';
	...
	//echo '<nobr>';
	echo '<span style="white-space: nowrap;"> ';
	echo 'And : <input size="13" id="filter_date_suppression_saisie_fin_plage" name="filter_date_suppression_saisie_fin_plage" value="';
...
//echo '<nobr>';
echo '<span style="white-space: nowrap;"> ';
echo 'Between: <input size="13" id="filter_date_debut_saisie_debut_plage" name="filter_date_debut_saisie_debut_plage" value="';
...
//echo '<nobr>';
echo '<span style="white-space: nowrap;"> ';
echo 'And : <input size="13" id="filter_date_debut_saisie_fin_plage" name="filter_date_debut_saisie_fin_plage" value="';
...
//echo '<nobr>';
echo '<span style="white-space: nowrap;"> ';
echo 'Between: <input size="13" id="filter_date_fin_saisie_debut_plage" name="filter_date_fin_saisie_debut_plage" value="';
...
//echo '<nobr>';
echo '<span style="white-space: nowrap;"> ';
echo 'And: <input size="13" id="filter_date_fin_saisie_fin_plage" name="filter_date_fin_saisie_fin_plage" value="';
...
echo ">not</option>\n";
echo "</select>";
echo '<br/>Failure obligation presence';
echo '</th>';
...
//echo '<nobr>';
echo '<span style="white-space: nowrap;"> ';
echo 'Between: <input size="13" id="filter_date_traitement_absence_debut_plage" name="filter_date_traitement_absence_debut_plage" value="';
...
//echo '<nobr>';
echo '<span style="white-space: nowrap;"> ';
echo 'And : <input size="13" id="filter_date_traitement_absence_fin_plage" name="filter_date_traitement_absence_fin_plage" value="';
...
//echo '<nobr>';
echo '<span style="white-space: nowrap;"> ';
echo 'Between: <input size="13" id="filter_date_creation_saisie_debut_plage" name="filter_date_creation_saisie_debut_plage" value="';
...
//echo '<nobr>';
echo '<span style="white-space: nowrap;"> ';
echo 'And : <input size="13" id="filter_date_creation_saisie_fin_plage" name="filter_date_creation_saisie_fin_plage" value="';
...
if ($recherche_saisie_a_rattacher == 'oui' && $traitement != null) {
    if($results->count()==0){
        echo"<p class='red'>No seizure (of + or - 24 hours) to attach to the treatment : ";
        echo "<a href='visu_traitement.php?id_traitement=".$traitement->getId()."";
        if($menu){
                echo"&menu=false";
            } 
...
foreach ($results as $saisie) {
	...
	if (getFiltreRechercheParam('filter_saisies_supprimees') == 'y') {
    	...
    	if ($suppr_utilisateur != null) {
    		echo ' by '.  $suppr_utilisateur->getCivilite().' '.$suppr_utilisateur->getNom().' '.substr($suppr_utilisateur->getPrenom(), 0, 1).'.';;
    	}
	    echo "</a>";
	    echo '</td>';
	}
...
//	echo "</a>";
	...
	echo "Marker of call carried out";
    }
    echo '</td>';
