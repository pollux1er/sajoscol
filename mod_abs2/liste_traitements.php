...
if ($affichage == 'tableur') {
    ...
    $titre = 'Extract of the treatment of absences';
...
echo '<button type="submit" name="affichage" value="tableur" >To export with the format ods</button> ';
...
echo ">not</option>\n";
echo "</select>";
echo '<br/>Failure compulsory education (bulletin)';
echo '</th>';
...
echo '<span style="white-space: nowrap;"> ';
//echo '<nobr>';
echo 'Between: <input size="13" id="filter_date_creation_traitement_debut_plage" name="filter_date_creation_traitement_debut_plage" value="';
...
echo '<span style="white-space: nowrap;"> ';
//echo '<nobr>';
echo 'And : <input size="13" id="filter_date_creation_traitement_fin_plage" name="filter_date_creation_traitement_fin_plage" value="';
