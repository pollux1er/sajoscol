...
if(($_SESSION['statut']=='cpe')||
    ...
    echo "title='Assessments'>Assessments</a></li>\n";
    ...
    echo "title='Impound absences and delays for a group'>Impound a group</a></li>\n";
    ...
    echo "title='Impound for a student'>Impound a student</a></li>\n";
    ...
    echo "title='List seizures'>List seizures</a></li>\n";
    ...
    echo "title='Visualize a seizure'>Seizure</a></li>\n";
    ...
    echo "title='Treatment'>List treatments</a></li>\n";
    ...
    echo "title='Treatment'>Treatment</a></li>\n";
    ...
    echo "title='Notifications'>List notifications</a></li>\n";
    ...
    echo "title='Sending by batch'>Sending by batch</a></li>\n";
    ...
    echo "title='Seize absences and delays for a group'> Impound a group</a></li>\n";
    ...
    if(!$utilisateur->getClasses()->isEmpty()){
        ...
        echo "title='Assessments'>Individual assessment</a></li>\n";
    }
    ...
    if(acces('/mod_abs2/saisir_eleve.php','autre')) {
        ...
        echo "title='Impound for a student'>attached a student</a></li>\n";        
