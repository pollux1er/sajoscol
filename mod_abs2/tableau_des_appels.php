...
<div class="legende">
    ...
    <table class="legende">
        <tr >
            ...
            The seizures of the pupil on the crenel are numbered after its name.
The color depends on the type of the seizure.</td>
            <td width="300px">
            <font color="orange">&#9632;</font> Delay<br />
            <font color="red">&#9632;</font> Failure with the obligations of presence<br />
            <font color="blue">&#9632;</font> Not failure with the obligations of presence
            </td>
        </tr>
        <tr>
            <td rowspan="2"><h4 class="legende">Calls  </h4>
            The prime coat of cell indicates if a teaching call were carried out
or not.
            </td>
        ...
        <tr>
            <td style="background-color:#9f9;">Call fact.
            </td>
        </tr>
    </table>    
</div>    
...
<h2>Calls of
    ...
    <button style="font-size:12px" dojoType="dijit.form.Button" type="submit">Change</button></h2>

	<p>You must choose a crenel to view the absent ones
	<select dojoType="dijit.form.Select"  id="choix_creneau" name="choix_creneau" onchange='document.choix_du_creneau.submit();'>
		<option value="rien">Choice of the crenel</option>
<?php
...
<?php
if ($choix_creneau_obj != null) {
	echo '<br/>See the absences of <span style="color: blue;">'.$choix_creneau_obj->getHeuredebutDefiniePeriode('H:i').'</span> at <span style="color: blue;">'.$choix_creneau_obj->getHeurefinDefiniePeriode('H:i').'</span>.';
?>
<br />
