...
if (!$traitement->getAbsenceEleveSaisies()->isEmpty()) {
    ...
    echo '<button type="submit">Seek seizures to attach</button>';
    echo '</p>';
    echo '</form>';
}
echo '</td></tr>';
...
foreach ($traitement->getAbsenceEleveNotifications() as $notification) {
    ...
    echo ', status : '.$notification->getStatutEnvoi();
    echo "</a>";
    echo '</td></tr>';
}
echo '<tr><td>';
...
echo '<button type="submit">New notification with the family</button>';
	echo '</p>';
echo '</form>';
echo '</td></tr>';
...
if ($traitement->getModifiable()) {
    ...
    echo '<button type="submit">Remove the treatment</button>';
	echo '</p>';
    echo '</form>';
    echo '</td></tr>';
}
