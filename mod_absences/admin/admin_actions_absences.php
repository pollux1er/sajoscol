...
if ($action_sql == "supprimer") {
      ...
      if ($test == "0")
      {
         ...
         // Execution de cette requete
            ...
            $msg = "The removal was performed successfully.";
      } else {
          $msg = "Can not be deleted because one or more follow-up were recorded with this type of action. Start by removing concerned followed";
      }
...
// header
$titre_page = "Management follow-up actions";
...
<div style="text-align:center">
    <h2>Definition of follow-up actions</h2>
    <p><a href="admin_actions_absences.php?action=ajouter"><img src='../../images/icons/add.png' alt='' class='back_link' /> Add one or many action (s)</a></p>
    <br/>
    ...
    <form method="post" action="admin_actions_absences.php?action=ajouter" name="form1" id="form1">
     <fieldset class="fieldset_efface">
      <table cellpadding="2" cellspacing="2" class="tab_table">
        <tr>
          <th class="tab_th">Number of shares to be added</th>
        </tr>
      ...
      <table cellpadding="2" cellspacing="2" class="tab_table">
        ...
        <?php if (isset($verification_erreur[$nb]) and $verification_erreur[$nb] != 1) { ?>
         <tr>
          ...
          <?php if ($verification_erreur[$nb] === 2) { ?>The code you entered already exists<?php } ?>
