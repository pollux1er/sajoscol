...
// header
$titre_page = "Defining the types of weeks of the establishment";
...
echo "<p class=bold>".$retour."<img src='../../images/icons/back.png' alt='Retour' class='back_link'/> return</a>";
...
?>
	...
	<tbody>
		<tr>
			<th class="tab_th" style="width: 100px;">Weeknumber<br /> (officiel)</th>
			<th class="tab_th" style="width: 100px;">number<br />interne</th>
			<th class="tab_th" style="width: 100px;">Type</th>
			<th class="tab_th" style="width: 200px;">of</th>
			<th class="tab_th" style="width: 200px;">at</th>
		</tr>
    <?php
	...
	?>
		<tr class="<?php echo $couleur_cellule; ?>">
			...
			<td> Monday <?php echo date("d-m-Y", trouverDates($i+1)); ?> </td>
			<td> Saturday <?php echo date("d-m-Y", (trouverDates($i+1) + 5*86400)); ?> </td>
