...
// header
$titre_page = "Opening hours of the establishment";
...
// tableau semaine inverse
	$tab_sem_inv['Monday'] = '0';
	$tab_sem_inv['Tuesday'] = '1';
	$tab_sem_inv['Wednesday'] = '2';
	$tab_sem_inv['Thursday'] = '3';
	$tab_sem_inv['Friday'] = '4';
	$tab_sem_inv['Sarturday'] = '5';
	$tab_sem_inv['Sunday'] = '6';
...
echo "<p class=\"bold\">".$retour."<img src='../../images/icons/back.png' alt='Retour' class='back_link'/> Return </a></p>";
?>
...
<h2>Definition of the opening hours of the establishment</h2>
	...
	<table cellpadding="0" cellspacing="1" class="tab_table" summary="Horaires d'ouverture">
	  <tbody>
	    ...
	    <tr class="couleur_ligne_1">
	      <td class="tab_td_donnee_cote">Open</td>
	      <?php $i = '0';
		while ( $i < '7' ) { ?>
	    ...
	    <tr class="couleur_ligne_2">
	      <td class="tab_td_donnee_cote">opening</td>
	      <?php $i = '0';
		while ( $i < '7' ) { ?>
	    ...
	    <tr class="couleur_ligne_1">
	      <td class="tab_td_donnee_cote">closure</td>
	      <?php $i = '0';
		while ( $i < '7' ) { ?>
	    ...
	    <tr class="couleur_ligne_2">
	      <td class="tab_td_donnee_cote">Pause time</td>
	      <?php $i = '0';
		while ( $i < '7' ) { ?>
	    ...
	    <tr class="couleur_ligne_1">
	      <td class="tab_td_donnee_cote">Day time</td>
	      <?php $i = '0';
		while ( $i < '7' ) { ?>
