                                                ...
                                                if( $d_heure_absence_eleve != $a_heure_absence_eleve )
                                                 {
                                                  ...
                                                  } else { $erreur='1'; $erreur_valu='2'; $texte_erreur="The start time does not equal the end time."; }
                                         } else { $erreur='1'; $erreur_valu='3'; $texte_erreur="The time format (a) is not correct."; }
                                   } else { $erreur='1'; $erreur_valu='4'; $texte_erreur="The time format (to) is not correct."; }
                            } else { $erreur='1'; $erreur_valu='5'; $texte_erreur="No time was in (a) input."; }
                     } else { $erreur='1'; $erreur_valu='6'; $texte_erreur="No time was in (of) asked."; }
               } else { $erreur='1'; $erreur_valu='7'; $texte_erreur="The date is not correct."; }
...
//**************** FIN EN-TETE *****************
?>
<p class=bold>|<a href='gestion_absences.php?type=<?php echo $type; ?>'>Return</a>|
</p><?php
    ...
    if(isset($eleve_absence_eleve_erreur[0]) and !empty($eleve_absence_eleve_erreur[0])) { ?>
      ...
      if($erreur_valu === '1') { ?>
              ...
              <table style="margin: auto; width: 500px;" border="0" cellspacing="2" cellpadding="0">
                 <tr class="fond_rouge">
                    <td class="norme_absence_blanc_min"><strong>The</strong></td>
     ...
     <fieldset class="fieldset_efface">
      <table class="entete_tableau_absence" border="0" cellspacing="0" cellpadding="1">
        <tr style="background-image: url('../images/haut_tab.png');">
          <td class="titre_tableau_absence" nowrap><strong>infirmary</strong></td>
        ...
        <tr class="tr_tableau_absence_titre">
          ...
          <td class="centre">Information from the infirmary</td>
        </tr>
               ...
               $resultat_id = mysql_query($requete_id) or die('Erreur SQL !'.$requete_id.'<br />'.mysql_error());
                ...
                <?php
                 ...
                 <table class="tableau_info_compt" border="0" cellspacing="0" cellpadding="2">
                   <tr>
                     <td>Student went<br /><strong><?php if ($compte != 0) { ?><a href="javascript:centrerpopup('../lib/liste_absences.php?id_eleve=<?php echo $id_eleve; ?>&amp;type=<?php echo $type; ?>', 260, 320, 'scrollbars=yes,statusbar=no,resizable=yes');"><?php } ?><?php echo $compte; ?> fois<?php if ($compte != 0) { ?></a><?php } ?></strong><br />at infirmary</td>
                   </tr>
                 </table>
          </td>
          <td>
              <table class="tableau_100" border="0" cellspacing="2" cellpadding="2">
                ...
                <tr class="td_tableau_absence_1">
                  ...
                  <td>Of <input onfocus="javascript:this.select()" name="d_heure_absence_eleve[<?php echo $i; ?>]" type="text" id="d_heure_absence_eleve" value="<?php if (isset($d_heure_absence_eleve[$i]) and !empty($d_heure_absence_eleve[$i])) { echo $d_heure_absence_eleve[$i]; } else { ?>00:00<?php } ?>" size="8" maxlength="8" /><br />to &nbsp;&nbsp;<input name="a_heure_absence_eleve[<?php echo $i; ?>]" onfocus="javascript:this.select()" type="text" id="a_heure_absence_eleve" value="<?php if (isset($a_heure_absence_eleve[$i]) and !empty($a_heure_absence_eleve[$i])) { echo $a_heure_absence_eleve[$i]; } else { ?>00:00<?php } ?>" size="8" maxlength="8" /></td>
                </tr>
                <tr class="tr_tableau_absence_titre">
                  <td colspan="2"><strong>Information from the infirmary</strong></td>
                </tr>
		<tr>
                  <td colspan="2">
...
<?php
        ...
        $resultat = mysql_query($requete) or die('Erreur SQL !'.$requete.'<br />'.mysql_error());
?>
                <div class="norme_absence_rouge"><strong>list of passages in the infirmary déjas recorded for this date</strong></div>
                <table style="margin: auto; width: 500px;" border="0" cellspacing="2" cellpadding="0">
                  <tr class="fond_rouge">
                     <td class="norme_absence_blanc_min"><strong>The</strong></td>
                     <td class="norme_absence_blanc_min"><strong>Of</strong></td>
