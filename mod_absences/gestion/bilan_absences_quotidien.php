...
//+++++++++++++++++++++++++++++++++
//++++++++++HEADER+++++++++++++++++
$titre_page = " Daily statement of absent.";
...
<form name="autre_date" method="post" action="bilan_absences_quotidien.php">
	...
	<a href="./voir_absences_viescolaire.php">
		<img src="../../images/icons/back.png" alt="Retour" title="Return" class="back_link" />&nbsp;Return
	</a> -

	<label for="dateChoisie" style="cursor: pointer;">See statement of &nbsp;</label>
	...
	&nbsp;-&nbsp;
	<a href="bilan_absences_quotidien_pdf.php?date_choisie=<?php echo $date_choisie; ?>" title="export at file PDF">Version PDF</a>


</form>

	<h3 class="gepi" style="margin-bottom: 2px; margin-left: 4px;">statement of absent at <?php echo date_frl(date_sql($date_choisie)); ?>.</h3>
<table style="border: 1px solid black;" cellpadding="5" cellspacing="5">
	...
	<td colspan="<?php echo($nb_creneaux + 2); ?>">
		...
		<tr>
		<td style="background-color: #d7ffd4; width: 15px; color: green;"><b>R</b></td><td> Late</td><td></td>
		<td style="background-color: #ffd4d4; width: 15px; color: red;"><b>A</b></td><td> Absent</td>
		</tr>
		</table>
	</td>
	</tr>
	...
	<tr>
		<th style="border: 1px solid black; background-color: grey;">Class</th>
		<th style="border: 1px solid black; background-color: grey; width: 300px;">Full name</th>
<?php
...
// ===================== Quelques variables utiles ===============
	...
	if ($nbre_rep >= 1) {
		...
		$attention = "institution is supposed close today.";
	}
