...
else
{
	...
	echo "<p style='color:red'>DEBUG:<br /> the generation of PDF has fail because we poster it information of debugger, </br> but it maybe that you have precision on this problem.</br>
              </p>\n";
...
/* début de la génération du fichier PDF */
	...
	$pdf->SetKeywords('');
	// sujet du document
	$pdf->SetSubject(' Daily statement of absent ');
	// titre du document
	$pdf->SetTitle('Daily statement of absent');
...
/* ENTETE TITRE - DEBUT */
		...
		$pdf->Cell(120, 6, 'Daily statement of absent', 0, 1, 'C');
		...
		$pdf->SetX(85);
		$pdf->Cell(120, 5, traite_accents_utf8('year'), 0, 1, 'C');
...
/* ENTETE TABLEAU - DEBUT */
	...
	// Cellule identité
	$pdf->Cell($lar_col_eleve, $hau_entete, traite_accents_utf8('full name'), 1, 0, 'C');
