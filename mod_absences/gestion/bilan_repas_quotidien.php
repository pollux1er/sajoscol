...
//+++++++++++++++++++++++++++++++++
//++++++++++HEADER+++++++++++++++++
$titre_page = " daily statement of meal.";
...
<form name="autre_date" method="post" action="bilan_repas_quotidien.php">
	...
	<a href="./voir_absences_viescolaire.php">
		<img src="../../images/icons/back.png" alt="Retour" title="Retour" class="back_link" />&nbsp;Return
	</a> -
	...
	<h3 class="gepi" style="margin-bottom: 2px; margin-left: 4px;">statement meal of <?php echo date_frl(date_sql($date_choisie)); ?>.</h3>
