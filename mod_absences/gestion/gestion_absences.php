...
<div style="border-top: 2px solid #2C7E8F; /* #FF9F2F */ border-bottom: 2px solid #2C7E8F; width: 100%; margin: auto; padding: 0; position: relative;">
	...
	<?php
		...
		<div style="float: left; margin: 12.5px 0px 0px 0px; width: 36%">
			Name : <strong><?php echo $nom_eleve; ?></strong><br />
			first name : <strong><?php echo $prenom_eleve; ?></strong><br />
			Date of birth : <?php echo $naissance_eleve; ?><br />
			Age : <strong><?php echo age($date_de_naissance); ?> years</strong><br />
			<br />
			Class : <a href="#" class="info"><?php echo classe_de($login_eleve); ?><span style="width: 300px;">(followed by : <?php echo pp(classe_court_de($login_eleve)); ?>)</span></a>
		</div>
...
<?php /* ajout impressions didier */ ?>
	...
	[ <a href="gestion_absences.php?select_fiche_eleve=<?php echo $select_fiche_eleve; ?>&amp;aff_fiche=suivieleve#suivieleve" title="consulter le suivi de l'élève">Monitoring the student</a> |
	<a href="gestion_absences.php?select_fiche_eleve=<?php echo $select_fiche_eleve; ?>&amp;aff_fiche=abseleve#abseleve" title="consulter l'absentéisme non justifié">Unjustified absenteeism</a> | 
	<a href="gestion_absences.php?select_fiche_eleve=<?php echo $select_fiche_eleve; ?>&amp;aff_fiche=tableauannuel" title="consulter la fiche de l'élève">annual Statistical</a> | 
	<a href="gestion_absences.php?select_fiche_eleve=<?php echo $select_fiche_eleve; ?>&amp;aff_fiche=suivieleve#tab_sem_abs" title="Répartissement des absences">Distribution of absences</a> |
	<a href="gestion_absences.php?select_fiche_eleve=<?php echo $select_fiche_eleve; ?>&amp;aff_fiche=impbilan#impbilan" title="Impression bilan des absences">Printed record of absences </a> |
	<a href="gestion_absences.php?select_fiche_eleve=<?php echo $select_fiche_eleve; ?>&amp;aff_fiche=impfic#impfic" title="Impression fiche récapitulative">Print summary sheet </a> ]
    </div><br />
...
<?php /* DIV du suivi de l'élève */ ?>
	   <?php if ( $aff_fiche==='suivieleve' or $aff_fiche==='' ) { ?>
		<a name="suivieleve"></a>
		<div style="background-image: url(../images/haut_tab.png); font-size: 120%; font-weight: bold; color: #E8F1F4; text-align: left;">student news</div>
		<div style="border-top: 2px solid #2C7E8F; border-bottom: 2px solid #2C7E8F;">
			...
			<a name="formulaire"></a>
		            <form method="post" action="gestion_absences.php?select_fiche_eleve=<?php echo $select_fiche_eleve; ?>">
		               <fieldset>
		                 <legend>Add a tracking</legend>
			                 <select id="info_suivi" onchange="data_info_suivi.value += info_suivi.options[info_suivi.selectedIndex].text + '\n'" style="width: 210px;">
			                   <option>Selected a quick text</option>
					  		   <option>[Exclusion of the course] Has been excluded from the course: to:</option>
			                   <option>Meeting with parents</option>
			                 </select>
...
<?php /* 		   <input type="hidden" name="uid_post" value="<?php echo my_ereg_replace(' ','%20',$uid); ?>" /> */ ?>
					 ...
					 <table style="border: 0px" cellspacing="1" cellpadding="1">
						...
						<div style="font-family: Arial; font-size: 0.8em; background-color: #FFFFFF; border : 1px solid #0061BD; height: 70px; padding-left: 2px; width: 100px;">
							...
							<input name="niveau_urgent" id="nur3" value="3" type="radio" <?php if(!empty($data_modif_fiche['niveau_message_suivi_eleve_cpe']) and $data_modif_fiche['niveau_message_suivi_eleve_cpe']==='3') { ?>checked="checked"<?php } ?> /><label for="nur3" style="cursor: pointer;">priority</label><br />
						</div>
						</td>
					    </tr>
				        </table>
					...
					Method&nbsp;:
						<input name="support_suivi_eleve_cpe" id="ppar1" value="1" type="radio" <?php if(!empty($data_modif_fiche['support_suivi_eleve_cpe']) and $data_modif_fiche['support_suivi_eleve_cpe'] === '1') { ?>checked="checked"<?php } ?> onclick="javascript:aff_lig_type_courrier('cacher')" /><label for="ppar1" style="cursor: pointer;">orally</label>
						...
						<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<input name="support_suivi_eleve_cpe" id="ppar4" value="4" type="radio" <?php if(!empty($data_modif_fiche['support_suivi_eleve_cpe']) and $data_modif_fiche['support_suivi_eleve_cpe'] === '4') { ?>checked="checked"<?php } ?> onclick="javascript:aff_lig_type_courrier('afficher')" /><label for="ppar4" style="cursor: pointer;">mail</label>
						<input name="support_suivi_eleve_cpe" id="ppar6" value="6" type="radio" <?php if(!empty($data_modif_fiche['support_suivi_eleve_cpe']) and $data_modif_fiche['support_suivi_eleve_cpe'] === '6') { ?>checked="checked"<?php } ?> onclick="javascript:aff_lig_type_courrier('cacher')" /><label for="ppar6" style="cursor: pointer;">Document binding</label>
	...
	<div style="text-align: center;">
	  <?php if($debut_selection_suivi!='0') { ?><a href="gestion_absences.php?select_fiche_eleve=<?php echo $select_fiche_eleve; ?>&amp;debut_selection_suivi=<?php echo $debut_selection_suivi-'2'; ?>">previous page</a><?php } ?>
	  ...
	  <?php if($debut_selection_suivi_suivant<=$cpt_komenti) { ?><a href="gestion_absences.php?select_fiche_eleve=<?php echo $select_fiche_eleve; ?>&amp;debut_selection_suivi=<?php echo $debut_selection_suivi+'2'; ?>">next Page</a><?php } ?>
	</div>
           <?php
	     $requete_komenti = "SELECT * FROM ".$prefix_base."suivi_eleve_cpe WHERE ".$prefix_base."suivi_eleve_cpe.eleve_suivi_eleve_cpe = '".$login_eleve."' ORDER BY date_suivi_eleve_cpe DESC, heure_suivi_eleve_cpe DESC LIMIT ".$debut_selection_suivi.", 2";
		   ...
		   if(!empty($data_komenti['niveau_message_suivi_eleve_cpe'])) {
				...
				if( $data_komenti['niveau_message_suivi_eleve_cpe']==='3') { $couleur='#FFDFDF'; $couleur2='#FF0000'; $couleur3='#FDFFEF'; $drapeau='[prioritaire]'; }
                    ...
                    <div class="info_eleve" style="background: <?php echo $couleur; ?>;"><b><?php echo date_frl($data_komenti['date_suivi_eleve_cpe']).' - '.$data_komenti['heure_suivi_eleve_cpe'].' <span style="font-weight: bold; color: '.$couleur2.';">'.$drapeau.'</span>'; ?></b><br /><?php echo $data_komenti['komenti_suivi_eleve_cpe'].$action_pour_eleve; ?><br /><br /><span class="dimi_texte">Written by : <?php echo qui($data_komenti['parqui_suivi_eleve_cpe']); ?><br />
			<?php
		...
		<?php // courrier attaché
			...
			<?php
				...
				<br />&nbsp;&nbsp;&nbsp;received the answer: <?php echo $datation;
				       if ( !empty($data_1['reponse_remarque_lettre_suivi']) ) { ?><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Remarque : <?php echo $data_1['reponse_remarque_lettre_suivi']; }
			        } else { ?><br />&nbsp;&nbsp;&nbsp;<span style="color: #EF000A;"><strong>Canceled by mail <?php echo qui($data_1['quireception_lettre_suivi']); ?></strong></span><?php } ?>
			    </div>
		 <?php } ?>
		<?php } ?>
           <?php } ?>
...
<?php /* DIV de l'absentéisme de l'élève */ ?>
	<?php if ( $aff_fiche === 'abseleve' ) { ?>
		<a name="abseleve"></a>
		<div style="background-image: url(../images/haut_tab.png); font-size: 120%; font-weight: bold; color: #E8F1F4; text-align: left;">Absenteeism of students</div>
		<div style="border-top: 2px solid #2C7E8F; /* #FF9F2F */ border-bottom: 2px solid #2C7E8F; width: 100%; margin: auto; padding: 0; position: relative;">
			<div style="background: transparent url(../images/grid_10.png); padding-top: 5px;">
...
// modification du critère pour compter aussi les non justifs par telephone didier		
		$cpt_absences_nj = mysql_result(mysql_query("SELECT count(*) FROM ".$prefix_base."absences_eleves WHERE eleve_absence_eleve = '".$select_fiche_eleve."' AND type_absence_eleve = 'A' AND justify_absence_eleve != 'O'"),0);
           ...
           <p class="titre_sous_menu"><b><a href="javascript:centrerpopup('../lib/liste_absences.php?id_eleve=<?php echo $select_fiche_eleve; ?>&amp;type=A',260,320,'scrollbars=yes,statusbar=no,resizable=yes');" title="Absences"><?php echo $cpt_absences; ?></a></b> Absence(s)</p>
               <?php if ( $cpt_absences_nj != 0 ) { ?>
           	   List of unjustified absences (s)<br />
		   <ul>
	   ...
	   <?php $cpt_retards = mysql_result(mysql_query("SELECT count(*) FROM ".$prefix_base."absences_eleves WHERE eleve_absence_eleve = '".$select_fiche_eleve."' AND type_absence_eleve = 'R'"),0);
		 ...
		 $cpt_retards_nj = mysql_result(mysql_query("SELECT count(*) FROM ".$prefix_base."absences_eleves WHERE eleve_absence_eleve = '".$select_fiche_eleve."' AND type_absence_eleve = 'R' AND justify_absence_eleve != 'O '"),0);
           ...
           if ( $cpt_retards != 0 ) { ?>
           <p class="titre_sous_menu"><b><a href="javascript:centrerpopup('../lib/liste_absences.php?id_eleve=<?php echo $select_fiche_eleve; ?>&amp;type=R',260,320,'scrollbars=yes,statusbar=no,resizable=yes');" title="Retards"><?php echo $cpt_retards; ?></a></b> delays</p>
               <?php if($cpt_retards_nj != 0) { ?>
	           List of unwarranted delays (s)<br />
		   <ul>
	           <?php // modification du critère pour compter aussi les non justifs par telephone didier	
	   ...
	   <?php } ?>
		 ...
		 $cpt_dispences_nj = mysql_result(mysql_query("SELECT count(*) FROM ".$prefix_base."absences_eleves WHERE eleve_absence_eleve = '".$select_fiche_eleve."' AND type_absence_eleve = 'D' AND justify_absence_eleve = 'N '"),0);
           ...
           if( $cpt_dispences != 0 ) { ?>
           <p class="titre_sous_menu"><b><a href="javascript:centrerpopup('../lib/liste_absences.php?id_eleve=<?php echo $select_fiche_eleve; ?>&amp;type=D',260,320,'scrollbars=yes,statusbar=no,resizable=yes');" title="Dispences"><?php echo $cpt_dispences; ?></a></b> exemptions</p>
               <?php if($cpt_dispences_nj != 0) { ?>
	           List of unjustified exemptions (s)<br />
		   <ul>
	   ...
	   <?php } ?>
           ...
           <p class="titre_sous_menu"><b><a href="javascript:centrerpopup('../lib/liste_absences.php?id_eleve=<?php echo $select_fiche_eleve; ?>&amp;type=I',260,320,'scrollbars=yes,statusbar=no,resizable=yes');" title="Infirmerie"><?php echo $cpt_infirmeries; ?></a></b> Ambulance</p>
           <br />
           <?php } ?>
...
<?php /* DIV impression bilan  */ ?>
	   <?php if ( $aff_fiche==='impbilan') {	?>
		<a name="impbilan"></a>
		<div style="background-image: url(../images/haut_tab.png); font-size: 120%; font-weight: bold; color: #E8F1F4; text-align: left;">Printed record of absences</div>
		<div style="border-top: 2px solid #2C7E8F; border-bottom: 2px solid #2C7E8F;">
			<div style="background: transparent url(../images/grid_10.png); padding-top: 5px;">
<?php
$absencenj='';
   ...
   <form method="post" action="bilan_absence.php?type_impr=bda&amp;choix=<?php echo $choix; ?>" target="blank" name="form3">
      <fieldset style="width: 340px; margin: auto;" class="couleur_ligne_3">
         <legend class="legend_texte">&nbsp;Selection&nbsp;</legend>
            <div class="titre_tableau_gestion">General statement of absences</div>
            <div class="norme_absence" style="text-align: left;">
			 ...
			 <input type="hidden" name="eleve" value="<?php echo $select_fiche_eleve; ?>" />
                du <input name="du" type="text" size="11" maxlength="11" value="<?php echo $du2; ?>" /><a href="#calend" onClick="<?php  echo $cal_3->get_strPopup('../../lib/calendrier/pop.calendrier.php', 350, 170); ?>"><img src="../../lib/calendrier/petit_calendrier.gif" border="0" alt="" /></a> at <input name="au" id="au" type="text" size="11" maxlength="11" value="<?php echo $au; ?>" onClick="getDate(au,'form3')" /><a href="#calend" onClick="<?php  echo $cal_4->get_strPopup('../../lib/calendrier/pop.calendrier.php', 350, 170); ?>"><img src="../../lib/calendrier/petit_calendrier.gif" border="0" alt="" /></a>
		<br /><a href="#ao" onclick="affichercacher('div_1')" style="cursor: pointer;"><img style="border: 0px solid ; width: 13px; height: 13px; border: none; padding:2px; margin:2px; float: left;" name="img_1" alt="" title="Information" src="../../images/fleche_na.gif" align="middle" />other options</a>
		<div id="div_1" style="display: <?php if( $absencenj != '' or $retardnj != '' ) { ?>block<?php } else { ?>none<?php } ?>; border-top: solid 1px; border-bottom: solid 1px; padding: 10px; background-color: #E0EEEF"><a name="ao"></a>
		  <span style="font-family: Arial;">
			<input name="absencenj" id="absencenj" value="1" type="checkbox" onclick="activedesactive('retardnj','absencenj');" <?php if ( $absencenj === '1' ) { ?>checked="checked"<?php } ?> /><label for="absencenj" style="cursor: pointer;">List only unexcused absences</label>
		  	<br /><input name="retardnj" id="retardnj" value="1" type="checkbox" onclick="activedesactive('absencenj','retardnj');" <?php if ( $retardnj === '1' ) { ?>checked="checked"<?php } ?> /><label for="retardnj" style="cursor: pointer;">List only unwarranted delays</label>
		  </span>
		</div>
...
<?php /* DIV fiche recap  */ ?>
	   ...
	   ?>
		<a name="impfic"></a>
		<div style="background-image: url(../images/haut_tab.png); font-size: 120%; font-weight: bold; color: #E8F1F4; text-align: left;">Print summary sheet</div>
		<div style="border-top: 2px solid #2C7E8F; border-bottom: 2px solid #2C7E8F;">
			<div style="background: transparent url(../images/grid_10.png); padding-top: 5px;">
<?php
$absencenj='';
...
<div style="text-align: center;">
   <form method="post" action="fiche_pdf.php" target="blank" name="form3">
      <fieldset style="width: 340px; margin: auto;" class="couleur_ligne_3">
         <legend class="legend_texte">&nbsp;Selection&nbsp;</legend>
            <div class="titre_tableau_gestion">summary Sheet</div>
            <div class="norme_absence" style="text-align: left;">
             <br />
			    of <input name="du" type="text" size="11" maxlength="11" value="<?php echo $du2; ?>" /><a href="#calend" onClick="<?php  echo $cal_3->get_strPopup('../../lib/calendrier/pop.calendrier.php', 350, 170); ?>"><img src="../../lib/calendrier/petit_calendrier.gif" border="0" alt="" /></a>
				at <input name="au" id="au" type="text" size="11" maxlength="11" value="<?php echo $au; ?>" onClick="getDate(au,'form3')" /><a href="#calend" onClick="<?php  echo $cal_4->get_strPopup('../../lib/calendrier/pop.calendrier.php', 350, 170); ?>">
...
<?php /* DIV des statistique de l'élève ajout avec impression didier*/ ?>
	<?php if ( $aff_fiche === 'suivieleve' or  $aff_fiche === '' or $aff_fiche==='abseleve' or $aff_fiche==='impbilan' or $aff_fiche==='impfic') { ?>
		<div style="background-image: url(../images/haut_tab.png); font-size: 120%; font-weight: bold; color: #E8F1F4; text-align: left;">Statistics student</div>
		<div style="border-top: 2px solid #2C7E8F; border-bottom: 2px solid #2C7E8F;">
			<div style="background: transparent url(../images/grid_10.png); padding-top: 5px;">
			<?php
				// graphique
...
*/
	...
	?><div style="font-size: 14px; text-align: center; margin: auto;"><strong>Graphic absence and delay of the Year</strong></div>
...
//	     $requete_comptage = mysql_result(mysql_query("SELECT count(*) FROM ".$prefix_base."absences_eleves WHERE eleve_absence_eleve = '".$select_fiche_eleve."'  AND type_absence_eleve = 'A'"),0);
	...
	<table style="border-style: solid; border-width: 2px; border-color: black; width: 320px; border-collapse: collapse; margin: auto;">
		<caption style="font-size: 14px; text-align: center; margin: auto;"><strong>Number of absences per time slot</strong></caption>
		<tr style="background-color: #F0FFCF;">
			<td class="td_semaine_jour"></td>
			<?php if ( isset($semaine['lundi']['ouverture']) ) { ?><td class="td_semaine_jour">Mon.</td><?php } ?>
			<?php if ( isset($semaine['mardi']['ouverture']) ) { ?><td class="td_semaine_jour">Tues.</td><?php } ?>
			<?php if ( isset($semaine['mercredi']['ouverture']) ) { ?><td class="td_semaine_jour">Wednes.</td><?php } ?>
			<?php if ( isset($semaine['jeudi']['ouverture']) ) { ?><td class="td_semaine_jour">Thurs.</td><?php } ?>
			<?php if ( isset($semaine['vendredi']['ouverture']) ) { ?><td class="td_semaine_jour">Fri.</td><?php } ?>
			<?php if ( isset($semaine['samedi']['ouverture']) ) { ?><td class="td_semaine_jour">Sartur.</td><?php } ?>
		</tr>
	<?php
	$i = '0';
	...
	$i = $i +1;
		...
		<div style="text-align: center; margin: auto;"><strong><a href="#ident">ascend</a></strong></div>
		<br /><br />
	</div>
</div>
...
<div style="margin: auto; position: relative;">
	<div style="float: left; width: 781px">
		<div style="background-image: url(../images/haut_tab.png); font-size: 120%; font-weight: bold; color: #E8F1F4; text-align: left;">The student of the year</div>
		<div style="border-top: 2px solid #2C7E8F; /* #FF9F2F */ border-bottom: 2px solid #2C7E8F; width: 100%; margin: auto; padding: 0; position: relative;">
	...
	?><div style="font-size: 14px; text-align: center; margin: auto;"><strong>Statistics over a year</strong></div>
	<?php
...
<div style="text-align:center">
<br />
<form method="post" action="gestion_absences.php?choix=lemessager" name="form1">At the date of <input name="du" type="text" size="11" maxlength="11" value="<?php if(isset($du)) { echo $du; } ?>" /><a href="#calend" onclick="<?php echo $cal->get_strPopup('../../lib/calendrier/pop.calendrier.php',350,170); ?>"><img src="../../lib/calendrier/petit_calendrier.gif" border="0" alt="" /></a> <input type="submit" name="Submit" value="&gt;&gt;" /></form>
    <table style="margin: auto; width: 700px;" border="0" cellspacing="1" cellpadding="0">
       <tr class="fond_rouge">
           <td colspan="2" class="titre_tableau_gestion"><b>the messenger</b></td>
       </tr>
       <tr class="td_tableau_absence_1">
           <td class="norme_absence_min" style="text-align: center; width: 50%;">the priority</td>
           <td class="norme_absence_min" style="text-align: center; width: 50%;">posts</td>
       </tr>
	   ...
	   <?php
		   ...
		   if(!empty($data_komenti['niveau_message_suivi_eleve_cpe'])) {
				...
				if( $data_komenti['niveau_message_suivi_eleve_cpe']==='3') { $couleur='#FFDFDF'; $couleur2='#FF0000'; $drapeau='[prioritaire]'; }
                    ...
                    <p class="info_eleve" style="background: <?php echo $couleur; ?>;"><b><?php echo date_frl($data_komenti['date_suivi_eleve_cpe']).' - '.$data_komenti['heure_suivi_eleve_cpe']; ?></b><br /><?php echo $data_komenti['komenti_suivi_eleve_cpe']; ?><br /><br /><span class="dimi_texte">write by : <?php echo qui($data_komenti['parqui_suivi_eleve_cpe']); ?><br />concerns: <strong><a href="gestion_absences.php?select_fiche_eleve=<?php echo $data_komenti['eleve_suivi_eleve_cpe']; ?>" title="consulter le suivi élève"><?php echo qui_eleve($data_komenti['eleve_suivi_eleve_cpe']); ?></a></strong> of <?php echo classe_de($data_komenti['eleve_suivi_eleve_cpe']) ?><br />[ <a href="gestion_absences.php?select_fiche_eleve=<?php echo $data_komenti['eleve_suivi_eleve_cpe']; ?>">read</a> ]</span></p>
           <?php } ?>
	   </td>
           <td class="norme_absence_min" valign="top">
           <?php
		   ...
		   if(!empty($data_komenti['niveau_message_suivi_eleve_cpe'])) {
				...
				if( $data_komenti['niveau_message_suivi_eleve_cpe']==='3') { $couleur='#FFDFDF'; $couleur2='#FF0000'; $drapeau='[prioritaire]'; }
                    ...
                    <p class="info_eleve" style="background: <?php echo $couleur; ?>;"><b><?php echo date_frl($data_komenti['date_suivi_eleve_cpe']).' - '.$data_komenti['heure_suivi_eleve_cpe'].' <span style="font-weight: bold; color: '.$couleur2.';">'.$drapeau.'</span>'; ?></b><br /><?php echo $data_komenti['komenti_suivi_eleve_cpe']; ?><br /><br /><span class="dimi_texte">write by: <?php echo qui($data_komenti['parqui_suivi_eleve_cpe']); ?><br />concerns: <strong><a href="gestion_absences.php?select_fiche_eleve=<?php echo $data_komenti['eleve_suivi_eleve_cpe']; ?>" title="consulter le suivi élève"><?php echo qui_eleve($data_komenti['eleve_suivi_eleve_cpe']); ?></a></strong> dof <?php echo classe_de($data_komenti['eleve_suivi_eleve_cpe']) ?><br />[ <a href="gestion_absences.php?select_fiche_eleve=<?php echo $data_komenti['eleve_suivi_eleve_cpe']; ?>">read</a> ]</span></p>
           <?php } ?>
	   </td>
       </tr>
    </table>
...
<br />
    <table style="margin: auto; width: 700px;" border="0" cellspacing="1" cellpadding="0">
       <tr class="fond_rouge">
           <td colspan="1" class="titre_tableau_alert"><b>Alert system</b></td>
       </tr>
       <tr class="td_tableau_absence_1">
           <td class="norme_absence_min" style="text-align: center; width: 50%;">the alerts</td>
       </tr>
       <tr class="td_tableau_absence_1">
...
<form method="post" action="impression_absences.php?type_impr=<?php echo $type_impr; ?>" name="form3">
      <fieldset style="width: 450px; margin: auto;">
         <legend class="legend_texte">&nbsp;Selection&nbsp;</legend>
            <div class="titre_tableau_gestion">Profiles recherchers</div>
		 ...
		 <tr>
		   <td colspan="2">
			<select name="ajout_type_alert" size="1" style="width: 200px;">
				...
				<option>type letter</option>
				<option>student sheet</option>
			</select>
			<input type="submit" name="Submit10" value="Ajouter" />
</td>
		 </tr>
		</table>
                of <input name="du" type="text" size="11" maxlength="11" value="<?php echo $du; ?>" /><a href="#calend" onclick="<?php  echo $cal->get_strPopup('../../lib/calendrier/pop.calendrier.php', 350, 170); ?>"><img src="../../lib/calendrier/petit_calendrier.gif" border="0" alt="" /></a>
            </div>
      </fieldset>
    </form>
