...
<div id="absences">
<p class="bold"><a href='<?php if($select_fiche_eleve=='' and $fiche_eleve=='' and $choix!='lemessager') { ?>../../accueil.php<?php } else { ?>gestion_absences.php<?php } ?>'><img src="../../images/icons/back.png" alt="Retour" title="Retour" class="back_link" />&nbsp;Return</a> |
<a href="./impression_absences.php?type=<?php echo $type; ?>&amp;year=<?php echo $year; ?>&amp;month=<?php echo $month; ?>&amp;day=<?php echo $day; ?>">printing</a> |
<a href="statistiques.php?year=<?php echo $year; ?>&amp;month=<?php echo $month; ?>&amp;day=<?php echo $day; ?>">statistics</a> |
<a href="gestion_absences.php?choix=lemessager&amp;year=<?php echo $year; ?>&amp;month=<?php echo $month; ?>&amp;day=<?php echo $day; ?>">the messenger</a> |
<a href="alert_suivi.php?choix=alert&amp;year=<?php echo $year; ?>&amp;month=<?php echo $month; ?>&amp;day=<?php echo $day; ?>">Warning system</a>
</p>
  ...
  <form method="post" action="gestion_absences.php?type=<?php echo $type; ?>&amp;choix=<?php echo $choix; ?>" name="choix_type_vs" style="margin: auto; text-align: center;">
   <fieldset class="fieldset_efface">
     ...
     <select name="type" onchange="javascript:document.choix_type_vs.submit()">
        ...
        <option value="R" onclick="javascript:document.choix_type_vs.submit()" <?php if ($type=="R") {echo 'selected="selected"'; } ?>>Late</option>
        <option value="I" onclick="javascript:document.choix_type_vs.submit()" <?php if ($type=="I") {echo 'selected="selected"'; } ?>>infirmary</option>
        <option value="D" onclick="javascript:document.choix_type_vs.submit()" <?php if ($type=="D") {echo 'selected="selected"'; } ?>>exemptions</option>
     </select>
     <!--<input name="submit8" type="image" src="../../images/enabled.png" style="border: 0px;" />-->
		<?php /* <input type="submit" name="submit8" value="&lt;&lt;" />*/ ?>
     &nbsp; <a href="select.php?type=<?php echo $type; ?>&amp;classe_choix=<?php echo $classe_choix; ?>">add</a> - <a href="../lib/tableau.php?type=<?php echo $type; ?>&amp;pagedarriver=gestion_absences">table</a>
        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;See student sheet <input type="text" name="fiche_eleve" value="" /><input name="submit" type="image" src="../../images/enabled.png" style="border: 0px;" />
		<?php /* <input type="submit" name="submit8" value="&lt;&lt;" /> */ ?>
   </fieldset>
  </form>
...
[ <a href="gestion_absences.php?choix=top10&amp;type=<?php echo $type ?>">Top <?php echo $TOP; ?></a> | <a href="gestion_absences.php?choix=sm&amp;type=<?php echo $type; ?>&amp;date_ce_jour=<?php echo $date_ce_jour; ?>">Unexcused absences</a> | <a href="gestion_absences.php?choix=am&amp;type=<?php echo $type; ?>&amp;date_ce_jour=<?php echo $date_ce_jour; ?>">excused absences</a> ]
<?php } if($type == "R" and $fiche_eleve == "") { ?>
[ <a href="gestion_absences.php?choix=top10&amp;type=<?php echo $type; ?>">Top <?php echo $TOP; ?></a> | <a href="gestion_absences.php?choix=sm&amp;type=<?php echo $type; ?>&amp;date_ce_jour=<?php echo $date_ce_jour; ?>">Undue delays</a> | <a href="gestion_absences.php?choix=am&amp;type=<?php echo $type; ?>&amp;date_ce_jour=<?php echo $date_ce_jour; ?>">delays justified</a> ]
<?php } if($type == "I" and $fiche_eleve == "") { ?>
[ <a href="gestion_absences.php?choix=top10&amp;type=<?php echo $type; ?>">Top <?php echo $TOP; ?></a> | <a href="gestion_absences.php?choix=am&amp;type=<?php echo $type; ?>&amp;date_ce_jour=<?php echo $date_ce_jour; ?>">Infirmary with pattern</a> ]
<?php } if($type == "D" and $fiche_eleve == "") { ?>
[ <a href="gestion_absences.php?choix=top10&amp;type=<?php echo $type; ?>">Top <?php echo $TOP; ?></a> | <a href="gestion_absences.php?choix=sm&amp;type=<?php echo $type; ?>&amp;date_ce_jour=<?php echo $date_ce_jour; ?>">Unjustified exemptions</a> | <a href="gestion_absences.php?choix=am&amp;type=<?php echo $type; ?>&amp;date_ce_jour=<?php echo $date_ce_jour; ?>">exemptions justified</a> ]
<?php } ?>
</div>
...
?>
          <table border="0" cellpadding="2" cellspacing="2" class="tableau_calque_information">
			...
			<?php if ($type == "A") {?>Absent attachement : <?php } ?><?php if ($type == "R") {?>Retard saisi : <?php } ?><?php if ($type == "I") {?>passages in the infirmary attachement : <?php } ?><?php if ($type == "D") {?>exemption attachement : <?php } ?><b><?php echo $compte ?></b><br /></td>
    ...
    <td style="text-align: center">
       ...
       <form name="form1" method="post" action="gestion_absences.php?type=<?php echo $type; ?>&amp;choix=<?php echo $choix; ?>">
         <fieldset style="background-color: #D1EFE8; background-image: url(../images/2.png); ">
          <legend class="legend_texte">&nbsp;Selection&nbsp;</legend>
          Class &nbsp;
          <select name="classe_choix" onchange="javascript:document.form1.submit()">
            <option value="" selected="selected" onclick="javascript:document.form1.submit()">All Classes</option>
                <?php
           ...
           <?php if (getSettingValue("active_module_trombinoscopes")=='y')  { ?>
               <br />
               <input type="checkbox" name="photo" value="avec_photo" id="avecphoto" onClick="javascript:document.form1.submit()" <?php  if ($photo=="avec_photo") { ?>checked="checked"<?php } ?> /><label for="avecphoto" style="cursor: pointer;">with photo</label><br />
           <?php } ?>
               <br />
          TOP <?php echo $TOP; ?> des <?php if($type == "A") { ?>absences.<?php } if($type == "R") { ?>late.<?php } if($type == "I") { ?>passages in the infirmary.<?php } if($type == "D") { ?>exemptions.<?php } ?>
	    </fieldset>
          </form>
    </td>
  </tr>
...
?>
          <table border="0" cellpadding="2" cellspacing="2" class="tableau_calque_information">
             <tr>
                <td class="texte_fondjaune_calque_information"><?php echo "<b>".strtoupper($data_sans_motif['nom'])."</b> ".ucfirst($data_sans_motif['prenom']); ?> student of <?php echo "<b>".classe_de($data_sans_motif['login'])."</b>";  $id_classe_eleve = classe_de($data_sans_motif['login']); ?><br /><?php if ($data_sans_motif['type_absence_eleve']=="A") { ?> was absent<?php if ($data_sans_motif['sexe'] == "F") { ?>e<?php } } if  ($data_sans_motif['type_absence_eleve']=="R") { ?> est arrivé<?php if ($data_sans_motif['sexe'] == "F") { ?>e<?php } ?> late<?php } ?><?php if ($data_sans_motif['type_absence_eleve']=="I") { ?>went to the infirmary<?php } ?><br /> the <?php echo date_frl($data_sans_motif['d_date_absence_eleve']); ?><?php if (($data_sans_motif['a_date_absence_eleve'] != $data_sans_motif['d_date_absence_eleve'] and $data_sans_motif['a_date_absence_eleve'] != "") or $data_sans_motif['a_date_absence_eleve'] == "0000-00-00") { ?> to <?php echo date_frl($data_sans_motif['a_date_absence_eleve']); ?><?php } ?><br /><?php if ($data_sans_motif['a_heure_absence_eleve'] == "00:00:00" or $data_sans_motif['a_heure_absence_eleve'] == "") { ?>à <?php } else { ?>de <?php } ?><?php echo heure($data_sans_motif['d_heure_absence_eleve']); ?> <?php if ($data_sans_motif['a_heure_absence_eleve'] == "00:00:00" or $data_sans_motif['a_heure_absence_eleve'] == "") { } else { echo 'à '.heure($data_sans_motif['a_heure_absence_eleve']); } ?></td>
                 <?php if (getSettingValue("active_module_trombinoscopes")=='y') {
             ...
             <tr>
                <td class="norme_absence"><?php if($data_sans_motif['saisie_absence_eleve']!="") { ?>registered by : <?php echo qui($data_sans_motif['saisie_absence_eleve']); } ?><br />for reason : <?php echo motif_de($data_sans_motif['motif_absence_eleve']); ?></td>
             </tr>
             <tr>
                <td class="norme_absence"><?php if ($data_sans_motif['justify_absence_eleve'] == "O") {?><span class="norme_absence_vert"><b>gave justification for: </b>
									<?php } elseif ($data_sans_motif['justify_absence_eleve'] == "T") { ?><span class="norme_absence_vert" style="color: orange;"><b>justified by phone : </b>
																						<?php } else { ?><span class="norme_absence_rouge"><b>has not given any reasons</b>
																						<?php } ?></span></td>
             </tr>
             <tr>
             ...
             <tr class="texte_fondjaune_calque_information">
					...
					for ($i = 0 ; $i < $nbre ; $i++){
						if ($info_responsable[$i]['resp_legal'] == '1') {
							...
							if ( $info_responsable[$i]['tel_port'] != ''  ) {
								$telephone_port = '<br />Port.<img src="../images/attention.png" alt="care surcharge number" title="care surcharge number" border="0" height="14" width="14" /> '.present_tel($info_responsable[$i]['tel_port']);
							}
						}
					}
				}
				...
				if ( $telephone_pers === '' and $telephone_prof === '' and $telephone_port != '' ) { $telephone = $telephone_port . ' ! surcharge'; }

				if ( $telephone_pers != '' or $telephone_prof != '' or $telephone_port != '' ) { $telephone = 'Phone charge: '.$telephone; }
				else { $telephone = 'No phone number available'; }
      ...
      <form name ="form3" method="post" action="gestion_absences.php?choix=<?php echo $choix; ?>&amp;type=<?php echo $type; ?>&amp;date_ce_jour=<?php echo $date_ce_jour; ?>&amp;action_sql=supprimer_selection">
	   ...
	   <?php /* modification affichage didier */ ?>
        <table class="td_tableau_gestion" style="margin: auto; margin-top:15px; width: 600px; border: 0 0 0 0;">
          <tr>
<?php /* modification affichage didier */ ?>
		   <td colspan="2" class="titre_tableau_gestion"><b><?php if ($type=="A") { ?>Unexcused absences<?php } ?><?php if ($type=="R") { ?>Undue delays<?php } ?><?php if ($type=="I") { ?>Infirmary without cause<?php } ?><?php if ($type=="D") { ?>Unjustified exemptions<?php } ?></b></td>
          </tr>
          <?php
         $total = 0;
         $i = 0;
		...
		while ( $data_sans_motif = mysql_fetch_array($execution_sans_motif))
		{
         ...
         <?php // si pas de lettres envoyés  affiche  case à cocher et affiche icone suppression modif didier
				...
				<a href="ajout_<?php if($data_sans_motif['type_absence_eleve']=="A") { ?>abs<?php } if ($data_sans_motif['type_absence_eleve']=="R") { ?>ret<?php } if($data_sans_motif['type_absence_eleve']=="D") { ?>dip<?php } if($data_sans_motif['type_absence_eleve']=="I") { ?>inf<?php } ?>.php?action=supprimer&amp;type=<?php echo $type; ?>&amp;id=<?php echo $data_sans_motif['id_absence_eleve']; ?>&amp;date_ce_jour=<?php echo $date_ce_jour; ?>" onClick="return confirm('Are you sure you want to remove it ...')"><img src="../images/icons/delete.png" style="width: 16px; height: 16px;" title="remove the absence" border="0" alt="" /></a>
				<?php
				}
				else // sinon si lettre envoyé  n'affiche pas case à cocher et affiche icone delete_imp modif didier
				{$info_sup = 'of '.date_fr($data_sans_motif['d_date_absence_eleve']).' to '.date_fr($data_sans_motif['a_date_absence_eleve']);
				?>
				<img src="../images/icons/coche_imp.png" style="width: 20px; height: 20px;" title="Impossible to remove <?php if($data_sans_motif['type_absence_eleve']=="A") { ?>absence<?php } if ($data_sans_motif['type_absence_eleve']=="R") { ?>The delay<?php } if ($data_sans_motif['type_absence_eleve']=="D") { ?>The exemption<?php } if ($data_sans_motif['type_absence_eleve']=="I") { ?>pass to infirmary<?php } ?> <?php echo $info_sup; ?>" border="0" alt="" />
				<input name="id_absence_eleve[<?php echo $total; ?>]" type="hidden" value="<?php echo $data_sans_motif['id_absence_eleve']; ?>" />
				<a href="#" onClick="alert('for remove, remove the date of  send  mail.'); return false;"><img src="../images/icons/delete_imp.png" style="width: 16px; height: 16px;" title="Impossible to remove <?php if($data_sans_motif['type_absence_eleve']=="A") { ?>l'absence<?php } if ($data_sans_motif['type_absence_eleve']=="R") { ?>delay<?php } if ($data_sans_motif['type_absence_eleve']=="D") { ?>exemption<?php } if ($data_sans_motif['type_absence_eleve']=="I") { ?>pass to infirmary<?php } ?> <?php echo $info_sup; ?>" border="0" alt="" /></a>
				<?php
				}
				?>
            	<a href="ajout_<?php if($data_sans_motif['type_absence_eleve']=="A") { ?>abs<?php } if ($data_sans_motif['type_absence_eleve']=="R") { ?>ret<?php } if($data_sans_motif['type_absence_eleve']=="I") { ?>inf<?php } if($data_sans_motif['type_absence_eleve']=="D") { ?>dip<?php } ?>.php?action=modifier&amp;type=<?php echo $type; ?>&amp;id=<?php echo $data_sans_motif['id_absence_eleve']; ?>&amp;mode=eleve"><img src="../../images/icons/saisie.png" style="width: 16px; height: 16px;" title="modify <?php if($data_sans_motif['type_absence_eleve']=="A") { ?>absence<?php } if ($data_sans_motif['type_absence_eleve']=="R") { ?>delay<?php } if ($data_sans_motif['type_absence_eleve']=="D") { ?>exemption<?php } if ($data_sans_motif['type_absence_eleve']=="I") { ?>pass to infirmary<?php } ?>" border="0" alt="" /></a>
            	<?php /* ajout classe eleve didier*/ ?>
               <a href="gestion_absences.php?select_fiche_eleve=<?php echo $data_sans_motif['login']; ?>" title="consult slip of student"><?php echo "<b>".strtoupper($data_sans_motif['nom'])."</b> ".ucfirst($data_sans_motif['prenom'])." (".$data_sans_motif['regime'].") (".classe_de($data_sans_motif['login'])." )"; ?></a>
            	</td>
            <td class="<?php echo $couleur_cellule; ?>">
		...
		<a href="javascript:CocheCheckbox(<?php echo $varcoche; ?>)">tick</a> | <a href="javascript:DecocheCheckbox(<?php echo $varcoche; ?>)">shoot</a>	<input name="date_ce_jour" type="hidden" value="<?php echo $date_ce_jour; ?>" /><input name="submit2" type="image" src="../../images/delete16.png" title="remove rapidly selection " style="border: 0px;" onClick="return confirm('are you sure to want remove...')" />
	    </td>
          </tr>
		  <tr><td>
    <?php
    ...
    <td style="text-align: center"><br />
          ...
          ?>
          Informations give for the date of<br /><b><?php echo date_frl($date_ce_jour); ?></b><br /><br />
          Classe &nbsp;
          <select name="classe_choix" onchange="javascript:document.form1.submit()">
          ...
          <?php if (getSettingValue("active_module_trombinoscopes")=='y')  { ?>
              <input type="checkbox" name="photo" value="avec_photo" id="avecphoto" onClick="javascript:document.form1.submit()"   <?php  if ($photo=="avec_photo") { ?>checked="checked"<?php } ?> /><label for="avecphoto" style="cursor: pointer;">with photo</label><br /><br />
          <?php } ?>
          for see, all the <?php if($type == "A") { ?>absences<?php } if($type == "R") { ?>delays<?php } if($type == "I") { ?>Infirmery<?php } if($type == "D") { ?>exemption<?php } ?> does not have a justificative, please tick the case  cocher la case below.<br />
            ...
            <label for="voirabssansjust" style="cursor: pointer;"><?php if($type == "A") { ?>Absence<?php } if($type == "R") { ?>delay<?php } if($type == "I") { ?>Infirmary<?php } if($type == "D") { ?>exemption<?php } ?> without justificative</label>
          </fieldset>
          </form>
    </td>
  </tr>
...
?>
         <table border="0" cellpadding="2" cellspacing="2" class="tableau_calque_information">
            <tr>
               <td class="texte_fondjaune_calque_information"><?php echo "<b>".$data_sans_motif['nom']."</b> ".$data_sans_motif['prenom']; ?> student of <?php echo "<b>".classe_de($data_sans_motif['login'])."</b>"; $id_classe_eleve = classe_de($data_sans_motif['login']); ?><br /><?php if ($data_sans_motif['type_absence_eleve']=="A") { ?> was absent <?php if ($data_sans_motif['sexe'] == "F") { ?>e<?php } } if  ($data_sans_motif['type_absence_eleve']=="R") { ?> est arrivé<?php if ($data_sans_motif['sexe'] == "F") { ?>e<?php } ?> en retard<?php } ?><?php if ($data_sans_motif['type_absence_eleve']=="I") { ?>going to infirmary<?php } ?><br /> the <?php echo date_frl($data_sans_motif['d_date_absence_eleve']); ?><?php if (($data_sans_motif['a_date_absence_eleve'] != $data_sans_motif['d_date_absence_eleve'] and $data_sans_motif['a_date_absence_eleve'] != "") or $data_sans_motif['a_date_absence_eleve'] == "0000-00-00") { ?> to <?php echo date_frl($data_sans_motif['a_date_absence_eleve']); ?><?php } ?><br /><?php if ($data_sans_motif['a_heure_absence_eleve'] == "" or $data_sans_motif['a_heure_absence_eleve'] == "00:00:00") { ?>at <?php } else { ?>of <?php } ?><?php echo heure($data_sans_motif['d_heure_absence_eleve']); ?> <?php if ($data_sans_motif['a_heure_absence_eleve'] == "00:00:00" or $data_sans_motif['a_heure_absence_eleve'] == "") { } else { echo 'at '.heure($data_sans_motif['a_heure_absence_eleve']); } ?></td>
               <?php if (getSettingValue("active_module_trombinoscopes")=='y') {
                 echo "<td style=\"width: 60px; vertical-align: top\" rowspan=\"4\">";
                 $nom_photo = '';
                 $nom_photo = nom_photo($data_sans_motif['elenoet'],"eleves",2);
            ...
            <tr>
               <td class="norme_absence">for the reasons : <?php echo motif_de($data_sans_motif['motif_absence_eleve']); ?></td>
             </tr>
             <tr>
                <td class="norme_absence"><?php if ($data_sans_motif['justify_absence_eleve'] == "O") {?><span class="norme_absence_vert"><b>give for justification : </b>
										<?php } elseif($data_sans_motif['justify_absence_eleve'] == "T") { ?><span class="norme_absence_vert" style="color: orange;"><b>justification by phone : </b>
																						<?php } else { ?><span class="norme_absence_rouge"><b>doesnt give justification</b>
																							<?php }?></span></td>
             </tr>
             <tr>
                <td class="norme_absence"><?php if(!empty($data_sans_motif['info_justify_absence_eleve'])) { ?><blockquote><?php echo $data_sans_motif['info_justify_absence_eleve']; ?></blockquote><?php } ?></td>
             ...
             <tr class="texte_fondjaune_calque_information">
				...
				if ( !empty($info_responsable) )
				{
					...
					for ($i = 0 ; $i < $nbre ; $i++){
						if ($info_responsable[$i]['resp_legal'] == '1') {
							...
							if ( $info_responsable[$i]['tel_port'] != ''  ) {
								$telephone_port = '<br />Port.<img src="../images/attention.png" alt="Care number surcharge" title="Care number surcharge" border="0" height="14" width="14" /> '.present_tel($info_responsable[$i]['tel_port']);
							}
						}
					}
				}
				...
				if ( $telephone_pers != '' or $telephone_prof != '' or $telephone_port != '' ) { $telephone = 'phone responsible : '.$telephone; }
				else { $telephone = 'not phone number  available'; }
...
<table style="margin: auto; width: 800px; border: 0 0 0 0;">
  <tr style="vertical-align: top">
    ...
    <br />
     <form name ="form3" method="post" action="gestion_absences.php?choix=<?php echo $choix; ?>&amp;type=<?php echo $type; ?>&amp;date_ce_jour=<?php echo $date_ce_jour; ?>&amp;action_sql=supprimer_selection">
      <fieldset class="fieldset_efface">
        ...
        <tr>
		<?php /* modification affichage didier */ ?>
          <td colspan="2" class="titre_tableau_gestion" nowrap><b><?php if ($type=="A") { ?>Absences not justify <?php } ?><?php if ($type=="R") { ?>delay not justify<?php } ?><?php if ($type=="I") { ?>Infirmary without reasons<?php } ?><?php if ($type=="D") { ?>exemption not justify<?php } ?></b></td>
        </tr>
        <?php
         $total = 0;
         $i = 0;
        ...
        <?php // si pas de lettres envoyés  affiche  case à cocher et affiche icone suppression modif didier
            	...
            	if ( $cpt_lettre_absence_recus == 0 ) {
				?>
          	<input name="selection[<?php echo $total; ?>]" id="sel<?php echo $total; ?>" type="checkbox" value="1" <?php $varcoche = $varcoche."'sel".$total."',"; ?> <?php /* if((isset($selection[$total]) and $selection[$total]) == "1" OR $cocher == 1) { ?>checked="checked"<?php } */ ?> /><a href="ajout_<?php if($data_sans_motif['type_absence_eleve']=="A") { ?>abs<?php } if ($data_sans_motif['type_absence_eleve']=="R") { ?>ret<?php } if($data_sans_motif['type_absence_eleve']=="D") { ?>dip<?php } if($data_sans_motif['type_absence_eleve']=="I") { ?>inf<?php } ?>.php?action=supprimer&amp;type=<?php echo $type; ?>&amp;id=<?php echo $data_sans_motif['id_absence_eleve']; ?>&amp;date_ce_jour=<?php echo $date_ce_jour; ?>" onClick="return confirm('are you sure to want remove...')"><img src="../images/icons/delete.png" style="width: 16px; height: 16px;" title="remove absence" border="0" alt="" /></a>
            <?php
				}
				else // sinon impossible de supprimer absence didier
				{
				 $info_sup = 'of '.date_fr($data_sans_motif['d_date_absence_eleve']).'to '.date_fr($data_sans_motif['a_date_absence_eleve']);
				?><img src="../images/icons/coche_imp.png" style="width: 18px; height: 18px;" title="Impossible de supprimer <?php if($data_sans_motif['type_absence_eleve']=="A") { ?>absence<?php } if ($data_sans_motif['type_absence_eleve']=="R") { ?>delay<?php } if ($data_sans_motif['type_absence_eleve']=="D") { ?>exemption<?php } if ($data_sans_motif['type_absence_eleve']=="I") { ?>passages in the infirmary<?php } ?> <?php echo $info_sup; ?>" border="0" alt="" />
				<input name="id_absence_eleve[<?php echo $total; ?>]" type="hidden" value="<?php echo $data_sans_motif['id_absence_eleve']; ?>" />
				<a href="#" onClick="alert('to remove, remove the date of send of mail.'); return false;"><img src="../images/icons/delete_imp.png" style="width: 16px; height: 16px;" title="Impossible to remove <?php if($data_sans_motif['type_absence_eleve']=="A") { ?>absence<?php } if ($data_sans_motif['type_absence_eleve']=="R") { ?>delay<?php } if ($data_sans_motif['type_absence_eleve']=="D") { ?>exemption<?php } if ($data_sans_motif['type_absence_eleve']=="I") { ?>passages in the infirmary<?php } ?> <?php echo $info_sup; ?>" border="0" alt="" /></a>
				<?php
				}
				?>
          	<input name="id_absence_eleve[<?php echo $total; ?>]" type="hidden" value="<?php echo $data_sans_motif['id_absence_eleve']; ?>" />
          	<a href="ajout_<?php if($data_sans_motif['type_absence_eleve']=="A") { ?>abs<?php } if($data_sans_motif['type_absence_eleve']=="D") { ?>exp<?php } if($data_sans_motif['type_absence_eleve']=="I") { ?>inf<?php } if ($data_sans_motif['type_absence_eleve']=="R") { ?>del<?php } ?>.php?action=modifier&amp;type=<?php echo $type; ?>&amp;id=<?php echo $data_sans_motif['id_absence_eleve']; ?>&amp;mode=eleve"><img src="../../images/icons/saisie.png" title="modifier l'absence" style="width: 16px; height: 16px;" border="0" alt="" /></a>
    ...
    <?php 	$total = $total + 1;
		...
		<?php $varcoche = $varcoche."'form3'"; ?>
		<a href="javascript:CocheCheckbox(<?php echo $varcoche; ?>)">tick</a> | <a href="javascript:DecocheCheckbox(<?php echo $varcoche; ?>)">shoot</a>	<input name="date_ce_jour" type="hidden" value="<?php echo $date_ce_jour; ?>" /><input name="submit2" type="image" src="../../images/delete16.png" title="supprimer la s&eacute;lection rapide" style="border: 0px;" onClick="return confirm('Etes-vous sur de vouloir le supprimer...')" />
	  </td>
        </tr>
		<tr><td>
		<?php
    ...
    <td style="text-align: center">
          ...
          Class
          <select name="classe_choix" onChange="javascript:document.form1.submit()">
            <option value="" selected onClick="javascript:document.form1.submit()">All class</option>
                <?php
                  $resultat_liste_classe = mysql_query($requete_liste_classe) or die('Erreur SQL !'.$requete_liste_classe.'<br />'.mysql_error());
                  while ( $data_liste_classe = mysql_fetch_array ($resultat_liste_classe)) {
                         if ($classe_choix==$data_liste_classe['id']) {$selected = "selected"; } else {$selected = ""; }?>
          ...
          <?php if (getSettingValue("active_module_trombinoscopes")=='y') { ?>
          <input type="checkbox" name="photo" id="avecphoto" value="avec_photo" onClick="javascript:document.form1.submit()" <?php  if ($photo=="avec_photo") { ?>checked="checked"<?php } ?> /><label for="avecphoto" style="cursor: pointer;">with photo</label><br /><br />
          <?php } ?>
          visualize by date, please shoot the case below.<br />
            <input type="checkbox" name="choix" id="voirabssansjust" value="sma" onClick="javascript:document.form1.submit()" <?php  if ($choix=="sma") { ?>checked="checked"<?php } ?> />
            <label for="voirabssansjust" style="cursor: pointer;"><?php if($type == "A") { ?>Absence<?php } if($type == "R") { ?>Retard<?php } if($type == "I") { ?>Infirmary<?php } if($type == "D") { ?>exemption<?php } ?> without justification</label>
           </fieldset>
          </form>
    </td>
  </tr>
...
<?php
			 echo "<b>".$data_avec_motif['nom']."</b> ".$data_avec_motif['prenom']; ?> sthdent of <?php echo "<b>".classe_de($data_avec_motif['login'])."</b>";
			 $id_classe_eleve = classe_de($data_avec_motif['login']); ?>
			 <br />
			 <?php //ajout creneau horaire dans div didier ?>
			 <?php if ($data_avec_motif['type_absence_eleve']=="A") { ?> was  absent<?php if ($data_avec_motif['sexe'] == "F") { ?>e<?php } }
      			 if  ($data_avec_motif['type_absence_eleve']=="R") { ?> become<?php if ($data_avec_motif['sexe'] == "F") { ?>e<?php } ?> delay<?php } ?>
				 <?php if ($data_avec_motif['type_absence_eleve']=="I") { ?>was going to infirmary<?php } ?>
				 <br />
				 the <?php echo date_frl($data_avec_motif['d_date_absence_eleve']); ?>
				 ...
				 <br />
				 <?php if ($data_avec_motif['a_heure_absence_eleve'] == "" or $data_avec_motif['a_heure_absence_eleve'] == "00:00:00") { ?>à <?php } else { ?>de <?php } ?><?php echo hour($data_avec_motif['d_heure_absence_eleve']); ?> <?php if ($data_avec_motif['a_heure_absence_eleve'] == "00:00:00" or $data_avec_motif['a_heure_absence_eleve'] == "") { } else { echo 'à '.hour($data_avec_motif['a_heure_absence_eleve']); } ?></td>
...
<?php
				if (getSettingValue("active_module_trombinoscopes")=='y') {
					echo "<td style=\"width: 60px; vertical-align: top\" rowspan=\"4\">";
					$nom_photo = '';
					$nom_photo = nom_photo($data_avec_motif['elenoet'],"student",2);
          			//$photos = "../../photos/eleves/".$nom_photo;
          			$photos = $nom_photo;
...
?>
			...
			<tr>
				<td class="norme_absence">for reasons : <?php echo motif_de($data_avec_motif['motif_absence_eleve']); ?></td>
			</tr>
			<tr>
				<td class="norme_absence"><?php if ($data_avec_motif['justify_absence_eleve'] == "O") {?><span class="norme_absence_vert"><b>give for justification : </b>
									<?php } elseif($data_avec_motif['justify_absence_eleve'] == "T") { ?><span class="norme_absence_vert" style="color: orange;"><b>justify by phone</b>
																							<?php }else { ?><span class="norme_absence_rouge"><b>doesnt give justification</b>
																							<?php } ?></span></td>
			</tr>
			<tr>
			...
			<tr class="texte_fondjaune_calque_information">
				...
				if ( !empty($info_responsable) )
				{
					...
					for ($i = 0 ; $i < $nbre ; $i++){
						if ($info_responsable[$i]['resp_legal'] == '1') {
							...
							if ( $info_responsable[$i]['tel_port'] != ''  ) {
								$telephone_port = '<br />Port.<img src="../images/attention.png" alt="care number surchage" title="care number surchage" border="0" height="14" width="14" /> '.present_tel($info_responsable[$i]['tel_port']);
							}
						}
					}
				}
				...
				if ( $telephone_pers != '' or $telephone_prof != '' or $telephone_port != '' ) { $telephone = 'phone principal : '.$telephone; }
				else { $telephone = 'no phone number available'; }
  ...
  <form name ="form3" method="post" action="gestion_absences.php?choix=<?php echo $choix; ?>&amp;date_ce_jour=<?php echo $date_ce_jour; ?>&amp;type=<?php echo $type; ?>&amp;action_sql=supprimer_selection">
   <fieldset class="fieldset_efface">
    <table class="td_tableau_gestion"  style="width: 600px;margin:auto;margin-top:15px; ">
        <tr>
		<?php /* modification affichage didier */ ?>
          <td colspan="2" class="titre_tableau_gestion" nowrap><b><?php if ($type=="A") { ?>Absent justify<?php } ?><?php if ($type=="R") { ?>delay justify<?php } ?><?php if ($type=="I") { ?>Infirmary with reason<?php } ?><?php if ($type=="D") { ?>exemption  justify<?php } ?></b></td>
        </tr>
<?php
		$total = 0;
		$i = 0;
	...
	<tr>
		...
		<?php
            	...
            	if ( $cpt_lettre_absence_recus != 0 )
            	{
					...
					$info_sup = 'of '.date_fr($data_avec_motif['d_date_absence_eleve']).' to '.date_fr($data_avec_motif['a_date_absence_eleve']);
					?><a href="#" onClick="alert('for remove, sremove the send date of mail.'); return false;"><img src="../images/icons/delete_imp.png" style="width: 16px; height: 16px;" title="Impossible to remove <?php if($data_avec_motif['type_absence_eleve']=="A") { ?>absence<?php } if ($data_avec_motif['type_absence_eleve']=="R") { ?>delay<?php } if ($data_avec_motif['type_absence_eleve']=="D") { ?>exemption<?php } if ($data_avec_motif['type_absence_eleve']=="I") { ?>passage in the infirmary<?php } ?> <?php echo $info_sup; ?>" border="0" alt="" /></a><?php

				}
				else
				{

            		?><a href="ajout_<?php if($data_avec_motif['type_absence_eleve']=="A") { ?>abs<?php } if ($data_avec_motif['type_absence_eleve']=="R") { ?>del<?php } if ($data_avec_motif['type_absence_eleve']=="D") { ?>exe<?php } if ($data_avec_motif['type_absence_eleve']=="I") { ?>inf<?php } ?>.php?action=supprimer&amp;type=<?php echo $type; ?>&amp;id=<?php echo $data_avec_motif['id_absence_eleve']; ?>&amp;date_ce_jour=<?php echo $date_ce_jour; ?>" <?php $info_sup = 'du '.date_fr($data_avec_motif['d_date_absence_eleve']).' au '.date_fr($data_avec_motif['a_date_absence_eleve']); ?>onClick="return confirm('are you sure to want remove <?php if($data_avec_motif['type_absence_eleve']=="A") { ?>absent<?php } if ($data_avec_motif['type_absence_eleve']=="R") { ?>delay<?php } if ($data_avec_motif['type_absence_eleve']=="D") { ?>exemption<?php } if ($data_avec_motif['type_absence_eleve']=="I") { ?>passage in the infirmary<?php } ?> <?php echo $info_sup; ?>.')"><img src="../../images/icons/delete.png" style="width: 16px; height: 16px;" title="remove <?php if($data_avec_motif['type_absence_eleve']=="A") { ?>absence<?php } if ($data_avec_motif['type_absence_eleve']=="R") { ?>delay<?php } if ($data_avec_motif['type_absence_eleve']=="D") { ?>exemption<?php } if ($data_avec_motif['type_absence_eleve']=="I") { ?>passage in the infirmary<?php } ?> <?php echo $info_sup; ?>" border="0" alt="" /></a><?php


				} ?>

		<a href="ajout_<?php if($data_avec_motif['type_absence_eleve']=="A") { ?>abs<?php } if($data_avec_motif['type_absence_eleve']=="D") { ?>dip<?php } if($data_avec_motif['type_absence_eleve']=="I") { ?>inf<?php } if ($data_avec_motif['type_absence_eleve']=="R") { ?>del<?php } ?>.php?action=modifier&amp;type=<?php echo $type; ?>&amp;id=<?php echo $data_avec_motif['id_absence_eleve']; ?>&amp;mode=eleve"><img src="../../images/icons/saisie.png" style="width: 16px; height: 16px;" title="remove <?php if($data_avec_motif['type_absence_eleve']=="A") { ?>absent<?php } if ($data_avec_motif['type_absence_eleve']=="R") { ?>delay<?php } if ($data_avec_motif['type_absence_eleve']=="D") { ?>exemption<?php } if ($data_avec_motif['type_absence_eleve']=="I") { ?>passage in the infirmary <?php } ?>" border="0" alt="" /></a>
...
?>
    ...
    <td style="text-align: center"><br />
        <form name ="form1" method="post" action="gestion_absences.php?choix=<?php echo $choix; ?>&amp;type=<?php echo $type; ?>">
          <fieldset style="background-color: #D1EFE8; background-image: url(../images/2.png); ">
            <legend class="legend_texte">&nbsp;Selectioned</legend>
            <?php //Affiche le calendrier
                minicals($year, $month, $day, $classe_choix, $type, 'gestion_absences');
            ?>
            Informations give for the date of<br /><b><?php echo date_frl($date_ce_jour); ?></b><br /><br />
            ...
            <?php if (getSettingValue("active_module_trombinoscopes")=='y') { ?>
            <input type="checkbox" name="photo" id="avecphoto" value="avec_photo" onClick="javascript:document.form1.submit()" <?php  if ($photo=="avec_photo") { ?>checked="checked"<?php } ?> /><label for="avecphoto" style="cursor: pointer;">with photo</label><br />
            <?php } ?>
          </fieldset>
        </form>
    </td>
