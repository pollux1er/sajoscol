...
//**************** EN-TETE *****************
$titre_page = "Selection of one or more student";
...
?>
<p class="bold"><a href='<?php echo $retour; ?>'><img src="../../images/icons/back.png" alt="Return" title="Return" class="back_link" /> Return</a>
</p>
...
<div style="text-align:center">
  <table class="entete_tableau_selection" border="0" cellspacing="0" cellpadding="2">
    <tr>
      ...
      <?php if($type == "A") { ?>Absence of one or more students<?php }
       if($type == "D") { ?>Exemption of a student (s)<?php }
       if($type == "R") { ?>Delays of one or more student (s)<?php }
       if($type == "I") { ?>Nursing a student (s)<?php } ?>
       </b></td>
    </tr>
    <tr>
        ...
        <form name="form1" method="post" action="select.php?type=<?php echo $type; ?>">
         <fieldset class="fieldset_efface" style="width: 450px;">
            ...
            <select name="classe_choix" onchange="javascript:document.form1.submit();"> <?php /* correction pour ie didier  */ ?>
            	<option value="tous" selected="selected" onclick="javascript:document.form1.submit()">All Classes</option>
			<?php
      ...
      <?php if($type == "A" OR $type == "R") { ?>
         <span class="norme_absence_bleu">* To select multiple students: CTRL key to select individual students by clicking on it.</span><br /><br />
      <?php } ?>
      <?php if($type == "A") { ?>
         <span class="norme_absence_bleu">* If no student is selected, the entire class is selected.</span><br /><br />
      <?php } ?>
      </td>
      <td class="td_tableau_selection">
	<form method="post" action="<?php echo $page; ?>.php?action=ajouter&amp;type=<?php echo $type; ?>" name="form2">
         ...
         <p><input type="submit" name="submit" value="validate your selection" /></p>
        </form>
      </td>
    </tr>
  </table>
