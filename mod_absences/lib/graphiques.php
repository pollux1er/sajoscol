...
?>
<p class=bold>|<a href='../gestion/gestion_absences.php'>Return</a>|
</p>
    ...
    <form method="post" action="" name="form1">
      <fieldset style="width: 400px; margin: auto;">
        <legend class="legend_texte">&nbsp;Find&nbsp;</legend>
          <div style="text-align:left">[ <?php if($recherche=="cacher" or $recherche=="") { ?><a href="graphiques.php?recherche=afficher">afficher</a><?php } if($recherche=="afficher") { ?><a href="graphiques.php?recherche=cacher">hide</a><?php } ?> ]<br />
        <?php if ($recherche == "afficher") { ?>
             Type
               <select name="type" id="type">
                  <option value="A" <?php if ($type == "A") {?>selected<?php } ?>>Absence</option>
                  <option value="R" <?php if ($type == "R") {?>selected<?php } ?>>Delay</option>
                  <option value="D" <?php if ($type == "D") {?>selected<?php } ?>>Exemption</option>
                  <option value="I" <?php if ($type == "I") {?>selected<?php } ?>>Infirmary</option>
               </select><br />
           Class
              <select name="classe_choix" id="classe_choix">
                 <option value="tous" <?php if (empty($classe_choix)) {?>selected<?php } ?>>All</option>
                    <?php
