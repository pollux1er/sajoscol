...
//**************** EN-TETE *****************
$titre_page = "Management of the absences";
...
$cal_1 = new Calendrier("form1", "of");
$cal_2 = new Calendrier("form1", "to");
...
if( $pagedarriver === 'gestion_absences') {
	echo "<p class='bold'> <a href=\"../gestion/gestion_absences.php\"><img src='../../images/icons/back.png' alt='Retour' class='back_link'/> Return</a></p>";
}elseif( $pagedarriver === 'prof_ajout_abs') {
	echo "<p class='bold'> <a href=\"../professeurs/prof_ajout_abs.php\"><img src='../../images/icons/back.png' alt='Retour' class='back_link'/> Return</a></p>";
}
...
<div style="text-align:center">
	<form method="post" action="" name="form1">
		<fieldset style="width: 400px; margin: auto;">
			<legend class="legend_texte">&nbsp;Find&nbsp;</legend>

          	<div style="text-align:left">[ <?php if($recherche=="cacher" or $recherche=="") { ?>
				<a href="tableau.php?recherche=afficher&amp;pagedarriver=<?php echo $pagedarriver; ?>">Display</a><?php } if($recherche=="afficher") { ?>
				<a href="tableau.php?recherche=cacher&amp;pagedarriver=<?php echo $pagedarriver; ?>">hide</a><?php } ?> ]
				<br />
    ...
    <?php if ($recherche == "afficher") { ?>
				...
				<select name="type" id="type">
					...
					<option value="R" <?php if ($type == "R") {?>selected="selected"<?php } ?>>Delay</option>
					<option value="D" <?php if ($type == "D") {?>selected="selected"<?php } ?>>Exemption</option>
					<option value="I" <?php if ($type == "I") {?>selected="selected"<?php } ?>>Infirmary</option>
				</select>
				Justified <input name="justifie" type="checkbox" id="justifie3" value="1" <?php if ($justifie == "1") {?>checked="checked"<?php } ?> />
				Not justified <input name="nonjustifie" type="checkbox" id="nonjustifie" value="1" <?php if ($nonjustifie == "1") {?>checked="checked"<?php } ?> /><br />

    <?php if($type == "A" OR $type == "R") { ?>

				Reason
             	<select name="motif" id="motif">
                 	<option value="tous" <?php if (empty($motif)) {?>selected="selected"<?php } ?>>all</option>
	...
	<?php } ?>
				...
				<select name="classe_choix" id="classe_choix">
					<option value="tous" <?php if (empty($classe_choix)) {?>selected="selected"<?php } ?>>All</option>
    <?php
	...
	<?php if($classe_choix != "tous") { ?>
			<br />
            	...
            	<select name="eleve_choix" id="eleve_choix" style="width: 25em;">
					<option value="tous" <?php if (empty($eleve_choix)) {?>selected<?php } ?>>All</option>
	<?php
...
<div class="centre"><span class="norme_absence_bleu">passage with the mouse on the NAME makes it possible to post the card of the student</span></div>
 ...
 ?>
	<div id="d<?php echo $data_div['id_absence_eleve']; ?>" style="position: absolute; z-index: 20; visibility: hidden; top: 0px; left: 0px;">
		<table border="0" cellpadding="2" cellspacing="2" class="tableau_calque_information">
			<tr>
				<td class="texte_fondjaune_calque_information"><?php echo "<b>".strtoupper($data_div['nom'])."</b> ".ucfirst($data_div['prenom']); ?> student of <?php echo "<b>".classe_de($data_div['login'])."</b>"; $id_classe_eleve = classe_de($data_div['login']); ?> was absent<?php if ($data_div['sexe'] == "F") { ?>e<?php } ?><br />the <?php echo date_frl($data_div['d_date_absence_eleve']); ?><?php if (($data_div['a_date_absence_eleve'] != $data_div['d_date_absence_eleve'] and $data_div['a_date_absence_eleve'] != "") or $data_div['a_date_absence_eleve'] == "0000-00-00") { ?> to <?php echo date_frl($data_div['a_date_absence_eleve']); ?><?php } ?><br /><?php if ($data_div['a_heure_absence_eleve'] == "00:00:00" or $data_div['a_heure_absence_eleve'] == "") { ?>at <?php } else { ?>of <?php } ?><?php echo hour($data_div['d_heure_absence_eleve']); ?> <?php if ($data_div['a_heure_absence_eleve'] == "00:00:00" or $data_div['a_heure_absence_eleve'] == "") { } else { ?> à <?php ?> <?php echo hour($data_div['a_heure_absence_eleve']); } ?></td>
				<?php
				...
				if ( $telephone_pers != '' or $telephone_prof != '' or $telephone_port != '' ) {
					$telephone = 'Responsible phone : '.$telephone;
				} else {
					$telephone = 'No phone number available';
				}
...
<?/* Ajout d'une possibilité de tri sur les colonnes en mode afficher  didier*/ ?>
      <td rowspan="2" class="norme_absence_blanc"><?php if ($recherche == "afficher") { ?><a onClick="javascript:document.form1.tri.value='nom, prenom';document.form1.submit()">Nom Pr&eacute;nom</a><?php } else {echo 'Name First name';}?></td>
	  <td rowspan="2" class="norme_absence_blanc"><?php if ($recherche == "afficher") { ?><a onClick="javascript:document.form1.tri.value='classe';document.form1.submit()">Classe</a><?php } else {echo 'Class';}?></td>
      ...
      <td colspan="2" class="norme_absence_blanc"><?php if ($recherche == "afficher") { ?><a onClick="javascript:document.form1.tri.value='d_heure_absence_eleve';document.form1.submit()">Heure</a><?php } else {echo 'Hour';}?></td>
	  <td rowspan="2" class="norme_absence_blanc"><?php if ($recherche == "afficher") { ?><a onClick="javascript:document.form1.tri.value='motif_absence_eleve';document.form1.submit()">Motif</a><?php } else {echo 'Reason';}?></td>
    </tr>
    <tr class="fond_vert">
   ...
   <div id="d<?php echo $data_div['id_absence_eleve']; ?>" style="position: absolute; z-index: 20; visibility: hidden; top: 0px; left: 0px;">
		<table border="0" cellpadding="2" cellspacing="2" class="tableau_calque_information">
		 ...
		 $valeur=redimensionne_image($photo);
			...
			<tr>
				<td class="norme_absence">For the reason : <?php echo motab($data_div['motif_absence_eleve']); ?></td>
			</tr>
			<tr>
				<td class="norme_absence"><?php if ($data_div['justify_absence_eleve'] == "O") {?><span class="norme_absence_vert"><b> gave for justification : </b>
			   <?php } elseif($data_div['justify_absence_eleve'] == "T") { ?><span class="norme_absence_vert" style="color: orange;"><b> justified by phone </b>
			   																	<?php } else { ?><span class="norme_absence_rouge"><b>Justification did not give</b>
			   <?php } ?></span></td>
			</tr>
			<tr>
				<td class="norme_absence"><?php if(!empty($data_div['info_justify_absence_eleve'])) { ?><blockquote><?php echo $data_div['info_justify_absence_eleve']; ?></blockquote><?php } ?></td>
			...
			<tr class="texte_fondjaune_calque_information">
				...
				if ( $telephone_pers != '' or $telephone_prof != '' or $telephone_port != '' ) { $telephone = 'Responsible phone: '.$telephone; }
...
<div style="text-align:center">
  <table style="margin: auto; width: 600px;" border="0" cellspacing="2" cellpadding="0">
	...
	<?php /* ajout possibilité de tri sur colonnes en mode afficher didier */?>
      <td class="norme_absence_blanc"><?php if ($recherche == "afficher") { ?><a onClick="javascript:document.form1.tri.value='nom, prenom';document.form1.submit()">Name First name</a><?php } else {echo 'Name First name';}?></td>
      <td class="norme_absence_blanc"><?php if ($recherche == "afficher") { ?><a onClick="javascript:document.form1.tri.value='classe';document.form1.submit()">Class</a><?php } else {echo 'Le';}?></td>
	  <td class="norme_absence_blanc"><?php if ($recherche == "afficher") { ?><a onClick="javascript:document.form1.tri.value='d_date_absence_eleve';document.form1.submit()">the</a><?php } else {echo 'the';}?></td>
      <td class="norme_absence_blanc"><?php if ($recherche == "afficher") { ?><a onClick="javascript:document.form1.tri.value='d_heure_absence_eleve';document.form1.submit()">at</a><?php } else {echo 'At';}?></td>
    ...
    ?>
    <tr class="<?php echo $couleur_cellule; ?>" onmouseover="window.status='See this entry'; showdiv(event, 'd<?php echo $data_recherche['id_absence_eleve']; ?>'); return true;" onmouseout="hidediv('d<?php echo $data_recherche['id_absence_eleve']; ?>'); return true;">
      <td class="norme_absence"><?php echo "<b>".strtoupper($data_recherche['nom'])."</b><br />".ucfirst($data_recherche['prenom']); ?></td>
...
?>
   <div id="d<?php echo $data_div['id_absence_eleve']; ?>" style="position: absolute; z-index: 20; visibility: hidden; top: 0px; left: 0px;">
       <table border="0" cellpadding="2" cellspacing="2" class="tableau_calque_information">
            <tr>
              <td class="texte_fondjaune_calque_information"><?php echo "<b>".strtoupper($data_div['nom'])."</b> ".ucfirst($data_div['prenom']); ?> élève de <?php echo "<b>".classe_de($data_div['login'])."</b>"; $id_classe_eleve = classe_de($data_div['login']); ?> est dispensé<?php if ($data_div['sexe'] == "F") { ?>e<?php } ?><br /> of <?php echo date_frl($data_div['d_date_absence_eleve']); ?> to <?php echo date_frl($data_div['a_date_absence_eleve']); ?><br />more information : <?php echo $data_div['info_absence_eleve']; ?></td>
           </tr>
            <tr>
              <td class="norme_absence">For the reason: <?php echo motab($data_div['motif_absence_eleve']); ?></td>
            </tr>
            <tr>
              <td class="norme_absence"><?php if ($data_div['justify_absence_eleve'] != "O") {?><span class="norme_absence_rouge"><b>Justification did not give</b><?php } else { ?><span class="norme_absence_vert"><b>gave for justification: </b><?php } ?></span></td>
            </tr>
            <tr>
              <td class="norme_absence"><?php if(!empty($data_div['info_justify_absence_eleve'])) { ?><blockquote><?php echo $data_div['info_justify_absence_eleve']; ?></blockquote><?php } ?></td>
            </tr>
...
<div style="text-align:center">
  <table style="margin: auto; width: 600px;" border="0" cellspacing="2" cellpadding="0">
	...
	<?php /* modification nombre colonne pour ajout classe didier */ ?>
      <td colspan="5" class="titre_tableau_gestion" nowrap><b>Exemption</b></td>
    </tr>
    <tr class="fond_vert">
	<?php /* ajout possibilité de tri par colonne en mode afficher  et ajout colonne classe didier*/ ?>
      <td rowspan="2" class="norme_absence_blanc"><?php if ($recherche == "afficher") { ?><a onClick="javascript:document.form1.tri.value='nom, prenom';document.form1.submit()">Name First name</a><?php } else {echo 'Nom Pr&eacute;nom';}?></td>
	  <td rowspan="2" class="norme_absence_blanc"><?php if ($recherche == "afficher") { ?><a onClick="javascript:document.form1.tri.value='classe';document.form1.submit()">Class</a><?php } else {echo 'Class';}?></td>
      <td colspan="2" class="norme_absence_blanc"><?php if ($recherche == "afficher") { ?><a onClick="javascript:document.form1.tri.value='d_date_absence_eleve';document.form1.submit()">Date</a><?php } else {echo 'Date';}?></td>
      <td rowspan="2" class="norme_absence_blanc"><?php if ($recherche == "afficher") { ?><a onClick="javascript:document.form1.tri.value='info_absence_eleve';document.form1.submit()">Timetable</a><?php } else {echo 'Timetable';}?></td>
    </tr>
    <tr class="fond_vert">
      <td class="norme_absence_blanc">of</td>
      <td class="norme_absence_blanc">at</td>
    </tr>
    <?php
	$init = "";
	$init_v = "";
...
<?php
 ...
 ?>
   <div id="d<?php echo $data_div['id_absence_eleve']; ?>" style="position: absolute; z-index: 20; visibility: hidden; top: 0px; left: 0px;">
		<table border="0" cellpadding="2" cellspacing="2" class="tableau_calque_information">
			<tr>
				<td class="texte_fondjaune_calque_information"><?php echo "<b>".strtoupper($data_div['nom'])."</b> ".ucfirst($data_div['prenom']); ?> student of <?php echo "<b>".classe_de($data_div['login'])."</b>"; $id_classe_eleve = classe_de($data_div['login']); ?> went<?php if ($data_div['sexe'] == "F") { ?>e<?php } ?> with the infirmary<br />le <?php echo date_frl($data_div['d_date_absence_eleve']); ?><br />of <?php echo heure($data_div['d_heure_absence_eleve']); ?> at <?php echo heure($data_div['a_heure_absence_eleve']); ?></td>
				...
				if ( !empty($info_responsable) )
				{
					...
					for ($i = 0 ; $i < $nbre ; $i++){
						if ($info_responsable[$i]['resp_legal'] == '1') {
							...
							if ( $info_responsable[$i]['tel_port'] != ''  ) {
								$telephone_port = '<br />Port.<img src="../images/attention.png" alt="Surtaxed number care" title="Surtaxed number care" border="0" height="14" width="14" /> '.present_tel($info_responsable[$i]['tel_port']);
							}
						}
					}
...
<div style="text-align:center">
	<table style="margin: auto; width: 600px;" border="0" cellspacing="2" cellpadding="0">
		<tr>
		<?php /* modification nombre colonnes didier */ ?>
      <td colspan="5" class="titre_tableau_gestion" nowrap><b>Infirmary</b></td>
    </tr>
    <tr class="fond_vert">
	<?php /* ajout du tri par colonne en mode afficher didier */ ?>
      <td class="norme_absence_blanc centre"><?php if ($recherche == "afficher") { ?><a onClick="javascript:document.form1.tri.value='nom, prenom';document.form1.submit()">Name First name</a><?php } else {echo 'Name First name';}?></td>
	  <td class="norme_absence_blanc centre"><?php if ($recherche == "afficher") { ?><a onClick="javascript:document.form1.tri.value='classe';document.form1.submit()">Class</a><?php } else {echo 'Class';}?></td>
      ...
      <td class="norme_absence_blanc centre"><?php if ($recherche == "afficher") { ?><a onClick="javascript:document.form1.tri.value='d_heure_absence_eleve';document.form1.submit()">of</a><?php } else {echo 'of';}?></td>
      <td class="norme_absence_blanc centre"><?php if ($recherche == "afficher") { ?><a onClick="javascript:document.form1.tri.value='a_heure_absence_eleve';document.form1.submit()">at</a><?php } else {echo 'at';}?></td>
    </tr>
	<?php
	$init = "";
	$init_v = "";
