...
function dategl($jour, $mois, $annee)
  ...
  $tab_mois = array(1=>"January", "February", "March", "Avril", "May", "June", "July", "August", "September", "October", "November", "December");
  $tab_jour = array("Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday");
...
if ($var == "0000-00-00") {} else {
  ...
  $tab_mois = array('01'=>"January", '02'=>"February", '03'=>"March", '04'=>"April", '05'=>"May", '06'=>"June", '07'=>"July", '08'=>"August", '09'=>"September", '10'=>"October", '11'=>"November", '12'=>"December");
  $tab_jour = array("Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday");
  $tab_date = explode(',', $date);
  $jour = date("w", mktime(0, 0, 0, $tab_date[1], $tab_date[0], $tab_date[2]));
...
function date_frc($var)
  ...
  $var = explode("-",$var);
  $date = "$var[2],$var[1],$var[0]";
  $tab_mois = array('01'=>"Jan.", '02'=>"Feb.", '03'=>"Mar.", '04'=>"Apr.", '05'=>"May", '06'=>"June", '07'=>"July.", '08'=>"August", '09'=>"Sept.", '10'=>"Oct.", '11'=>"Nov.", '12'=>"Dec.");
  $tab_jour = array("Sun.", "Mon.", "Tue.", "wed.", "Thu.", "fri.", "Sat.");
  $tab_date = explode(',', $date);
  $jour = date("w", mktime(0, 0, 0, $tab_date[1], $tab_date[0], $tab_date[2]));
  if ($tab_date[0]=='01') {$tab_date[0]='1er';}
  if ($tab_date[0]=='02') {$tab_date[0]='2';}
...
function dateglvs($jour, $mois, $annee)
  {
  $date = "$jour,$mois,$annee";
  $tab_mois = array(1=>"January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December");
  $tab_jour = array("Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday");
  $tab_date = explode(',', $date);
...
function motab($motab)
{
   switch ($motab)
   {
      case "A": $motab = "no reason"; break;
      case "AS": $motab = "accident sport"; break;
      case "AT": $motab = "not present in reserve"; break;
      case "C": $motab = "on the court"; break;
      case "CF": $motab = "family suitabilities"; break;
      case "CO": $motab = "convocation office"; break;
      case "CS": $motab = "sporting competition"; break;
      case "DI": $motab = "exempt e.p.s."; break;
      case "ET": $motab = "error of employs time"; break;
      case "EX": $motab = "examination"; break;
      case "H": $motab = "Hospitalized"; break;
      case "JP": $motab = "justify by the main thing"; break;
      case "MA": $motab = "Disease"; break;
      case "OR": $motab = "to advise"; break;
      case "PR": $motab = "waking"; break;
      case "RC": $motab = "refusal from studies"; break;
      case "RE": $motab = "renvoye of the college"; break;
      case "RT": $motab = "present in reserve"; break;
      case "RV": $motab = "reference of the race"; break;
      case "SM": $motab = "refusal of justification"; break;
      case "SP": $motab = "teaching exit"; break;
      case "ST": $motab = "training course outside the college"; break;
      case "T": $motab = "phone"; break;
      case "TR": $motab = "transporter"; break;
      case "VM": $motab = "visit medical"; break;
      case "IN": $motab = "infirmary"; break;
      default;
   }
  return $motab;
}
...
function motab_c($motab_c)
{
   switch ($motab_c)
   {
      case "A": $motab_c = "none"; break;
      case "AS": $motab_c = "accident"; break;
      case "AT": $motab_c = "not in reserve"; break;
      case "C": $motab_c = "on the court"; break;
      case "CF": $motab_c = "suitabilities"; break;
      case "CO": $motab_c = "convocation"; break;
      case "CS": $motab_c = "competition"; break;
      case "DI": $motab_c = "exempt"; break;
      case "ET": $motab_c = "error of edit"; break;
      case "EX": $motab_c = "examination"; break;
      case "H": $motab_c = "hospital"; break;
      case "JP": $motab_c = "justify"; break;
      case "MA": $motab_c = "Disease"; break;
      case "OR": $motab_c = "to advise"; break;
      case "PR": $motab_c = "reveil"; break;
      case "RC": $motab_c = "refusal to come"; break;
      case "RE": $motab_c = "renvoye"; break;
      case "RT": $motab_c = "in reserve"; break;
      case "RV": $motab_c = "reference"; break;
      case "SM": $motab_c = "refusal to justify"; break;
      case "SP": $motab_c = "sorite pedagogic"; break;
      case "ST": $motab_c = "training course"; break;
      case "T": $motab_c = "phone"; break;
      case "TR": $motab_c = "transport"; break;
      case "VM": $motab_c = "medical examination"; break;
      case "IN": $motab_c = "infirmary"; break;
      default;
   }
  return $motab_c;
}
...
function aff_mois($mois) {
   $tab_mois = array('1'=>"January", '2'=>"February", '3'=>"March", '4'=>"April", '5'=>"May", '6'=>"June", '7'=>"July", '8'=>"August", '9'=>"September", '10'=>"October", '11'=>"November", '12'=>"December");
...
function tableau_annuel($id_eleve, $mois_debut, $nb_mois, $annee_select, $tableau_info_donnee)
 {
	...
	//entête
		echo '<tr>';
		  echo '<td class="td_calendrier_mois" style="background-color: #F0FFCF;">Month</td>';
		  // boucle des jours
	...
	?> <img src="../images/retard.png" style="width: 10px; height: 10px;" alt="" /> - Delay<?php
	?> <img src="../images/absenceretard.png" style="width: 10px; height: 10px;" alt="" /> - Absences and delay<?php
}
