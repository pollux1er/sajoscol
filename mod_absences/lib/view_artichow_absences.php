...
if($type_1=="A") { $tire_graph = "Absences over the 12 previous months"; }
if($type_1=="D") { $tire_graph = "Exemptions over the 12 previous months"; }
if($type_1=="I") { $tire_graph = "Passages to the infirmary over the 12 previous months"; }
if($type_1=="R") { $tire_graph = "Delays over the 12 previous months"; }
...
$plot->yAxis->title->set("number of absences");
