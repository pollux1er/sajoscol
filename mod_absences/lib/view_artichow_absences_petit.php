<?php
// $Id: view_artichow_absences_petit.php 1351 2008-01-13 14:42:34Z jjocal $
//
...
while($i<12)
  {
        ...
        $date_debut = $annee_select."-".$mois."-01";
         if($mois == "01") { $mois_aff[$i] = "jan. "; }
         if($mois == "02") { $mois_aff[$i] = "fév. "; }
         if($mois == "03") { $mois_aff[$i] = "mars "; }
         if($mois == "04") { $mois_aff[$i] = "avr. "; }
         if($mois == "05") { $mois_aff[$i] = "mai "; }
         if($mois == "06") { $mois_aff[$i] = "juin "; }
         if($mois == "07") { $mois_aff[$i] = "juil. "; }
         if($mois == "08") { $mois_aff[$i] = "août "; }
         if($mois == "09") { $mois_aff[$i] = "sep. "; }
         if($mois == "10") { $mois_aff[$i] = "oct. "; }
         if($mois == "11") { $mois_aff[$i] = "nov. "; }
         if($mois == "12") { $mois_aff[$i] = "déc. "; }
...
if($type_1=="A") { $tire_graph = "Absences over the 12 preceding month"; }
if($type_1=="D") { $tire_graph = "Exempt over the 12 preceding month"; }
if($type_1=="I") { $tire_graph = "Passage to the infirmary over the 12 preceding month"; }
if($type_1=="R") { $tire_graph = "Delay over the 12 preceding month"; }
