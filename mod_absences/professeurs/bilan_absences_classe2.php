...
// ======================== Traitement des données ======================== //
	...
	if ($id_classe == NULL) {
		trigger_error("Impossible to post information requested because the class is not
specified.", E_USER_ERROR);
	...
	$query_c = mysql_query($sql_c) OR trigger_error('Impossible to post the class.', E_USER_WARNING);
...
<p><a href="./bilan_absences_professeur.php"><img src="../../images/icons/back.png" alt="Revenir en arri&egrave;re" />&nbsp;RETURN</a></p>

	<form name="time" action="./bilan_absences_classe2.php" method="post">

<h3 class="gepi">Absences of the class of <span style="font-weight: bold;"><?php echo $aff_nom_classe; ?>&nbsp;</span>
of&nbsp;
