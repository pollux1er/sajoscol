...
<table summary="Mise en page du haut (d&eacute;sol&eacute;)">
	<tr>
		<td>
			<a href="prof_ajout_abs.php">Return</a>
		 </td>
		<td> - Beginning :
		</td>
		<td>
...
<p>Summary of absences by class.</p>
...
-->
	...
	<tr>
		<th style="border: 1px solid black; background-color: grey;">Classes</th>
		<th style="border: 1px solid black; background-color: grey; width: 300px;">Name First name</th>
		<th style="width: 500px; border: 1px solid black; background-color: grey;">Dates of absences</th>
	</tr>
...
<h5>Made impression it <?php echo date("d/m/Y - h:i"); ?>.</h5>
<?php
