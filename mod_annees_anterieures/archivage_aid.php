...
if (isset($_GET['action']) and ($_GET['action']=="supp_annee")) {
	...
	if (($res_suppr1) and ($res_suppr2) and ($res_suppr3) and ($res_suppr4)) {
		$msg = "The suppression of the data was correctly carried out.";
	} else {
		$msg = "One or more problems were encountered during the suppression.";
	}
...
$themessage  = 'Are you sure to want to remove all data AID concerning this year ?';
$themessage2  = 'Are you sure to want to remove all the data for this AID ?';
//**************** EN-TETE *****************
$titre_page = "Filing of AIDs";
...
if(!isset($annee_scolaire)){
	...
	if(mysql_num_rows($res_annee)==0){
		echo "<p>No year is still safeguarded.</p>\n";
	}
	else{
		echo "<p>Here the list of the safeguarded years :</p>\n";
		echo "<ul>\n";
		while($lig_annee=mysql_fetch_object($res_annee)){
			$annee_scolaire=$lig_annee->annee;
			echo "<li><b>Year $annee_scolaire</b> - <a href='".$_SERVER['PHP_SELF']."?action=supp_annee&amp;annee_supp=".$annee_scolaire.add_token_in_url()."'   onclick=\"return confirm_abandon (this, 'yes', '$themessage')\">Remove all the AIDs data filed for this year</a></li>\n";
		}
		echo "</ul>\n";
		echo "<p><br /></p>\n";

	}
	echo "<p>Under which name of year want you to safeguard the year?</p>\n";
	...
	echo "<p>Year&nbsp;: <input type='text' name='annee_scolaire' value='$default_annee' /></p>\n";

	echo "<center><input type=\"submit\" name='ok' value=\"Valider\" style=\"font-variant: small-caps;\" /></center>\n";
} else {
	echo "<div class='norme'><p class=bold><a href='archivage_aid.php'><img src='../images/icons/back.png' alt='Return' class='back_link'/> Return</a> | \n";
    ...
    if(!isset($confirmer)){
          ...
          - <a href='".$_SERVER['PHP_SELF']."?action=supp_AID&amp;annee_scolaire=".$annee_scolaire."&amp;annee_supp=".$annee_scolaire."&amp;type_aid_supp=".$lig_types_aid->id."'   onclick=\"return confirm_abandon (this, 'yes', '$themessage2')\">Remove all the filed data of this AID</a></li>";
			}

			echo "<p>Data were already safeguarded for the year $annee_scolaire. List safeguarded types of AIDs :<br /> $chaine_types_aid</ul><p>
      <b>ATTENTION :</b> if, at the following stage, you notch already filed types of AIDs, the data will be filed once again and will be added to the other
already filed data. If it acts many same types of AIDS, you are then likely to create
doubled blooms.</p>\n";
 			echo "<p>You can also carry out the suppression of AIDs filed</p>";
	...
	if(!isset($id_type)){
		...
		echo "<h2>Choice of the types of AIDs</h2>\n";

		echo "<p>Conservation of the dated for the school year: $annee_scolaire</p>\n";

		echo "<p>Choose the types of AIDs which you wish to file</p>";
		echo "<p>All <a href='javascript:modif_coche(true)'>tick</a> / <a href='javascript:modif_coche(false)'>shoot</a>.</p>";
		...
		if($nb_types==0){
			echo "<p>ERROR: It seems that no type of AID is yet defined.</p>\n";
			require("../lib/footer.inc.php");
			die();
		}
    ...
    echo "/>The results of filing are in general very long. Notch the box opposite
if you wish to post only the errors of filing.";
    echo "<p class='small'>(*) Types of AID for which the tools complementary related to the cards
projects were activated.</p>";
		...
		echo "</div>\n";
		if(count($id_type)==0){
			echo "<p>ERROR: You did not notch of type of AIDs.</p>\n";
			echo "</form>\n";
			require("../lib/footer.inc.php");
			die();
		}
    ...
    $tab1 = "<table class='table_annee_anterieure' border = \"1\">\n<tr><td><b>Id</b></td><td><b>Year</b></td><td><b>Name</b></td><td><b>Complete name</b></td><td><b>Note on</b></td><td><b>Type of note</b></td></tr>\n";
    $flag_tab1 = 0;
    while ($i < $nb_type) {
      ...
      if(!$res_insert1){
          $tab1 .= "<tr><td colspan=\"6\"><font color=\"red\">Error of recording for the request : ".$sql_archiv."</font></td></tr>";
          $flag_tab1 = 1;
			} else {
      ...
      if ($outils_complementaires == 'y') {
          $tab2 = "<table class='table_annee_anterieure' border = \"1\">\n<tr><td><b>Id AID</b></td><td><b>Year</b></td><td><b>Name</b></td><td><b>Standard identifier AID</b></td><td><b>Productions</b></td><td><b>Summary</b></td><td><b>Family</b></td><td><b>keys Words </b></td><td><b>Adress 1</b></td><td><b>Adress 1</b></td><td><b>Public recipient</b></td><td><b>Contacts</b></td><td><b>subject 1</b></td><td><b>subjects 2</b></td><td><b>Public card</b></td><td><b>display adress 1</b></td><td><b>Average of the notes</b></td><td><b>Max of the notes</b></td><td><b>Min of the notes</b></td><td><b>In construction</b></td><td><b>List responsible professors</b></td><td><b>List student</b></td><td><b>List responsible student</b></td></tr>\n";
      } else {
          $tab2 = "<table border = \"1\">\n<tr><td><b>Id AID</b></td><td><b>Year</b></td><td><b>Name</b></td><td><b>Standard identifier AID</b></td></tr>\n";
      }
      $flag_tab2 = 0;
      $tab3 = "<table class='table_annee_anterieure' border = \"1\">\n<tr><td><b>Id AID</b></td><td><b>student Id </b></td><td><b>Responsible student</b></td></tr>\n";
      $tab4 = "<table class='table_annee_anterieure' border = \"1\">\n<tr><td><b>student Id </b></td><td><b>Year</b></td><td><b>Class</b></td><td><b>Id AID</b></td><td><b>Number period</b></td><td><b>Appreciation</b></td><td><b>Note student</b></td><td><b>average classifies</b></td><td><b>Min class</b></td><td><b>Max class</b></td></tr>\n";
      $tab5 = "<table class='table_annee_anterieure' border = \"1\">\n<tr><td><b>student Id </b></td><td><b>Name</b></td><td><b>First name</b></td><td><b>date of birth</b></td></tr>\n";
      $flag_tab3 = 0;
      $flag_tab4 = 0;
      $flag_tab5 = 0;
      while ($j < $nb_aid) {
        ...
        // Sauvegarde dans l'archive
          ...
          if(!$res_insert2){
            if ($outils_complementaires == 'y')
              $tab2 .= "<tr><td colspan=\"24\"><font color=\"red\">Error of recording for the request : ".$sql_archiv."</font></td></tr>";
            else
              $tab2 .= "<tr><td colspan=\"4\"><font color=\"red\">Error of recording for the request : ".$sql_archiv."</font></td></tr>";
            $flag_tab2 = 1;
          ...
          while ($k < $nombre) {
            ...
            if(!$res_insert3){
                $tab3 .= "<tr><td colspan=\"3\"><font color=\"red\">Error of recording for the request : ".$sql_archiv."</font></td></tr>";
                $flag_tab3 = 1;
		  	    } else if ($log_error!='y') {
            ...
            while ($t < $nombre_app) {
              ...
              if(!$res_insert4){
                  $tab4 .= "<tr><td colspan=\"11\"><font color=\"red\">Error of recording for the request : ".$sql_archiv."</font></td></tr>";
                  $flag_tab4 = 1;
		  	      } else if ($log_error!='y') {
    ...
    $tab1 .= "</table>\n";
		...
		if(isset($deja_traitee_id_type)){
			echo "<h2>Already treated types of AIDs</h2><p>";
    ...
    // Fin du traitement
		...
		if($chaine!=""){
			echo "<h2>Types of AIDs remaining to treat</h2><p><b>".substr($chaine,2)."</b></p>\n";
		}
		if($temoin_encore_des_types>0){
/*			echo "<script type='text/javascript'>
			setTimeout('document.formulaire.submit();', 5000);
			</script>\n";*/
			echo "<center><input type=\"submit\" name='ok' value=\"Continue the treatment\" style=\"font-variant: small-caps;\" /></center>\n";
		}	else {
			echo "<h2>Finished treatment.</h2>\n";
		}
    echo "<hr />";
		$nom_type = sql_query1("select nom from aid_config where indice_aid = '".$id_type[0]."'");
    echo "<h2>Results of the treatment of the type of AID : $nom_type</h2>\n";


    echo "<h3>Recording of the type of AID";
    if ($flag_tab1 == 1)
        echo $tab1;
    else
        if ($log_error =='y')
            ...
            echo " : </h3>No new recording was carried out.";
    echo "<H3>Recording of new not yet filed pupils";
    if ($flag_tab5 == 1)
        echo $tab5;
    else
        if ($log_error =='y')
    ...
    echo "<H3>Recording of the AIDs/élèves bonds";
    if ($flag_tab3 == 1)
        echo $tab3;
    else
        if ($log_error =='y')
    ...
    echo "<H3>Recording of the appreciations, notes, min, max";
    if ($flag_tab4 == 1)
        echo $tab4;
    else
        if ($log_error =='y')
    ...
    if (isset($flag_port_folio)) {
      $tab_item .= "</table>\n";
      echo "<H3>Recording of the validated items";
      echo $tab_item;
    }
