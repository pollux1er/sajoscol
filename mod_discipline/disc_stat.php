...
//**************** EN-TETE *****************
$titre_page = "Discipline: Statistics";
...
if(!isset($is_posted)) {
	...
	echo "<p>Choose what do you wish to display &nbsp;:</p>\n";
	echo "<table class='boireaus' summary='Choice of postings'>\n";
	echo "<tr>\n";
	echo "<th>\n";
	echo "Nature<br />incidents\n";
	echo "<br />\n";
	echo "<a href='javascript:modif_case(\"nature\",true)'><img src='../images/enabled.png' width='15' height='15' alt='All tick' /></a>/\n";
	echo "<a href='javascript:modif_case(\"nature\",false)'><img src='../images/disabled.png' width='15' height='15' alt='All shoot' /></a>\n";
	echo "</th>\n";
	echo "<th>\n";
	echo "Measurements taken\n";
	echo "<br />\n";
	echo "<a href='javascript:modif_case(\"id_mesure\",true)'><img src='../images/enabled.png' width='15' height='15' alt='All tick' /></a>/\n";
	echo "<a href='javascript:modif_case(\"id_mesure\",false)'><img src='../images/disabled.png' width='15' height='15' alt='All shoot' /></a>\n";
	echo "</th>\n";
	echo "<th>\n";
	echo "Sanctions\n";
	echo "<br />\n";
	echo "<a href='javascript:modif_case(\"nature_sanction\",true)'><img src='../images/enabled.png' width='15' height='15' alt='All tickr' /></a>/\n";
	echo "<a href='javascript:modif_case(\"nature_sanction\",false)'><img src='../images/disabled.png' width='15' height='15' alt='All shoot' /></a>\n";
	echo "</th>\n";
	echo "</tr>\n";
	...
	echo "<td style='vertical-align:top; text-align: left;'>\n";
	echo "<input type='checkbox' name='nature_sanction[]' id='nature_sanction_$cpt' value='travail' /><label for='nature_sanction_$cpt'>Work</label><br />\n";
	$cpt++;
	echo "<input type='checkbox' name='nature_sanction[]' id='nature_sanction_$cpt' value='retenue' /><label for='nature_sanction_$cpt'>Reserve</label><br />\n";
	$cpt++;
	...
	echo "<p style='color:red;'>TO MAKE: Totality by classes...</p>\n";
	echo "<p style='color:red;'>TO MAKE: To be able to make tables month by month.</p>\n";
	echo "</div>\n";

	echo "<p>&nbsp;</p>\n";

	echo "<div style='border:1px solid black; padding: 1em;'>\n";
	echo "<p class='bold'>Signal ten &nbsp;:</p>\n";
	echo "<form enctype='multipart/form-data' action='".$_SERVER['PHP_SELF']."' method='post' name='formulaire'>\n";
	...
	echo "<p>Choose what you wish to display &nbsp;:</p>\n";

	echo "<p>the student \n";
	echo "<a href='javascript:topten_coche(true)'><img src='../images/enabled.png' width='15' height='15' alt='All tick' /></a>/\n";
	echo "<a href='javascript:topten_coche(false)'><img src='../images/disabled.png' width='15' height='15' alt='All shoot' /></a>\n";
	echo "<br />\n";
	echo "<input type='checkbox' name='topten_incidents' id='topten_incidents' value='y' /><label for='topten_incidents'>responsible of the greatest number of incidents,</label><br />\n";
	echo "<input type='checkbox' name='topten_sanctions' id='topten_sanctions' value='y' /><label for='topten_sanctions'>who have the most sanctions (<i>work, reserve, exclusion,...</i>),</label><br />\n";
	echo "<input type='checkbox' name='topten_retenues' id='topten_retenues' value='y' /><label for='topten_retenues'>who have the most reserves,</label><br />\n";
	echo "<input type='checkbox' name='topten_exclusions' id='topten_exclusions' value='y' /><label for='topten_exclusions'>who have the most exclusions.</label><br />\n";

	echo "To retain only them <input type='text' name='nb_ele' value='10' size='2' /> first.<br />\n";
...
elseif($mode=='totaux') {
	echo " | <a href='".$_SERVER['PHP_SELF']."'>Statistics</a>";
	echo "</p>\n";
	...
	echo "<tr>\n";
	echo "<th>Nature</th>\n";
	echo "<th>Number of incidents</th>\n";
	/*
	echo "<th>Classes</th>\n";
	*/
	echo "</tr>\n";
	...
	echo "<p class='bold'>Measurements taken&nbsp;:</p>\n";
	echo "<table class='boireaus' summary='Measurements taken'>\n";
	echo "<tr>\n";
	echo "<th>Mesure</th>\n";
	echo "<th>Number of measurements taken</th>\n";
	echo "</tr>\n";
	$alt=1;
	for($i=0;$i<count($id_mesure);$i++) {
		...
		$res=mysql_query($sql);
		if(mysql_num_rows($res)==0) {
			echo "<span style='color:red;'>Anomaly&nbsp;: Measure unknown</span>";
		}
		else {
			$lig=mysql_fetch_object($res);
			echo $lig->mesure;
	...
	echo "<tr>\n";
	echo "<th>Sanction</th>\n";
	echo "<th>Number of sanctions</th>\n";
	echo "</tr>\n";
	$alt=1;
	...
	for($i=0;$i<count($id_nature_sanction);$i++) {
		...
		$res=mysql_query($sql);
		if(mysql_num_rows($res)==0) {
			echo "<span style='color:red;'>Anomaly&nbsp;: Unknown sanction</span>";
		}
		else {
			$lig=mysql_fetch_object($res);
...
elseif($mode=='topten') {
	...
	if($date_debut_disc!="") {
		...
		if($date_debut_disc!="") {
			echo "of ".formate_date($date_debut_disc);
		}
	}
	...
	if($date_fin_disc!="") {
		...
		if($date_fin_disc!="") {
			echo " to ".formate_date($date_fin_disc);
		}
	}
	...
	$res=mysql_query($sql);
	if(mysql_num_rows($res)==0) {
		echo "<p>No incident with responsible pupil is recorded.</p>\n";
	}
	else {
		echo "<p>the $nb_ele responsible student of the greatest number of incidents&nbsp;:</p>\n";
		echo "<table class='boireaus' summary='Table of the instigators incidental'>\n";
		echo "<tr>\n";
		echo "<th>student</th>\n";
		echo "<th>Class</th>\n";
		echo "<th>Number of incidents</th>\n";
	...
	$res=mysql_query($sql);
	if(mysql_num_rows($res)==0) {
		echo "<p>None with student with sanction is recorded.</p>\n";
	}
	else {
		echo "<p>the $nb_ele student who have the most sanctions&nbsp;:</p>\n";
		echo "<table class='boireaus' summary='Table of sanctioned'>\n";
		echo "<tr>\n";
		echo "<th>student</th>\n";
		echo "<th>Class</th>\n";
		echo "<th>Number of sanctions</th>\n";
	...
	$res=mysql_query($sql);
	if(mysql_num_rows($res)==0) {
		echo "<p>No student with reserve is recorded.</p>\n";
	}
	else {
		echo "<p>the $nb_ele student who have the most reserves&nbsp;:</p>\n";
		echo "<table class='boireaus' summary='Table of sanctioned by reserves'>\n";
		echo "<tr>\n";
		echo "<th>student</th>\n";
		echo "<th>Class</th>\n";
		echo "<th>Number of reserves</th>\n";
		echo "</tr>\n";
		$alt=1;
		while($lig=mysql_fetch_object($res)) {
			$alt=$alt*(-1);
	...
	$res=mysql_query($sql);
	if(mysql_num_rows($res)==0) {
		echo "<p>No student with exclusion is recorded.</p>\n";
	}
	else {
		echo "<p>the $nb_ele student who have the most exclusions &nbsp;:</p>\n";
		echo "<table class='boireaus' summary='Table of sanctioned by exclusions'>\n";
		echo "<tr>\n";
		echo "<th>student</th>\n";
		echo "<th>Class</th>\n";
		echo "<th>Number of exclusions</th>\n";
		echo "</tr>\n";
		$alt=1;
		while($lig=mysql_fetch_object($res)) {
			$alt=$alt*(-1);
...
*/
	...
	// (</i>$mode</i>)
	echo "<p style='color:red;'>Value of unknown mode.</p>\n";
}
