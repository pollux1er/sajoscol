...
$accessibilite="y";
$titre_page = "Management of the module Disciplines";
$gepiPathJava="./..";
$post_reussi=FALSE;
$msg = '';
...
if ((isset($_POST['is_posted']))&&(isset($_POST['activer']))) {
	...
	if (!saveSetting("autorise_commentaires_mod_disc", $autorise_commentaires_mod_disc)) {
		$msg = "Error during the recording of the parameter activation/desactivation \"autorise_commentaires_mod_disc\" !";
	}
}
