...
//**************** EN-TETE *****************
$titre_page = "Discipline: EDT student";
...
echo "<p><a href=\"edt_eleve.php?ele_login=".$ele_login."&amp;sem=".$aff_precedent."\"> previous week .</a> - Emploi du temps de <strong>".p_nom($ele_login)."</strong>";
echo " (<em>";
$tmp_tab=get_class_from_ele_login($ele_login);
if(isset($tmp_tab['liste_nbsp'])) {echo $tmp_tab['liste_nbsp'];} else {echo "???";}
echo "</em>) - <a href=\"edt_eleve.php?ele_login=".$ele_login."&amp;sem=".$aff_suivant."\">following week .</a>";
echo ".</p>\n";
...
echo "<blockquote>\n";
echo "<p>This page is intended to determine the crenels without course for the
student.</p>\n";
echo "</blockquote>\n";
echo "<p><br /></p>\n";
