...
//**************** EN-TETE *****************
$titre_page = "Discipline: Incidents without protagonists";
...
echo "<p class='bold'><a href='index.php'><img src='../images/icons/back.png' alt='Return' class='back_link'/> Return to the index</a>\n";

if(($_SESSION['statut']=='administrateur')||
($_SESSION['statut']=='cpe')||
($_SESSION['statut']=='scolarite')) {
	echo " | <a href='traiter_incident.php'>Incidents with protagonists</a>\n";
}
	...
	*/
	...
	if(mysql_num_rows($res)==0) {
		...
		if($incidents_clos=="y") {
			...
			($heure_incident!="")||
			($nature_incident!="")||
			($protagoniste_incident!="")) {echo " with the selected criteria";}
			echo ".</p>\n";
		}
		else {
	...
	echo " /><label for='incidents_clos' style='cursor:pointer;'> Display the closed incidents</label></p>\n";
	...
	*/
	...
	while($lig=mysql_fetch_object($res)) {
		...
		if(mysql_num_rows($test)==0) {
			...
			if($lieu_incident!="") {$texte.="<br /><span style='font-size:x-small;'>Place&nbsp;:".$lieu_incident."</span>";}
...
echo "<p><em>NOTE&nbsp;:</em></p>\n";
echo "<blockquote>\n";
echo "<p>When an incident is closed, one cannot modify the incident any more, nor to seize/Modify sanction.</p>\n";
echo "</blockquote>\n";
echo "<p><br /></p>\n";
