...
if(!isset($date)) {
	...
	*/
	...
	(!preg_match("/^[0-9]*$/",$mois))||
	(!preg_match("/^[0-9]*$/",$jour))) {
		echo "<p style='color:red;'>The date '$date' is invalid.</p>\n";
	}
	else {
		...
		if(mysql_num_rows($res_sanction)>0) {
			...
			echo "<table class='boireaus' summary='Reserves of the day'>\n";
			echo "<tr>\n";
			echo "<th style='font-size:x-small;'>Hour</th>\n";
			echo "<th style='font-size:x-small;'>Duration</th>\n";
			echo "<th style='font-size:x-small;'>Place</th>\n";
			echo "<th style='font-size:x-small;'>student</th>\n";
			echo "</tr>\n";
			...
			echo "<p>No reserve is still seized<br />for this day (<em>$date</em>).</p>\n";
		}
	}
}
?>