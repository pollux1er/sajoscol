...
if(isset($form_id_sanction)) {
	...
	for($i=0;$i<count($form_id_sanction);$i++) {
		...
		if(!$res) {
			$msg.="ERROR at the time of the update of the statute of the sanction n°".$form_id_sanction[$i].".<br />\n";
		}
	}
}
...
//**************** EN-TETE *****************
$titre_page = "Discipline: List sanctions";
...
if(mysql_num_rows($res_sanction)>0) {
	echo "<p class='bold'>Reserves of the day&nbsp;: $jour_sanction</p>\n";
	echo "<blockquote>\n";
	...
	echo "<th>student</th>\n";
	echo "<th>Work</th>\n";
	echo "<th>Given by (Informant)</th>\n";
	echo "<th>Number of report</th>\n";
	echo "<th>Carried out</th>\n";
	echo "</tr>\n";
	$alt_b=1;
	$num=0;
...
if($cpt_sanctions==0) {
	echo "<p class='bold'>List sanctions for $jour_sanction</p>\n";
	echo "<blockquote>\n";
	echo "<p>No sanction this day&nbsp;: $jour_sanction</p>\n";
	echo "</blockquote>\n";
}
...
$res_sanction=mysql_query($sql);
if(mysql_num_rows($res_sanction)>0) {
	echo "<p class='bold'>Work to be returned for a date former to $jour_sanction</p>\n";
	echo "<blockquote>\n";
	echo "<table class='boireaus' border='1' summary='Work' style='margin:2px;'>\n";
	echo "<tr>\n";
	echo "<th>student</th>\n";
...
echo "<blockquote>\n";
echo "<p><b>When a reserve must be reprogrammed</b>, Click on the initial date of reserve and to inform the section
Management of a carryforward<br />\n";
echo "<p>When a work must be reprogrammed, the information as what the pupil did not carry out it at the date
envisaged is not stored.<br />A defect, you can add details on the incident or in comment in allotted
Work</p>\n";
echo "</blockquote>\n";
