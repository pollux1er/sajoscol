<?php
/*
 * $Id: categories.php 7799 2011-08-17 08:38:10Z dblanqui $
 *
...
?>
<div id='result'>
    <h3><font class='red'>Organization of natures of incidents of categories:</font></h3>
    <div id='wrap'>
    <div id='natures'>
        <form action='index.php?ctrl=categories&action=save' method='post' name='save' id='save'>
            <?php echo add_token_field();?>
            <fieldset>
                <legend class='legend'>Assignment : </legend>
                <h3>1. Select the incidents</h3>
                ...
                <select  name='categorie' >
                    ...
                    <option class='option' VALUE='<?php echo $categorie->id;  ?>'><?php echo $categorie->categorie;  ?></option>
                        <?php }?>
                    <option class='option' VALUE='default'>Remove the categories</option>
                </select><br />
                <h3>3. Update of the data</h3>
    ...
    <div id='categories'>
        <fieldset>
            <legend class='legend'>Categories of the incidents</legend>
