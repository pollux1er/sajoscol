...
<div id="result">
  <div id="wrap">
    <h3><font class="red">Evolutions of the incidents over the school year :</font> </h3>
        ...
        <ul  class="css-tabs"  id="menutabs">
            ...
            foreach ($incidents as $titre=>$incidents_titre) :?>
              <?php if($titre=='L\'Etablissement') {
                if($affichage_etab) : ?>
          <li><a href="#tab<?php echo $i;?>" name="<?php echo $titre;?>-onglet-01" title="Evolution of the incidents"><?php echo $titre;?></a></li>
                  <?php $i=$i+1;
                endif;
          ...
          <li><a href="#tab<?php echo $i;?>" name="<?php echo $titre;?>-onglet-01" title="Evolution of the incidents">
