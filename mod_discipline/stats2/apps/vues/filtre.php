...
?>
<div id="result">
    <h3 class="red">Choice of the filters for the data</h3>
    ...
    <div id="filtres">
        <form action="index.php?ctrl=bilans&action=filtrer&action_from=<?php echo $action_from;?>" method="post"
            ...
            <div id="filtre_categories">
                <fieldset>
                    <legend>Choice of the categories</legend>
            ...
            <div id="filtre_categories">
                <fieldset>
                    <legend>Choice of measurements taken</legend>
                    <div id="recherche_classe">
                            <?php $max=count($mesures);?>
                            <a href="javascript:modif_case('mesures',true,<?php echo $max; ?>)"><img src='../../images/enabled.png' width='15' height='15' alt='All tick' title='all tick' /></a>/
                            <a href="javascript:modif_case('mesures',false,<?php echo $max; ?>)"><img src='../../images/disabled.png' width='15' height='15' alt='All shoot' title='All shoot'/></a>
                            <br />
                                <?php
                                $cpt=0;
            ...
            <div id="filtre_categories">
                <fieldset>
                    <legend>Choice of the sanctions</legend>
                    <div id="recherche_classe">
                            <?php $max=count($sanctions)+3;?>
                            <a href="javascript:modif_case('sanctions',true,<?php echo $max; ?>)"><img src='../../images/enabled.png' width='15' height='15' alt='All shoot' title='All tick' /></a>/
                            <a href="javascript:modif_case('sanctions',false,<?php echo $max; ?>)"><img src='../../images/disabled.png' width='15' height='15' alt='ALL shoot' title='All shoot'/></a>
                            <br />
                                <?php $cpt=0;?>
                               <input type='checkbox' name='sanctions[]' id='sanctions_<?php echo $cpt;?>' value='travail' <?php if ($filtres_sanctions){if( in_array('travail', $filtres_sanctions)) echo "checked";} ?>/><label for='sanction_<?php echo $cpt;?>'>Work</label><br />
	                        <?php $cpt++;?>
	                       <input type='checkbox' name='sanctions[]' id='sanctions_<?php echo $cpt;?>' value='retenue' <?php if ($filtres_sanctions){if( in_array('retenue', $filtres_sanctions)) echo "checked";} ?>/><label for='sanction_<?php echo $cpt;?>'>Reserve</label><br />
	                      <?php $cpt++;?>
                ...
                <div id="filtre_categories">
                <fieldset>
                    <legend>Role in the incident</legend>
                    <div id="recherche_classe">
                            <?php $max=count($roles);?>
                            <a href="javascript:modif_case('roles',true,<?php echo $max; ?>)"><img src='../../images/enabled.png' width='15' height='15' alt='All tick' title='All tick' /></a>/
                            <a href="javascript:modif_case('roles',false,<?php echo $max; ?>)"><img src='../../images/disabled.png' width='15' height='15' alt='All shoot' title='All shoot'/></a>
                            <br />
                                <?php
                                $cpt=0;
