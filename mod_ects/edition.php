...
//**************** EN-TETE *****************
$titre_page = "Edition of documents ECTS";
...
parameter setting in the Management of the classes.</p>\n";
    ...
    echo "<p>Click on the class for which you wish to publish documents ECTS :</p>\n";
    echo "<br/><p><a href='edition.php?id_classe=all'>All classes</a></p>";
    ...
    echo "<p class=bold><a href=\"edition.php\"><img src='../images/icons/back.png' alt='Return' class='back_link'/> Return</a></p>";
    ...
    if ($id_classe == 'all') {
        ...
        if ($nb_annees == 0) {
            echo "<p>Caution! No credit ECTS is currently present in the tables of filing. Information of six-month periods 1 and 2 will miss thus.</p>";
        } else {
        ...
        if (mysql_num_rows($call_classe) == 0) {
            echo 'Error with the selection of the class. You have the rights well on
this class ?';
            die();
        } else {
            $Classe = ClassePeer::retrieveByPK($id_classe);

            echo '<h3>Class of '.$Classe->getNom().'</h3>';
            ...
            echo "<div>\n";
                ...
                echo "<label for='choix_edit_1' class='curseur_pointeur'>\n";
                    echo "To generate documents ECTS of all the pupils of the class\n";
                echo "</label>\n";
            echo "</div>\n";
            ...
            echo "<div>\n";
                ...
                echo "<label for='choix_edit_2' class='curseur_pointeur'>\n";
                    echo "To generate only documents ECTS of the pupil selected opposite: \n";
                echo "</label>\n";
    ...
    echo "<h3>Documents with générer</h3>";
    echo "<p>tick the documents which you wish to generate :</p>";
    echo "<div>\n";
    ...
    echo "<div>\n";
        ...
        echo "<label for='choix_releve' class='curseur_pointeur'>\n";
            echo "The statement of appropriations\n";
        echo "</label>\n";
    echo "</div>\n";
    echo "<div>\n";
        ...
        echo "<label for='choix_attestation' class='curseur_pointeur'>\n";
            echo "The certificate of followed course\n";
        echo "</label>\n";
    echo "</div>\n";
    echo "<div>\n";
