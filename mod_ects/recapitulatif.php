...
parameter setting in the Management of the classes.</p>\n";
        ...
        $nombre_classe = mysql_num_rows($call_classe);
        if ($nombre_classe == "0") {
            echo "You are not teaching in a class having right lesson opening with ECTS.";
        }
    }
...
parameter setting in the Management of the classes.</p>\n";
        ...
        $nombre_classe = mysql_num_rows($call_classe);
        if ($nombre_classe == "0") {
            echo "Either you are not teaching in this class, or this class does not open
right with ECTS.";
            die();
        }
    }
  ...
  echo "<h1 style='margin-top: 0px; margin-bottom: 0px;margin-left: 30px;'>Acquired appropriations ECTS - Class of ".$Classe->getNom()."</h1>";
  
  echo "<p style='margin-left: 30px;'>Display/mask per year : ";
  ...
  echo "<img src=\"../lib/create_im_mat.php?texte=".rawurlencode("Mention globale")."&amp;width=22\" WIDTH=\"22\" BORDER=\"0\" alt=\"Total mention\" />";
  echo "</td>";
  echo "</tr>\n";
