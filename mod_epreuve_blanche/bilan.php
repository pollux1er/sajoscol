...
//**************** EN-TETE *****************
$titre_page = "White test: Assessment";
...
echo "<p class='bold'><a href='index.php?id_epreuve=$id_epreuve&amp;mode=modif_epreuve'>Returnr</a>";
...
if(!isset($imprime)) {
	...
	echo "<p class='bold'>Bilan of the test&nbsp;:</p>\n";

	echo "<p>Choose information to be revealed in addition to the name/first name student
and note&nbsp;:</p>\n";
	echo "<blockquote>\n";
	echo "<input type='checkbox' name='avec_n_anonymat' id='avec_n_anonymat' value='y' /><label for='avec_n_anonymat'>Number anonymity</label><br />\n";
	echo "<input type='checkbox' name='avec_correcteur' id='avec_correcteur' value='y' /><label for='avec_correcteur'>Corrector</label><br />\n";
	echo "<input type='checkbox' name='avec_salle' id='avec_salle' value='y' /><label for='avec_salle'>Room</label>\n";
	...
	echo "<p><i>NOTES&nbsp;:</i></p>\n";
	echo "<ul>\n";
	echo "<li style='color:red;'>TO MAKE&nbsp;: Calculer widths in the pdf to control that that holds.<br />With long names, one could exceed.</li>\n";
	echo "</ul>\n";
}
