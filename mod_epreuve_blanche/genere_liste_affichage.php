...
secours='F',
autre='F',
description='White test: Generation lists affichage',
statut='';";
...
if(!isset($imprime)) {
	...
	if(mysql_num_rows($test1)!=mysql_num_rows($test2)) {
		echo "<p style='color:red;'>The numbers anonymities are not single on the test (<i>cela ne should not arrive</i>).</p>\n";
		require("../lib/footer.inc.php");
		die();
	}
	...
	echo "<li><b>CSV</b>&nbsp;:\n";
	 	echo "<ul>\n";
		echo "<li><a href='".$_SERVER['PHP_SELF']."?id_epreuve=$id_epreuve&amp;imprime=sans_num_anonymat&amp;mode=csv".add_token_in_url()."'>With the columns 'NAME;FIRST NAME;BIRTH;CLASS;ROOM'</a></li>\n";
		echo "<li><a href='".$_SERVER['PHP_SELF']."?id_epreuve=$id_epreuve&amp;imprime=avec_num_anonymat&amp;mode=csv".add_token_in_url()."'>With the columns 'NUM_ANONYMAT;NAME;FIRST NAME;BIRTH;CLASS;ROOM'</a></li>\n";
		echo "</ul>\n";
	echo "</li>\n";
	echo "<li><b>PDF</b>&nbsp;:\n";
	 	echo "<ul>\n";
		echo "<li><a href='".$_SERVER['PHP_SELF']."?id_epreuve=$id_epreuve&amp;imprime=sans_num_anonymat&amp;mode=pdf".add_token_in_url()."'>With columns 'NAME;FIRST NAME;BIRTH;CLASS;ROOM'</a></li>\n";
		echo "<li><a href='".$_SERVER['PHP_SELF']."?id_epreuve=$id_epreuve&amp;imprime=avec_num_anonymat&amp;mode=pdf".add_token_in_url()."'>With columns 'NUM_ANONYMAT;NAME;FIRST NAME;BIRTH;CLASS;ROOM'</a></li>\n";
		echo "</ul>\n";
	echo "</li>\n";
	echo "</ul>\n";
}
