...
secours='F',
autre='F',
description='Genesis of the classes: List future classes (call ajax)',
statut='';";
...
if((!isset($classe_fut))||(!isset($projet))) {
	...
	if($eff_ele_clas_fut>0) {
		...
		if($eff_ele_clas_fut<=8) {
			...
			echo "<table class='boireaus' summary='student of $classe_fut'>\n";
			echo "<tr>\n";
		...
		echo "<p>No student in <b>$classe_fut</b>.</p>\n";
	}
}
?>