...
secours='F',
autre='F',
description='Genesis of the classes: Selection of the newcomers/redoubling',
statut='';";
...
if((isset($projet))&&(isset($choix))&&(($choix=='Red')||($choix=='Arriv'))&&(isset($ele_login))) {
	...
	if($nb_err==0) {
		$msg="$nb_reg $choix recorded.";
	}
	else {
		$msg="ERREUR: $nb_err during the recording of $choix.";
	}
}

//**************** EN-TETE *****************
$titre_page = "Genesis classifies: Selection redoubling and newcomers";
...
if(!isset($choix)) {
	...
	echo "<p>student, redoubling or newcomers, must be registered in the table 'eleves' to be able to be taken into account in a project.</p>\n";
	echo "<ul>\n";
	echo "<li>\n";
	echo "<p><a href='../eleves/add_eleve.php?projet=$projet&amp;mode=multiple' target='_blank'>To seize newcomers</a>.</p>\n";
	echo "</li>\n";

	echo "<li>\n";
	echo "<p><a href='".$_SERVER['PHP_SELF']."?projet=$projet&amp;choix=Arriv'>Select newcomers</a> among those which you have just seized.</p>\n";
	echo "</li>\n";

	echo "<li>\n";
	echo "<p><a href='".$_SERVER['PHP_SELF']."?projet=$projet&amp;choix=Red'>Select redoubling</a> among the student registered in classes this year.</p>\n";
	echo "</li>\n";
	...
	if(mysql_num_rows($res)>0) {
		echo "<p>List red/arriv already seized &nbsp;:</p>\n";
		echo "<form method=\"post\" action=\"".$_SERVER['PHP_SELF']."\">\n";
		echo "<table class='boireaus' border='1' summary='Redoubling and newcomers'>\n";
		echo "<tr>\n";
		echo "<th>Student</th>\n";
		echo "<th>Statut</th>\n";
		echo "<th>\n";
		//echo "Supprimer\n";
		echo "<input type='submit' name='supprimer' value='Remove' />\n";
		echo "</th>\n";
		echo "</tr>\n";
		$alt=1;
...
elseif($choix=='Red') {
	...
	echo "<h3>Selection of redoubling</h3>\n";
	...
	if(!isset($id_classe)) {
		...
		// Ajouter des classes
		echo "<p>In which classes are redoubling them to register in the project '$projet'&nbsp;:\n";
		echo "</p>\n";
		...
		for($i=0;$i<count($id_classe);$i++) {
			...
			echo "<th>Student</th>\n";
			echo "<th>\n";
			echo "<a href=\"javascript:CocheClasse($i);changement();\"><img src='../images/enabled.png' width='15' height='15' alt='Tout cocher' /></a> / <a href=\"javascript:DecocheClasse($i);changement();\"><img src='../images/disabled.png' width='15' height='15' alt='All shoot' /></a>\n";
			echo "</th>\n";
			echo "</tr>\n";
...
elseif($choix=='Arriv') {
	echo " | <a href='".$_SERVER['PHP_SELF']."?projet=$projet'>Redoubling and newcomers</a>";
	echo "</p>\n";
	...
	echo "<h3>Selection of the newcomers</h3>\n";

	echo "<p class='bold'>student not affected in classes:</p>\n";

	echo "<table class='boireaus' summary='Choice of the student'>\n";
	echo "<tr>\n";
	echo "<th>Estudent</th>\n";
	echo "<th>\n";
	echo "<a href=\"javascript:CocheEleves();changement();\"><img src='../images/enabled.png' width='15' height='15' alt='All tick' /></a> / <a href=\"javascript:DecocheEleves();changement();\"><img src='../images/disabled.png' width='15' height='15' alt='All shoot' /></a>\n";
	echo "</th>\n";
	echo "</tr>\n";
