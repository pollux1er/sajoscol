...
secours='F',
autre='F',
description='Genesis of the classes: Choice of the classes',
statut='';";
...
if((isset($choix_classes))&&((isset($id_classe))||(isset($classes_futures)))) {
	...
	if($nb_err==0) {
		$msg="Regeneration of the list of the classes carried out: ";
		$msg.="$nb_reg1 current classes et $nb_reg2 recorded future classes.";
	}
	else {
		$msg="ERROR at the time of the regeneration of the list of the classes: ";
		$msg.="$nb_reg1 current classes and $nb_reg2 recorded future classes.";
	}
}

$themessage  = 'Information was modified. do you want to really leave without recording ?';
//**************** EN-TETE *****************
$titre_page = "Genesis classifies: Classes choice";
...
echo "<p>Add one or of the future classes&nbsp;:\n";
echo " <input type='text' name='classes_futures' value='$classes_futures' onchange=\"changement()\" /><br />\n";
echo "(<i>Seize several classes, put a comma enters the classes</i>)</p>\n";
