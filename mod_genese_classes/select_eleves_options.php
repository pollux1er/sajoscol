...
secours='F',
autre='F',
description='Genesis of the classes: Choice of the options of the student',
statut='';";
...
//**************** EN-TETE *****************
$titre_page = "Genesis classifies: Choice options student";
...
echo " onclick=\"return confirm_abandon (this, change, '$themessage')\"";
echo ">Refresh without recording</a></p>\n";
...
for($j=0;$j<count($id_classe_actuelle);$j++) {
	...
	*/
	...
	//==========================================
	echo "<tr>\n";
	echo "<th>Manpower &nbsp;: <span id='eff_tot_".$id_classe_actuelle[$j]."'>&nbsp;</span></th>\n";
	...
	*/
	...
	//==========================================
	echo "<tr>\n";
	echo "<th>Manpower &nbsp;: $eff_tot_classe</th>\n";
	...
	*/
	...
	for($i=0;$i<count($classe_fut);$i++) {
		echo "<th>\n";
		echo "<a href=\"javascript:modif_colonne('classe_fut_$i',$j,true);changement();\"><img src='../images/enabled.png' width='15' height='15' alt='Any coachman' /></a>";
		echo "</th>\n";
	}
	/*
	echo "<th>...</th>\n";
	...
	*/
	for($i=0;$i<count($lv1);$i++) {
		echo "<th>\n";
		echo "<a href=\"javascript:modif_colonne('lv1_$i',$j,true);changement();\"><img src='../images/enabled.png' width='15' height='15' alt='Any coachman' /></a>";
		echo "</th>\n";
	}
	for($i=0;$i<count($lv2);$i++) {
		echo "<th>\n";
		echo "<a href=\"javascript:modif_colonne('lv2_$i',$j,true);changement();\"><img src='../images/enabled.png' width='15' height='15' alt='Any coachman' /></a>";
		echo "</th>\n";
	}
	for($i=0;$i<count($lv3);$i++) {
		echo "<th>\n";
		echo "<a href=\"javascript:modif_colonne('lv3_$i',$j,true);changement();\"><img src='../images/enabled.png' width='15' height='15' alt='Any coachman' /></a>";
		echo "</th>\n";
	}
	for($i=0;$i<count($autre_opt);$i++) {
		echo "<th>\n";
		...
		echo " / <a href=\"javascript:modif_colonne('autre_opt_$i',$j,false);changement();\"><img src='../images/disabled.png' width='15' height='15' alt='All shoot' /></a>";
		echo "</th>\n";
	}
	echo "</tr>\n";
	//==========================================
...
echo "<div id='div_test_aff_classe2' class='infobulle_corps' style='position:absolute; border:1px solid black;'>Classes futures</div>\n";
	...
	$titre="Selection of the profile";
...
function calcule_effectif(champ,n) {
	...
	for(k=0;k<n;k++) {
		...
		if(champ=='classe_fut') {
			// It is necessary to recompute useful manpower if one would have
increased/reduced the manpower of Red/Dep
	...
	*/
	...
	for(i=i1;i<=i2;i++) {
		...
		if(document.getElementById(col+'_'+q)) {
			...
			alert('Not document.getElementById('+col+'_'+q+')')
		}
	}
	*/
