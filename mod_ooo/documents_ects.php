...
$i = 0;
$mentions = array('A' => 'Very well', 'B' => 'Well', 'C' => ' Rather Well', 'D' => 'Suitable', 'E' => 'Passable', 'F' => 'Insufficient');
$resultats = array();
//$recap_annees = array();
foreach($Eleves as $Eleve) {
    ...
    $Classe = $classes[0];
    if ($Eleve->getSexe() == 'F') {
        $naissance = "born it ".$Eleve->getNaissance();
    } else {
        $naissance = "born it ".$Eleve->getNaissance();
    }
    ...
    switch($gepiSettings['gepiSchoolStatut']){
        ...
        case 'prive_sous_contrat':
            $statut_etab = 'deprived under contract';
            break;
        case 'prive_hors_contrat':
            $statut_etab = 'deprived except contract';
            break;
        default:
            $statut_etab = 'public';
    }
    ...
    $denomination_periodes = array(1 => 'First half of the year', 2 => 'Second half of the year', 3 => 'Third six-month period', 4 => 'Fourth six-month period', 5 => 'Fifth six-month period', 6 => 'Sixth six-month period');
    $resultats[$i] = array();
    ...
    foreach($total_credits_annees as $annee_courante => $credits_courants) {
        $recap_annees[$i][] = array('texte' => 'Academic year '.$annee_courante." : ".$credits_courants." ECTS");
    }
