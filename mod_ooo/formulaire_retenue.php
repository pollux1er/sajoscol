...
echo "<p>&nbsp;</p>";
echo "<p class='bold'>Details of reserve";
echo "&nbsp;</p>\n";
...
// Si aucune date n'est encore saisie, proposer la date du jour
	...
	echo "<table class='boireaus' border='1' summary='Incidental Details'>\n";
	
	// Date 
	$alt=$alt*(-1);
	echo "<tr class='lig$alt'>\n";
	echo "<td style='font-weight:bold;vertical-align:top;text-align:left;'>\n";
	echo "Date from the incident&nbsp;:";
	echo "</td>\n";
	...
	echo "<a href=\"#calend\" onClick=\"".$cal->get_strPopup('../lib/calendrier/pop.calendrier.php', 350, 170)."\"><img src=\"../lib/calendrier/petit_calendrier.gif\" border=\"0\" alt=\"Small calendar\" /></a>\n";
	echo "</td>\n";
	echo "<td width='1%' style='text-align:right;'>\n";
	echo "<input type='submit' name='enregistrer' value='Generate reserve' />\n";
	echo "</td>\n";
	echo "</tr>\n";
	...
	echo "<tr class='lig$alt'>\n";
	echo "<td style='font-weight:bold;vertical-align:top;text-align:left;'>\n";
	echo "Name and first name of the student&nbsp;:";
	echo "</td>\n";
	echo "<td style='text-align:left;'";
	echo " colspan='2'";
	echo ">\n";
...
echo "</form>\n";
echo "<p>&nbsp;</p>";
echo "<p class='bold'>NOTE: The reserves seized by the form above are not recorded in the
disciplines modulate .";
echo "&nbsp;</p>\n";
