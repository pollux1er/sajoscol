...
abstract class BaseAbsenceEleveType extends BaseObject  implements Persistent
{
	 ...
	 * @return     string
	 */
	public function getRetardReport card()
	{
	 ...
	 * @return     AbsenceEleveType The current object (for fluent API support)
	 */
	public function setRetardReport card($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			...
			case 4:
				...
				break;
			case 5:
				return $this->getRetardReport card();
				break;
			case 6:
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
	{
		...
		$result = array(
			...
			$keys[5] => $this->getRetardReport card(),
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			...
			case 4:
				...
				break;
			case 5:
				$this->setRetardReport card($value);
				break;
			case 6:
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[5], $arr)) $this->setRetardReport card($arr[$keys[5]]);
	...
	public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
	{
		...
		$copyObj->setRetardReport card($this->getRetardReport card());
