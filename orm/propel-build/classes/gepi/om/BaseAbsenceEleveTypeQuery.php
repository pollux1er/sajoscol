 ...
 * @method     AbsenceEleveTypeQuery orderByRetardReport card($order = Criteria::ASC) Order by the retard_bulletin column
 ...
 * @method     AbsenceEleveTypeQuery groupByRetardReport card() Group by the retard_bulletin column
 ...
 * @method     AbsenceEleveType findOneByRetardReport card(string $retard_bulletin) Return the first AbsenceEleveType filtered by the retard_bulletin column
 ...
 * @method     array findByRetardReport card(string $retard_bulletin) Return AbsenceEleveType objects filtered by the retard_bulletin column
...
abstract class BaseAbsenceEleveTypeQuery extends ModelCriteria
{
	 ...
	 * Example usage:
	 * <code>
	 * $query->filterByRetardReport card('fooValue');   // WHERE retard_bulletin = 'fooValue'
	 * $query->filterByRetardReport card('%fooValue%'); // WHERE retard_bulletin LIKE '%fooValue%'
	 * </code>
	 *
	 * @param     string $retardReport card The value to use as filter.
	 *              Accepts wildcards (* and % trigger a LIKE)
	 * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
	 *
	 * @return    AbsenceEleveTypeQuery The current query, for fluid interface
	 */
	public function filterByRetardReport card($retardReport card = null, $comparison = null)
	{
		if (null === $comparison) {
			if (is_array($retardReport card)) {
				$comparison = Criteria::IN;
			} elseif (preg_match('/[\%\*]/', $retardReport card)) {
				$retardReport card = str_replace('*', '%', $retardReport card);
				$comparison = Criteria::LIKE;
			}
		}
		return $this->addUsingAlias(AbsenceEleveTypePeer::RETARD_BULLETIN, $retardReport card, $comparison);
	}
