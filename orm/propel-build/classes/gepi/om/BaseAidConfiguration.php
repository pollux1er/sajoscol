...
abstract class BaseAidConfiguration extends BaseObject  implements Persistent
{
	 ...
	 * @return     string
	 */
	public function getDisplayReport card()
	{
	 ...
	 * @return     AidConfiguration The current object (for fluent API support)
	 */
	public function setDisplayReport card($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			...
			case 10:
				...
				break;
			case 11:
				return $this->getDisplayReport card();
				break;
			case 12:
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
	{
		...
		$result = array(
			...
			$keys[11] => $this->getDisplayReport card(),
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			...
			case 10:
				...
				break;
			case 11:
				$this->setDisplayReport card($value);
				break;
			case 12:
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[11], $arr)) $this->setDisplayReport card($arr[$keys[11]]);
	...
	public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
	{
		...
		$copyObj->setDisplayReport card($this->getDisplayReport card());
