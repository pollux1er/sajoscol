...
abstract class BaseClasse extends BaseObject  implements Persistent
{
	 ...
	 * @return     string
	 */
	public function getModeleReport cardPdf()
	{
	 ...
	 * @return     Classe The current object (for fluent API support)
	 */
	public function setModeleReport cardPdf($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			...
			case 11:
				...
				break;
			case 12:
				return $this->getModeleReport cardPdf();
				break;
			case 13:
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
	{
		...
		$result = array(
			...
			$keys[12] => $this->getModeleReport cardPdf(),
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			...
			case 11:
				...
				break;
			case 12:
				$this->setModeleReport cardPdf($value);
				break;
			case 13:
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[12], $arr)) $this->setModeleReport cardPdf($arr[$keys[12]]);
	...
	public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
	{
		...
		$copyObj->setModeleReport cardPdf($this->getModeleReport cardPdf());
