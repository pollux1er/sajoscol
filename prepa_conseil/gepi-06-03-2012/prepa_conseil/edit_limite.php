...
if ($_SESSION['statut'] == "responsable") {
	...
	if (mysql_result($test, 0) == 0) {
	    tentative_intrusion(3, "Attempt at a relative to visualize a simplified bulletin of a pupil of which it is not responsible legal.");
...
if (($_SESSION['statut'] == "responsable" OR $_SESSION['statut'] == "eleve") AND $choix_edit != "2") {
    tentative_intrusion(3, "Attempt (student or parent) of change of the mode of visualization of a simplified bulletin (the imposed mode is visualization for only one student)");
