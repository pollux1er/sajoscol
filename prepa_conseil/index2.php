...
//**************** EN-TETE *****************
$titre_page = "Visualization of the notes";
...
if (isset($id_classe)) {
	...
	echo "<p class='bold'><a href='../accueil.php'><img src='../images/icons/back.png' alt='Return' class='back_link'/> Reception</a>";
	...
	if($chaine_options_classes!="") {
		echo " | Classify: <select name='id_classe' onchange=\"document.forms['form1'].submit();\">\n";
		echo $chaine_options_classes;
		echo "</select>\n";
	}
	if(isset($id_class_suiv)){
		if($id_class_suiv!=0){echo " | <a href='".$_SERVER['PHP_SELF']."?id_classe=$id_class_suiv'>Following class</a>";}
	}
	...
	echo "<td valign=\"top\"><strong>Choose&nbsp;the&nbsp;period&nbsp;:&nbsp;</strong><br />\n";
	...
	echo "/><label for='avec_moy_gen_periodes_precedentes'> With the averages of previous periods</label></p>\n";

	echo "</td>\n";

	echo "<td valign=\"top\">\n";
	echo "<strong>Parameters of display</strong><br />\n";
	echo "<input type=\"hidden\" name=\"id_classe\" value=\"".$id_classe."\" />";

	echo "<table border='0' width='100%' summary=\"Parameters of the table\">\n";
	echo "<tr>\n";
	echo "<td>\n";
		...
		echo "Prime coats of the alternate lines : \n";
		echo "</label>\n";
		echo "</td>\n";
	...
	echo "<td>\n";
		...
		echo "<table border='0' summary=\"Additional postings\">\n";
		echo "<tr>\n";
		...
		if (($affiche_rang == 'y') and ($test_coef != 0)) {
			...
			echo "display the row of the student\n";
			echo "</label>\n";
			echo "</td>\n";
			echo "</tr>\n";
		}
		...
		echo "display the date of birth of the student\n";
		echo "</label>\n";
		echo "</td>\n";
		echo "</tr>\n";
		echo "</table>\n";
...
*/
	...
	echo "<br />\n<span class='small'>Notice : the table of the notes is posted without heading and in a new page. To return to this screen, it is enough for you to close the window of
the table of the notes.</span>";
	...
	AND getSettingValue("GepiAccesMoyennesProfToutesTousEleves") != "yes") {
		echo "<br />\n<span class='small'>If you do not teach with whole classes, only the pupils to which you
teach will appear in the list, and the averages calculated will take into account only the posted
student.</span>";
	}
	echo "</td></tr>\n</table>\n";
	...
	echo "<input type='checkbox' id='utiliser_coef_perso' name='utiliser_coef_perso' value='y' onchange=\"display_div_coef_perso()\" /><label for='utiliser_coef_perso'> Use personalized coefficients.</label><br />\n";

	echo "<div id='div_coef_perso'>\n";
	echo "<table class='boireaus' summary='Personalized coefficients'>\n";
	echo "<tr>\n";
	echo "<th>Identifier</th>\n";
	echo "<th>Name of teaching</th>\n";
	echo "<th>Description of teaching</th>\n";
	...
	echo "<p><i>Remark:</i> If specific coefficients were set up for some student (<i>See in account administrator Management of the bases/Management of the classes/Lesson/&lt;TEACHING&gt;/student registered voters</i>), they will not be crushed by the values seized here.</p>\n";
	echo "</div>\n";
	...
	echo "/><label for='vtn_coloriser_resultats'> Coloriser results.</label><br />\n";
	...
	echo "<table id='table_couleur' class='boireaus' summary='Coloriser results'>\n";
	echo "<thead>\n";
		echo "<tr>\n";
		echo "<th><a href='#colorisation_resultats' onclick='add_tr_couleur();return false;'>Limit<br />higher</a></th>\n";
		echo "<th>Color text</th>\n";
		echo "<th>Color cell</th>\n";
		echo "<th>Remove</th>\n";
		echo "</tr>\n";
	echo "</thead>\n";
	...
	if(mysql_num_rows($res_pref)>0) {
		...
		// Colors taken into account in colorisation_visu_toutes_notes.js
...
display_div_coloriser();
	...
	echo "</p>\n";
	echo "<strong>Visualize the averages by class :</strong><br />";
	...
	if($lignes==0){
		echo "<p>No class is allotted to you.<br />Contact the administrator so that it carries out the suitable
