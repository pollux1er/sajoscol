...
$display_end = @mysql_result($call_data, 0, "display_end");
    ...
    //**************** EN-TETE *****************
if (!isset($bord))     $titre_page = "Visualization of the appreciations ".$nom_aid;
...
if (!isset($aid_id)) {
    ...
    if ($nombre_aid == "0") {
        ...
        echo "<p>You are not a responsible professor. You thus do not have access to this module.</p></html></body>\n";
        ...
        echo "<p>You are a responsible professor in $nom_aid :<br />\n";
        ...
        while ($i < $nombre_aid) {
            ...
            echo "<br /><span class='bold'>$aid_display</span> --- <a href='visu_aid.php?aid_id=$aid_id&aid=yes&indice_aid=$indice_aid'>Visualize the appreciations for this heading</a>\n";
    ...
    echo "<p class=bold><a href=\"../accueil.php\">Accueil</a>|<a href=visu_aid.php?indice_aid=$indice_aid><img src='../images/icons/back.png' alt='Return' class='back_link'/> Return</a></p>";
    ...
    echo "<p class='bold'>Appreciations $nom_aid : $aid_nom</p>\n";

    echo "<p>Choose the data to be printed or visualize (you can notch several
boxes) : </p>\n";
    ...
    while ($i < $max_boucle) {
        ...
        echo "<p><INPUT TYPE=CHECKBOX NAME='$name' VALUE='yes'>Period $i - extract the appreciations<p>\n";
        ...
        if (($type_note == 'every') or (($type_note == 'last') and ($i == $last_periode_aid))) {
            ...
            echo "<p><INPUT TYPE=CHECKBOX NAME='$name' VALUE='yes'>Period $i - extract the notes<p>\n";
    ...
    echo "<b>Parameters of display</b><br />\n";

    echo "<br />\nWidth in pixel of the table : <input type=text name=larg_tab size=3 value=\"680\">";

    echo "<br />\nEdges in pixel of the table : <input type=text name=bord size=3 value=\"1\">";

    echo "<br />\n<br />\n<span class='small'><b>Remark :</b> after validation, the results are posted in the shape of a table in a
new page without heading. To return to this screen, it will be enough for you to close the
window (cross in top on the right).</span>";
    ...
    echo "<p class='bold'>" . $_SESSION['nom'] . " " . $_SESSION['prenom'] . " | Year : ".getSettingValue("gepiYear")." | Appreciations $nom_aid : $aid_nom</p>";
