...
/*
 *
 * @version $Id: infos_parents.php 8551 2011-10-26 16:59:29Z crob $
 *
...
secours='F',
autre='F',
description='Roast student/parents',
statut='';";
...
if(isset($_GET['export_csv'])) {
	...
	elseif($mode=='2') {
		...
		if(mysql_num_rows($res_adr)==0) {
			$msg="No responsible association/address was not found.<br />";
		}
		else {
...
// ===================== entete Gepi ======================================//
$titre_page = "Roast student/parents";
...
if((!isset($mode))||($mode==1)) {
	...
	echo "<p>Information student/parents &nbsp;: <a href='".$_SERVER['PHP_SELF']."?export_csv=export_infos_parents_1'>Export CSV</a></p>\n";
	echo "<table class='boireaus'>\n";
	echo "<tr>\n";
	echo "<th rowspan='2'>Class</th>\n";
	echo "<th colspan='6'>student</th>\n";
	echo "<th colspan='8'>Responsible</th>\n";
	echo "</tr>\n";
	...
	$res_adr=mysql_query($sql);
	if(mysql_num_rows($res_adr)==0) {
		echo "<p style='color:red'>No responsible association/address was not found.</p>\n";
	...
	echo "<th>Adress</th>\n";
	echo "<th>Responsible 1</th>\n";
	echo "<th>Co-ordinates 1</th>\n";
	echo "<th>Responsible 2</th>\n";
	echo "<th>Co-ordinates 2</th>\n";
	echo "<th>Student</th>\n";
	echo "</tr>\n";
	...
	echo "<p><em>NOTES&nbsp;</em> To give correct results, this page requires that you carried out one ";
	if($_SESSION['statut']=='administrateur') {
		echo "<a href='dedoublonnage_adresses.php'>deduplication addresses responsible</a>";
	}
	else {
		echo "deduplication addresses responsible (<em>Contact an administrator</em>)";
	}
	echo ".</p>\n";
