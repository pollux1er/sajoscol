...
if(isset($_GET['ligne_entete'])){
	switch($_GET['mode']){
		case "Id_Note_App":
			$fd.="IDENTIFIER;NOTE;APPRECIATION\n";
			break;
		case "Id_App":
			$fd.="IDENTIFIER;APPRECIATION\n";
			break;
		case "Nom_Prenom_Id_App":
			$fd.="NAME;FIRST NAME;IDENTIFIER;APPRECIATION\n";
			break;
		case "Nom_Prenom_Id":
			$fd.="NAME;FIRST NAME;IDENTIFIER\n";
			break;
		case "Nom_Prenom_Id_Note_App":
			$fd.="NAME;FIRST NAME;IDENTIFIER;NOTE;APPRECIATION\n";
			break;
	}
}
