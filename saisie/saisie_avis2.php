<?php
/*
* $Id: saisie_avis2.php 7467 2011-07-21 10:18:17Z crob $
*
...
if (isset($id_classe) and (!isset($periode_num))) {
	...
	echo "<p class=bold><a href=\"saisie_avis.php\"><img src='../images/icons/back.png' alt='Return' class='back_link' /> My classes</a></p>\n";
	...
	while ($i < $nb_periode) {
		if ($ver_periode[$i] != "O") {
			...
			echo "<li>".ucfirst($nom_periode[$i])." (".$gepiClosedPeriodLabel.", impossible edition).</li>\n";
		}
	$i++;
	}
	echo "</ul>\n";
...
if (isset($id_classe) and (isset($periode_num)) and (!isset($fiche))) {
	...
	<p class=bold><a href="saisie_avis2.php?id_classe=<?php echo $id_classe; ?>"><img src='../images/icons/back.png' alt='Retour' class='back_link' /> Choose another period</a>
...
if(isset($id_class_prec)){
	if($id_class_prec!=0){echo " | <a href='".$_SERVER['PHP_SELF']."?id_classe=$id_class_prec&amp;periode_num=$periode_num' onclick=\"return confirm_abandon (this, change, '$themessage')\">Classify preceding</a>";}
}
...
echo "</form>\n";
	...
	<p>Click on the name of the student for whom you want to enter or modify
the appreciation.</p>
	<table class='boireaus' border="1" cellspacing="2" cellpadding="5" width="100%" summary="Choix de l'élève">
	<tr>
		<th width="20%"><b>Name First name</b></th>
		<th<?php
		...
		?>><b><?php echo ucfirst($nom_periode[$periode_num]) ; ?> : opinion of the staff meeting</b></th>
		<?php
			if($avec_mentions=="y") {
	...
	echo "<p><b>Synthesis of the opinions on the group classifies&nbsp;:</b></p>\n";
	echo "<table class='boireaus' border='1' cellspacing='2' cellpadding='5' width='100%' summary='Synthese'>";
	$alt=$alt*(-1);
	echo "<tr class='lig$alt'>\n";
	echo "<td width='20%'>\n<a href='saisie_synthese_app_classe.php?num_periode=$periode_num&amp;id_classe=$id_classe#synthese'>To seize the synthesis</a></td>\n";
...
if (isset($fiche)) {
	...
	echo "<p><a href='".$_SERVER['PHP_SELF']."?id_classe=$id_classe&amp;periode_num=$periode_num' onclick=\"return confirm_abandon (this, change, '$themessage')\"><img src='../images/icons/back.png' alt='Return' class='back_link' /> Return</a></p>\n";
...
//			$tab_moy_gen[$loop]=$moy_generale_classe;
	...
	echo "<table border='0' summary=\"student $current_eleve_login\">\n";
	echo "<tr>\n";
	echo "<td>\n";
