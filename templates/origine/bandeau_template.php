...
<a href="#contenu" class="invisible"> Go to content </a>
...
<div class="bandeau_colonne">
	<!-- Bouton rétrécir le bandeau -->
		<a class='change_taille_gd' href="#" onclick="modifier_taille_bandeau();change_mode_header('y', '<?php echo $tbs_bouton_taille;?>');return false;">
			<img src="<?php echo $tbs_bouton_taille;?>/images/up.png" alt='Hide the banner' title='Hide the banner' />
		</a>
	<!-- Bouton agrandir le bandeau -->
		<a class='change_taille_pt' href="#" onclick="modifier_taille_bandeau();change_mode_header('n', '<?php echo $tbs_bouton_taille;?>');return false;">
			<img src="<?php echo $tbs_bouton_taille;?>/images/down.png" alt='Show the banner' title='Show the banner' />
		</a>
		...
		<?php
			...
			if($tbs_afficher_temoin_filtrage_html=='y') {
				if($filtrage_html=='htmlpurifier') {
					echo " <img src='$gepiPath/images/bulle_verte.png' width='9' height='9' alt='Filtrage HTML avec HTMLPurifier' title='Filtering HTML with HTMLPurifier' />\n";
				}
				elseif($filtrage_html=='inputfilter') {
					echo " <img src='$gepiPath/images/bulle_bleue.png' width='9' height='9' alt='Filtrage HTML avec InputFilter' title='Filtering HTML withInputFilter' />\n";
				}
				else {
					echo " <img src='$gepiPath/images/bulle_rouge.png' width='9' height='9' alt='Pas de filtrage HTML' title='No HTML filtering ' />\n";
				}
			}
			//=====================================
		?>
...
<div class="bandeau_colonne" id="bd_colonne_droite">
	...
	<li class='ligne_deux_menu'>
		<a href='$value[lien]' $value[onclick] title=\"New window\">
			$value[texte]
		</a>
	</li>
						";
