...
<!-- fin bandeau_template.html      -->
	...
	<p class="center">
	  This module makes it possible to modify the order of the menus of the home page as well as the headings.
  	  <br /><span class="small">Notice : if the new name of the block is "bloc_invisible", this last will not appear in the menu (this does not function for the plugins).</span>
	</p>
	<p>
	  <input type="submit" value="Save" name="btn_enregistrer" />
	  <span class="ecarte">  </span>
	  <input type="submit" value="Reinitialize" name="btn_reinitialiser" title="Remove all the entries relating to the order of the menus" />
	  <input type="submit" value="optimize" name="btn_optimiser" title="Eliminate the holes in classification of the titles of menus" />
	  <br /><br />
	</p>
