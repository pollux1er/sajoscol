...
<h2 class="colleHaut">General configuration</h2>
  <p>
	<em>
	  The deactivation of this module does not remove the parameter
settings already carried out.
	</em>
  </p>
...
?>
	<fieldset class="no_bordure">
	  ...
	  <label for='activer_y'>
		Activate export "Admissions Post-Bac"
	  </label>
	  <br />
	  <input type="radio" 
			 name="activer" 
	  ...
	  <label for='activer_n'>
		Deactivate export "Admissions Post-Bac"
	  </label>
	</fieldset>
	<p class="center">
  ...
  <h2>Selection of the classes of final</h2>
  <p>The table below enables you to specify which classes correspond to the
level 'Terminale'. 
	Only the student of the classes selected here will be integrated into
export towards system APB.
  </p>
