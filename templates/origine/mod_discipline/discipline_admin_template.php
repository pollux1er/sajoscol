...
<!-- fin bandeau_template.html      -->
  ...
  <p>
	<em>
	  The desactivation of the Discipline module does not involve any
suppression of the data.
	  When the module is deactivate, the users do not have access to the module.
	</em>
  </p>
...
?>
	  ...
	  <label for='activer_y' style='cursor: pointer;'>
		Activate the module Disciplines
	  </label>
	  <br />
	  <input type="radio"
			 name="activer"
	  ...
	  <label for='activer_n' style='cursor: pointer;'>
		Deactivate the module Disciplines
	  </label>
	</fieldset>

	<h2>Authorize the use of a zone comment in the management of the
incidents</h2>
	  <fieldset class="no_bordure">
		<legend class="invisible">Zone of dialogue</legend>
		  <input type='radio'
		...
		<label for='autorise_commentaires_mod_disc_y' style='cursor: pointer;'>
		  Activate a zone of dialogue relating to each incident. <br/>This zone makes it possible to comment on the evolution of the
treatment of the incident, to formulate a request to the CPE, ... 
		</label>
	  <br />
		  <input type='radio'
				 name='autorise_commentaires_mod_disc'
		...
		<label for='visa_cdt_inter_modif_notices_visees_n' style='cursor: pointer;'>
		 Deactivate the zone of dialogue relating to each incident.
		</label>
	  </fieldset>
