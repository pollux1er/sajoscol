...
<!-- Fin haut de page -->
  ...
  <p>
	<em>
	  The deactivation of module ECTS does not involve any suppression of
the data. 
	  When the module is deactivate, it is not possible any more to manage the values of ECTS for the lesson or to seize ECTS for the student.
	</em>
  </p>
