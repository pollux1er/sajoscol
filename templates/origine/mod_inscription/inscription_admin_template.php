...
<!-- Fin haut de page -->
	...
	<h2>Activation of the module register</h2>
	<form action="inscription_admin.php" id="form1" method="post">
	  <p>
<?php
echo add_token_field();
?>
		The Inscription module enables you to define one or more items (training course, intervention, ...),
		with the which users will be able to be registered or désinscrire by
notching or stripping a cross.
	  ...
	  <fieldset class="no_bordure">
		...
		<label for='activer_y' style='cursor: pointer;'>
		  Activate the access to the module Inscription
		</label>
		<br />
		<input type="radio" 
			   name="activer" 
		...
		<label for='activer_n' style='cursor: pointer;'>
		  Deactivate the access to the module register
		</label>
	  </fieldset>
	  <p class="center">
