...
<!-- Fin haut de page -->
	...
	<h2>Activation of the Notanet module/Cards Patent</h2>
...
?>
		<legend>The Notanet module/Cards Brevet relates to the colleges.</legend>
		<br />
		<input type="radio" 
			   name="activer" 
			   id="activer_y" 
		...
		<label for='activer_y' style='cursor: pointer;'>
		  Activate the access to the Notanet module/Cards Brevet
		</label>
		<br />
		...
		<label for='activer_n' style='cursor: pointer;'>
		  Deactivate the access to the Notanet module/Cards Patent
		</label>
	  </fieldset>
