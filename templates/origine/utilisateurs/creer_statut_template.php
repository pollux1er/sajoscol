...
<!-- fin bandeau_template.html      -->
  ...
  <!-- Fin haut de page -->
	...
	<p>
	  If Gepi defines several by default statutes, it is possible to create the new ones while passing 
	  by this tool.
	</p>
...
?>
		...
		<label for="idAutorise">
		  Authorize the creation of new personalized statutes by the admnistrator.
		</label>
		<br/>
	  </p>
	  <p class="center">
		<input type="submit" value="Save" id="btn_submit" />
