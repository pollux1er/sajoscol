			...
			if(isset($check_matiere[$j]) and $check_matiere[$j] === "oui"){
				...
				if(mysql_num_rows($result_test)!=0){
					...
					if(mysql_num_rows($result_test2)==0){
						...
						$msg.="The user $user_login[$i] is associated to a <a href='../groupes/edit_class.php?id_classe=$lign_classe->id_classe'>group</a> for $tab_matiere[$j]. The course could not be removed.<br />\n";
					}
				}
			}
		}
...
//**************** EN-TETE *****************
$titre_page = "Management of the users | Assignment of courses to the professors ";
...
?>
<p class=bold>
<a href="index.php?mode=personnels"><img src='../images/icons/back.png' alt='Return' class='back_link'/> Return</a> | <a href='javascript:centrerpopup("help.php",600,480,"scrollbars=yes,statusbar=no,resizable=yes")'>Help</a>
</p>
...
*/
	...
	echo "<table class='boireaus' border='1' summary='Table of the professors and courses'>\n";
