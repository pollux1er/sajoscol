...
@set_time_limit(0);
/*
* $Id: clean_tables.php 8659 2011-11-23 19:51:02Z crob $
*
...
//if (($_POST['maj'])=="9") {
if ($maj=="9") {
	echo "<p class=bold><a href='../accueil.php'><img src='../images/icons/back.png' alt='Retour' class='back_link'/> Back to Home</a> ";
				...
				if(mysql_num_rows($res2)>0) {
					...
					while($lig2=mysql_fetch_object($res2)) {
						...
						if((mysql_num_rows($res_liste_notes)==0)&&(mysql_num_rows($res_liste_appreciations)==0)){
							...
							$texte_info_action.="<span style='color:red'>Report cards non vides pour $lig2->login sur la période $lig2->periode.</span><br />\n";
						}
...
elseif (isset($_POST['action']) AND $_POST['action'] == 'check_auto_increment') {
	...
	if(isset($_GET['chgt_annee'])) {
		...
		echo "<a href='../accueil.php'><img src='../images/icons/back.png' alt='Retour' class='back_link'/> Back to Home</a> ";
		echo "| <a href='clean_tables.php'>Retour page Vérification / Nettoyage des tables</a>\n";
	}
	echo "</p>\n";
