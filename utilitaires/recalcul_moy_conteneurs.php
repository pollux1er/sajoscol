...
echo "<div class='norme'><p class=bold><a href='../accueil.php'><img src='../images/icons/back.png' alt='Retour' class='back_link'/> Back to Home</a> | <a href='clean_tables.php'>Retour page précédente</a>";
