 ...
 */
		...
		$req_test = mysql_query("SELECT VALUE FROM setting WHERE NAME = 'GepiAccesReport cardSimpleEleve'");
		$res_test = mysql_num_rows($req_test);
		if ($res_test == 0)
		$result_inter .= traite_requete("INSERT INTO setting VALUES ('GepiAccesReport cardSimpleEleve', 'yes');");

		$req_test = mysql_query("SELECT VALUE FROM setting WHERE NAME = 'GepiAccesReport cardSimpleParent'");
		$res_test = mysql_num_rows($req_test);
		if ($res_test == 0)
		$result_inter .= traite_requete("INSERT INTO setting VALUES ('GepiAccesReport cardSimpleParent', 'yes');");

		$req_test = mysql_query("SELECT VALUE FROM setting WHERE NAME = 'GepiAccesReport cardSimpleProf'");
		$res_test = mysql_num_rows($req_test);
		if ($res_test == 0)
		$result_inter .= traite_requete("INSERT INTO setting VALUES ('GepiAccesReport cardSimpleProf', 'yes');");

		$req_test = mysql_query("SELECT VALUE FROM setting WHERE NAME = 'GepiAccesReport cardSimpleProfTousEleves'");
		$res_test = mysql_num_rows($req_test);
		if ($res_test == 0)
		$result_inter .= traite_requete("INSERT INTO setting VALUES ('GepiAccesReport cardSimpleProfTousEleves', 'no');");

		$req_test = mysql_query("SELECT VALUE FROM setting WHERE NAME = 'GepiAccesReport cardSimpleProfToutesClasses'");
		$res_test = mysql_num_rows($req_test);
		if ($res_test == 0)
		$result_inter .= traite_requete("INSERT INTO setting VALUES ('GepiAccesReport cardSimpleProfToutesClasses', 'no');");
