...
//**************** EN-TETE *****************
$titre_page = "Tool for visualization | Comparison of evolution of two classes";
...
?>
<p class='bold'><a href='../accueil.php'><img src='../images/icons/back.png' alt='Retour' class='back_link'/>Return home</a> | <a href='index.php'>Another tool for visualization</a>
<?php
if ((!isset($id_classe)) or ($id_classe=='')) {
    ?>
    </p><p>Please select the classes that you want to visualize :<br />
    <?php
...
//***************************************************************************************************
    ...
    $graph_title = "Comparison of the classes of ".$classe." and ".$classe2;
    $v_legend1 = $classe ;
    $v_legend2 = $classe2 ;
    echo "<table  border='1' cellspacing='2' cellpadding='5'>\n";
    echo "<tr><td width='100'>Course</td>\n";
    $k = '1';
    while ($k < $nb_periode) {
    ...
    echo "</table>\n";
    echo "<a name=\"graph\"></a>\n";
    echo "<p class='bold'>|<a href='../accueil.php'>Home</a>|<a href='index.php'>Another tool for visualization</a>|<a href='classe_classe.php?id_classe='>Choice of classes</a>|</p>\n";
    ...
    echo "&amp;v_legend1=".$v_legend1."&amp;v_legend2=".$v_legend2."&amp;etiquette=$etiq&amp;titre=$graph_title&amp;compteur=$compteur&amp;nb_data=$nb_periode' alt='Compared graphs of two classes' />\n";
