...
//**************** EN-TETE *****************
$titre_page = "Tool for visualization | Student according to the class ";
...
if (!isset($id_classe)) {
    echo "<p class='bold'><a href='../accueil.php'><img src='../images/icons/back.png' alt='Retour' class='back_link'/> Return home</a> | <a href='index.php'>Another tool for visualization</a></p>\n";

	echo "<p>Select the class :<br />\n";
	...
	*/
    ...
    if (!$periode) {
        ...
        ?>
        <p><span class='grand'>Class : <?php echo $classe; ?></span><br />
        <br />Choose which period you wish to visualize :<br />
        ...
        ?>
        <input type='radio' id='annee_complete' name='periode' value='annee' /> <label for='annee_complete' style='cursor:pointer;'>Complete year</label><br />
        ...
        ?>
    <table border='0' summary='Choix'><tr><td><p class='bold'>|<a href="eleve_classe.php?id_classe=<?php echo $id_classe; ?>">Choose another period</a>|
        <a href="eleve_classe.php?id_classe=<?php echo $id_classe; ?>&amp;v_eleve=<?php echo $v_eleve; ?>&amp;prec=yes&amp;periode=<?php echo $periode; ?>">Previous student</a>|
        <a href="eleve_classe.php?id_classe=<?php echo $id_classe; ?>&amp;suiv=yes&amp;periode=<?php echo $periode; ?>&amp;v_eleve=<?php echo $v_eleve; ?>">Next student</a>|
        </p></td>
        ...
        echo "<table class='boireaus' border='1' cellspacing='2' cellpadding='5' summary='Courses/Notes/Appreciations'>";
        echo "<tr><th width='100'><p>Course</p></th><th width='100'><p>Note student</p></th><th width='100'><p>class Average </p></th><th width='100'><p>Difference</p></th></tr>";
    ...
    <br />
    <a name="graph"></a>
    <table border='0' summary='Choix'><tr><td><span class=bold>|<a href="eleve_classe.php?id_classe=<?php echo $id_classe; ?>"> Choose another period</a>|
        <a href="eleve_classe.php?id_classe=<?php echo $id_classe; ?>&amp;v_eleve=<?php echo $v_eleve; ?>&amp;prec=yes&amp;periode=<?php echo $periode; ?>#graph">Previous student</a>|
        <a href="eleve_classe.php?id_classe=<?php echo $id_classe; ?>&amp;suiv=yes&amp;periode=<?php echo $periode; ?>&amp;v_eleve=<?php echo $v_eleve; ?>#graph">Next student</a>|</span></td>
		...
		echo ">";
		echo "<img src='../images/icons/buddy.png' alt='Student information ' />";
		echo "</a>";
