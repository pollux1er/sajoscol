...
//**************** EN-TETE *****************
$titre_page = "Tool for visualization | Eleve according to another student";
...
?>
<p class='bold'><a href='../accueil.php'><img src='../images/icons/back.png' alt='Retour' class='back_link'/> Return home</a> | <a href='index.php'>Other tool for visualization</a>
<?php
...
if ((!isset($id_classe)) or (!isset($id_classe2))) {
	...
	echo "<p>Select the class of the second student :</p>\n";
	...
	echo "</select><br /><br /><input type='submit' value='Validate' /></form>\n";
	...
	if ((!isset($v_eleve1)) OR (!isset($v_eleve2))) {
		if (($v_eleve1) AND (!$v_eleve2)) { $msg="You must enter the name of a second student...";}
		?>
		| <a href="eleve_eleve.php">Choice of classes</a></p>
		<form enctype="multipart/form-data" action="eleve_eleve.php#graph" method=post>
		<table><tr><td>
		<p>Class: <?php echo $classe; ?><br />Please select the student n°1:<br />
		...
		<p>Classe : <?php echo $classe2; ?><br /> Please select the student n°2:<br />
		...
		<p>Choose which period you wish to visualize :<br />
		<?php
		...
		?>
		<input type='radio' name='periode' value='annee' />Complete year</p>
	...
	<?php } else {
		...
		?> | <a href="eleve_eleve.php">Choice of classes</a> | <a href="eleve_eleve.php?id_classe=<?php echo $id_classe;?>&amp;id_classe2=<?php echo $id_classe2;?>">Choice of students</a></p><?php
		...
		echo "<tr><td width='100'><p>Course</p></td><td width='100'><p>$eleve1_nom $eleve1_prenom</p></td><td width='100'><p>$eleve2_nom $eleve2_prenom</p></td><td width='100'><p>Difference</p></td></tr>\n";
		...
		echo "<img src='./draw_artichow1.php?temp1=$temp1&amp;temp2=$temp2&amp;etiquette=$etiq&amp;titre=$graph_title&amp;v_legend1=$v_legend1&amp;v_legend2=$v_legend2&amp;compteur=$compteur&amp;nb_data=3' alt='Compared graphs of $v_legend1 and $v_legend2' />\n";
		...
		echo ">";
		echo "<img src='../images/icons/buddy.png' alt='Information student 1' />";
		echo "</a>";
		echo "<br />";
		...
		//echo " onmouseout=\"cacher_div('info_popup_eleve');\"";
		echo ">";
		echo "<img src='../images/icons/buddy.png' alt='Information student 2' />";
		echo "</a>";
