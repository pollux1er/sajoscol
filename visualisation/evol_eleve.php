...
//**************** EN-TETE *****************
$titre_page = "Tool for visualization | Evolution of the student over the year ";
...
if (!$id_classe) {
	...
	echo "<p class='bold'><a href='../accueil.php'><img src='../images/icons/back.png' alt='Retour' class='back_link'/>Return home</a> | <a href='index.php'>Other tool for visualization</a>";
	...
	if(($i>0)&&(round($i/$nb_class_par_colonne)==$i/$nb_class_par_colonne)){
        ...
        echo "<a href='evol_eleve.php?id_classe=$id_classe#graph'>$classe</a><br />\n";
    $i++;
    }
    //echo "</p>";
        echo "</table>\n";
...
/*
    echo "<a href='../".$ver_jpgraph."/view_jpgraph.php?";
    $k = "1";
    while ($k < $nb_periode) {
    ...
    echo "etiquette=$etiq&titre=$graph_title&compteur=$compteur&nb_data=$nb_periode'>toto</a>";
*/
    ...
    echo "etiquette=$etiq&amp;titre=$graph_title&amp;compteur=$compteur&amp;nb_data=$nb_periode' alt='Evolution of $prenom_el $nom_el' />\n";
