...
//**************** EN-TETE *****************
$titre_page = "Tool for visualization | Evolution of the student and the class over the year";
...
if (!isset($id_classe)) {
	...
	echo "<p class='bold'><a href='../accueil.php'><img src='../images/icons/back.png' alt='Return' class='back_link'/>Return home</a> | <a href='index.php'>Other tool for visualization</a></p>\n";
	...
	*/
	...
	echo "<a href='evol_eleve_classe.php?id_classe=$id_classe&amp;prec=yes&amp;v_eleve=$v_eleve'>Previous student</a> | \n";
	echo "<a href='evol_eleve_classe.php?id_classe=$id_classe&amp;suiv=yes&amp;v_eleve=$v_eleve'>Next student</a>|\n";
	...
	$graph_title = $eleve_nom." ".$eleve_prenom.", ".$classe.", evolution over the year";
	$v_legend1 = $eleve_nom." ".$eleve_prenom ;
	$v_legend2 = "Avg. ".$classe ;
	echo "<p>$eleve_nom  $eleve_prenom, class of $classe   |  Evolution over the year</p>\n";
	echo "<table class='boireaus' border='1' cellspacing='2' cellpadding='5' summary='Courses/Notes'>\n";
	echo "<tr><th width='100'><p>Course</p></th>\n";
	$k = '1';
	while ($k < $nb_periode) {
		echo "<th width='100'><p>$nom_periode[$k]</p></th><th width='100'><p>class</p></th>\n";
	$k++;
	}
	echo "</tr>\n";
	...
	?>
	<a href="evol_eleve_classe.php?id_classe=<?php echo $id_classe; ?>&amp;prec=yes&amp;v_eleve=<?php echo $v_eleve; ?>#graph">Previous student</a> |
	<a href="evol_eleve_classe.php?id_classe=<?php echo $id_classe; ?>&amp;suiv=yes&amp;v_eleve=<?php echo $v_eleve; ?>#graph">Next student</a> |
	<?php
	echo "</p>\n";
	echo "</form>\n";
	?>
...
<select size='1' name='v_eleve' onchange="this.form.submit()">
	...
	echo ">";
	echo "<img src='../images/icons/buddy.png' alt='Information student' />";
	echo "</a>";
...
//    echo "<img src='../".$ver_jpgraph."/view_jpgraph2.php?";
	...
	echo "&amp;v_legend1=".$v_legend1."&amp;v_legend2=".$v_legend2."&amp;etiquette=$etiq&amp;titre=$graph_title&amp;compteur=$compteur&amp;nb_data=$nb_periode' alt='Graph of evolution of the student and the class on the year' />\n";
