...
//**************** EN-TETE *****************
$titre_page = "Tool for visualization | Statistics of the class";
...
<?php
if (!isset($id_classe)) {
	echo "<p class='bold'><a href='../accueil.php'><img src='../images/icons/back.png' alt='Retour' class='back_link'/> Return home</a> | <a href='index.php'>Other tool for visualization</a></p>\n";

    echo "<p>Please choose the class that you to want to visualize :<br />";
	...
	*/
    ...
    echo "<tr><th width='100'>Course</th>";
    $k = '1';
    while ($k < $nb_periode) {
...
//    echo "<img src='../".$ver_jpgraph."/view_jpgraph.php?";
    ...
    echo "etiquette=$etiq&amp;titre=$graph_title&amp;compteur=$compteur&amp;nb_data=$nb_periode' alt='Statistics of the class' />\n";
